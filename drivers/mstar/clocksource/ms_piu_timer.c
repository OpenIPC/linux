...
CLOCKSOURCE_OF_DECLARE(ms_piu_timer_cs, "mstar,piu-clocksource", ms_piu_timer_clocksource_of_init);
CLOCKSOURCE_OF_DECLARE(ms_piu_timer_ce, "mstar,piu-clockevent", ms_piu_timer_clockevent_of_init);
