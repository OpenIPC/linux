...
//
////////////////////////////////////////////////////////////////////////////////
#ifndef __INFINITY3E_REG_ISP0__
...
typedef struct {
	...
	// h0000, bit: 5
	/* Enable static defect pixel correction
	# 1'b0: Disable
	# 1'b1: Enable
	 ( double buffer register )*/
	#define offset_of_reg_en_isp_sdc (0)
	#define mask_of_reg_en_isp_sdc (0x20)
	unsigned int reg_en_isp_sdc:1;
	...
	// h0005, bit: 2
	/* reg_wdma_src_sel
	# 1'b0: from FPN output
	# 1'b1: from sensor*/
	#define offset_of_reg_wdma_src_sel (10)
	#define mask_of_reg_wdma_src_sel (0x4)
	unsigned int reg_wdma_src_sel:1;
	...
	// h000d, bit: 14
	/* */
	#define offset_of_reg_isp_bist_fail_read (26)
	...
	// h000e, bit: 14
	/* */
	#define offset_of_reg_isp_bist_fail_read_1 (28)
	...
	// h000f, bit: 14
	/* */
	#define offset_of_reg_isp_bist_fail_read_2 (30)
	#define mask_of_reg_isp_bist_fail_read_2 (0xffff)
	...
	#3'd6: G3
	#3'd7: I1*/
	#define offset_of_reg_isp_rgbir_format (54)
	#define mask_of_reg_isp_rgbir_format (0x7)
	...
	#define offset_of_reg_isp_sw_used (56)
	#define mask_of_reg_isp_sw_used (0xffff)
	...
	// h001d, bit: 14
	/* 32 bits for sw used (can't be reset)*/
	#define offset_of_reg_isp_sw_used_1 (58)
	#define mask_of_reg_isp_sw_used_1 (0xffff)
	...
	// h0021, bit: 14
	/* Internal parallel to dma FIFO  full*/
	#define offset_of_reg_parallel2dma_fifo_ful (66)
	#define mask_of_reg_parallel2dma_fifo_ful (0x4000)
	unsigned int reg_parallel2dma_fifo_ful:1;
	...
	#define offset_of_reg_isp_gamma_10to10_en (140)
	#define mask_of_reg_isp_gamma_10to10_en (0x1)
	unsigned int reg_isp_gamma_10to10_en:1;

	// h0046, bit: 1
	/* Enable signal for gamma_10to10 gat max*/
	#define offset_of_reg_isp_gamma_10to10_max_en (140)
	#define mask_of_reg_isp_gamma_10to10_max_en (0x2)
	unsigned int reg_isp_gamma_10to10_max_en:1;

	// h0046, bit: 11
	/* Enable signal for gamma_10to10 max_data*/
	#define offset_of_reg_isp_gamma_10to10_max_data (140)
	#define mask_of_reg_isp_gamma_10to10_max_data (0xffc)
	...
	// h0048, bit: 0
	/* Enable CCM keep hue function*/
	#define offset_of_reg_isp_cc_keep_hue_en (144)
	#define mask_of_reg_isp_cc_keep_hue_en (0x1)
	unsigned int reg_isp_cc_keep_hue_en:1;
	...
	// h0049, bit: 14
	/* CCM keep hue threshold*/
	#define offset_of_reg_isp_cc_hue_th (146)
	#define mask_of_reg_isp_cc_hue_th (0xffff)
	unsigned int reg_isp_cc_hue_th:16;
	...
	// h004a, bit: 14
	/* New Interrupt Mask*/
	#define offset_of_reg_c_irq_mask3 (148)
	...
	// h004b, bit: 14
	/* New Force Interrupt Enable*/
	#define offset_of_reg_c_irq_force3 (150)
	...
	// h004c, bit: 14
	/* New Interrupt Clear*/
	#define offset_of_reg_c_irq_clr3 (152)
	...
	// h004d, bit: 14
	/* New Status of Interrupt on CPU side*/
	#define offset_of_reg_irq_final_status3 (154)
	...
	#[14]: Reserved
	#[15]: Reserved*/
	#define offset_of_reg_irq_raw_status3 (156)
	...
	0 : no mask (default)
	1 : mask*/
	#define offset_of_reg_mask_mload_mif_rst (202)
	#define mask_of_reg_mask_mload_mif_rst (0x8)
...
}  __attribute__((packed, aligned(1))) infinity3e_reg_isp0;
#endif
