...
#define INT_IRQ_CMDQ1             (GIC_SPI_MS_IRQ_START + 52)  //I3 New
#define INT_IRQ_CMDQ2             (GIC_SPI_MS_IRQ_START + 53)  //I3 New
#define INT_IRQ_USB_INT_P1        (GIC_SPI_MS_IRQ_START + 54)  //I3 New
#define INT_IRQ_UHC_INT_P1        (GIC_SPI_MS_IRQ_START + 55)  //I3 New
#define INT_IRQ_IVE_INT           (GIC_SPI_MS_IRQ_START + 56)  //I3 New
#define INT_IRQ_LDC_IRQ           (GIC_SPI_MS_IRQ_START + 57)  //I3 New
#define INT_IRQ_SC1_TOP_INT       (GIC_SPI_MS_IRQ_START + 58)  //I3 New
#define INT_IRQ_SC2_TOP_INT       (GIC_SPI_MS_IRQ_START + 59)  //I3 New
...
#define INT_PMSLEEP_DUMMY_76      (PMSLEEP_FIQ_START + 76)
#define INT_PMSLEEP_DUMMY_77      (PMSLEEP_FIQ_START + 77)
#define PMSLEEP_FIQ_END           (PMSLEEP_FIQ_START + 78)
