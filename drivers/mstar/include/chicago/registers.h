...
#define BASE_REG_CHIPTOP_PA         GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x1E00)
#define BASE_REG_PADTOP_PA          GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x0B00)
#define BASE_REG_PIUMISC_PA         GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x3C00)
#define BASE_REG_PM_PA              GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x3F00)
#define BASE_REG_INTRCTL_PA         GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x2B00)
