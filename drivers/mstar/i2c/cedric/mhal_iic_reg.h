...
//for port 0
#define CHIP_REG_HWI2C_MIIC0            (CHIP_GPIO1_REG_BASE+ (0x01*2)) 
    #define CHIP_MIIC0_PAD_0            (0)
    #define CHIP_MIIC0_PAD_1            (__BIT2)
    #define CHIP_MIIC0_PAD_MSK          (__BIT2)

//for port 1 
#define CHIP_REG_HWI2C_MIIC1            (CHIP_REG_BASE+ (0x6E*2)) //0x1EDC
    #define CHIP_MIIC1_PAD_0            (0)
    #define CHIP_MIIC1_PAD_1            (__BIT1)
    #define CHIP_MIIC1_PAD_MSK          (__BIT1)

//for port 2
#define CHIP_REG_HWI2C_MIIC2            (CHIP_REG_BASE+ (0x6E*2)) //0x1EDC
    #define CHIP_MIIC2_PAD_0            (0)
    #define CHIP_MIIC2_PAD_1            (__BIT2)
    #define CHIP_MIIC2_PAD_MSK          (__BIT2)
