...
#define MS_CMDQ_END_CMD       0x100802010000FFFE    // nonuse
#define MS_CMDQ_NULL_CMD      0x000000000000FFFF    // null cmd
#define MS_CMDQ_NULLTEST_CMD  0x00000000FFFFFFFF    // null cmd
#define MS_CMDQ_WRITE_CMD     0x1000000000000000    // write base head
#define MS_CMDQ_ALLNULL_CMD   0x0000000000000000    // clean
