...
typedef struct
{
    MS_U32 u32IRQNUM;
    MS_U32 u32CMDQIRQNUM;
}ST_SCLIRQ_SUSPEND_RESUME_CONFIG;
//-------------------------------------------------------------------------------------------------
//  Prototype
//-------------------------------------------------------------------------------------------------
#ifndef DRV_SCLIRQ_C
...
INTERFACE MS_BOOL Drv_SCLIRQ_Disable(MS_U16 u16IRQ);
INTERFACE MS_BOOL Drv_SCLIRQ_Get_Flag(MS_U16 u16IRQ, MS_U64 *pFlag);
INTERFACE MS_BOOL Drv_SCLIRQ_Set_Clear(MS_U16 u16IRQ);
INTERFACE MS_BOOL Drv_SCLIRQ_Get_Flags_Msk(MS_U64 u64IrqMsk, MS_U64 *pFlags);
INTERFACE MS_BOOL Drv_SCLIRQ_Set_Clear_Msk(MS_U64 u64IrqMsk);
INTERFACE MS_BOOL Drv_SCLIRQ_Set_Mask(MS_U64 u64IRQ);
INTERFACE MS_BOOL Drv_SCLIRQ_Suspend(ST_SCLIRQ_SUSPEND_RESUME_CONFIG *pCfg);
INTERFACE MS_BOOL Drv_SCLIRQ_Resume(ST_SCLIRQ_SUSPEND_RESUME_CONFIG *pCfg);
