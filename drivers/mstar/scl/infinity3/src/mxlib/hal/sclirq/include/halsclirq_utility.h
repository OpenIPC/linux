...
////////////////////////////////////////////////////////////////////////////////
#ifndef _HALSCLIRQ_UTILITY_H_
#define _HALSCLIRQ_UTILITY_H_
...
//  Macro and Define
//-------------------------------------------------------------------------------------------------
extern MS_U32 SCLIRQ_RIU_BASE;     // This should be inited before XC library starting.


// Address bus of RIU is 16 bits.
#define RIU_READ_BYTE(addr)         ( READ_BYTE( SCLIRQ_RIU_BASE+ (addr) ) )
#define RIU_READ_2BYTE(addr)        ( READ_WORD( SCLIRQ_RIU_BASE + (addr) ) )
#define RIU_WRITE_BYTE(addr, val)    WRITE_BYTE( (SCLIRQ_RIU_BASE + (addr)), val)
#define RIU_WRITE_2BYTE(addr, val)   WRITE_WORD( SCLIRQ_RIU_BASE + (addr), val)
