...
MS_U64 Hal_SCLIRQ_Get_Flag(EN_SCLIRQ_SCTOP_TYPE enType, MS_U64 u64IRQ)
{
    MS_U32 u32Mask;
    MS_U16 u16Mask;
    MS_U64 u64Flag = 0;
...
void Hal_SCLIRQ_Set_Clear(EN_SCLIRQ_SCTOP_TYPE enType, MS_U64 u64IRQ, MS_BOOL bEn)
{
    MS_U16 u16Mask;
    MS_U32 u32Bank;
    switch(enType)
    ...
    if(u64IRQ & 0x0000FFFF)
    {
        ...
        W2BYTEMSK(u32Bank, bEn ? u16Mask : 0, u16Mask);
    }
...
void Hal_SCLIRQ_Set_Mask(EN_SCLIRQ_SCTOP_TYPE enType, MS_U64 u64IRQ, MS_BOOL bMask)
{
    ...
    if(u64IRQ & 0x0000FFFF)
    {
        ...
        W2BYTEMSK(u32Bank, u16val, u16Mask);
    }
