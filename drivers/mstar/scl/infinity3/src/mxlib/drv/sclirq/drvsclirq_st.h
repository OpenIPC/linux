...
typedef enum
{
    ...
    E_SCLIRQ_EVENT_SETCHANGESIZE = 0x10000000,
    E_SCLIRQ_EVENT_CHANGESIZEDONE = 0x20000000,
}SCLIRQRXEvent;
typedef enum
{
    E_SCLIRQ_DAZA_OFF   = 0x00000000,
...
typedef struct
{
    MS_BOOL bVsyncWithVend;
    MS_BOOL bLDCEvenOpen;
    MS_BOOL bLDCEvenOpenCount;
    MS_BOOL bResetHangCnt;
}ST_SCLIRQ_DMAHANG_CNT;
//-------------------------------------------------------------------------------------------------
//  Prototype
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
