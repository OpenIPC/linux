...
typedef enum
{
    E_SCLDMA_COLOR_YUV422, ///< color format: 422Pack
    E_SCLDMA_COLOR_YUV420, ///< color format: YCSep420
    E_SCLDMA_COLOR_YCSep422, ///< color format: YC422
    E_SCLDMA_COLOR_YUVSep422, ///< color format: YUVSep422
    E_SCLDMA_COLOR_YUVSep420, ///< color format: YUVSep420
    E_SCLDMA_COLOR_NUM,    //I3 dma has 5 color type 422,420
