#ifndef __eMMC_CEDRIC_LINUX__
#define __eMMC_CEDRIC_LINUX__
...
#define REG_BANK_PMU		    0x700
#define REG_BANK_PMRTC        	0x900

#define RTC_BASE                GET_REG_ADDR(RIU_PM_BASE, REG_BANK_PMRTC)
#define REG_RESET               GET_REG_ADDR(RTC_BASE, 0x0A)
#define PMU_BASE                GET_REG_ADDR(RIU_PM_BASE, REG_BANK_PMU)
#define REG_BATTERY             GET_REG_ADDR(PMU_BASE, 0x06)
