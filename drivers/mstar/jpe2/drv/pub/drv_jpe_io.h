...
#ifndef __DRV_JPE_IO_H__
#define __DRV_JPE_IO_H__
...
#define JPE_IOC_GETBITS             _IOR_JPE(JPE_IOC_MAGIC, 2, u32)
//
#define JPE_IOC_GET_CAPS            _IOR_JPE(JPE_IOC_MAGIC, 3, u32)
//
#define JPE_IOC_SET_OUTBUF          _IOR_JPE(JPE_IOC_MAGIC, 4, u32)

// 0: 288MHz  1: 216MHz  2: 54MHz  3: 27MHz
#define JPE_IOC_SET_CLOCKRATE       _IOW_JPE(JPE_IOC_MAGIC, 5, u32)

#endif // __DRV_JPE_IO_H__