...
//I3 settings for gop1(at scl2)
#define mdrv_BASE_REG_GOP10_PA  GET_REG16_ADDR(BASE_REG_RIU_PA, (0x123400/2))
#define mdrv_BASE_REG_GOP11_PA  GET_REG16_ADDR(BASE_REG_RIU_PA, (0x123500/2))
#define mdrv_BASE_REG_GOP12_PA  GET_REG16_ADDR(BASE_REG_RIU_PA, (0x123600/2))
