...
#define GOP1_DEBUG 0
#if (GOP1_DEBUG==1)
#define GOP1DBG(fmt, arg...) printk(KERN_INFO fmt, ##arg)
#else
#define GOP1DBG(fmt, arg...)
#endif
...
void GOP1_Setmode(int bResume, int Screen,int Panel_Width,int  Panel_Height,U32  FB_Start_Addr,U32 Pixel_Format,U16 Bytes_Per_Pixel, int bInterlaceOut);
void GOP1_Setmode_Stretch_H(int bResume, int Screen,int Panel_Width,int  Panel_Height,U32  FB_Start_Addr,U32 Pixel_Format,U16 Bytes_Per_Pixel, int bInterlaceOut, int StretchRatio);
