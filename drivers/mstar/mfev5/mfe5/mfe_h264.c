...
{
    int bit_pos = avc_count(bs);
    bs_write_u1(bs, 0/* aspect_ratio_info_present_flag */);
    bs_write_u1(bs, 0/* overscan_info_present_flag */);
    ...
    bs_write_u1(bs, 0/* chroma_loc_info_present_flag */);
    bs_write_u1(bs, 0/* timing_info_present_flag */);
    bs_write_u1(bs, 0/* nal_hrd_parameters_present_flag */);
    bs_write_u1(bs, 0/* vcl_hrd_parameters_present_flag */);
    bs_write_u1(bs, 0/* pic_struct_present_flag */);
    bs_write_u1(bs, 0/* bitstream_restriction_flag */);
    return bs->bits_pos - bit_pos;
}
