...
#define NUE2_EMU_DBG_EN DISABLE
...
extern unsigned int nue2_drv_debug_level;
...
#define DBG_EMU_ERR(fmt, args...) nvt_dbg(ERR, fmt, ##args)
#define DBG_EMU_IND(fmt, args...) nvt_dbg(IND, fmt, ##args)
#define DBG_EMU_WRN(fmt, args...) nvt_dbg(IND, fmt, ##args) //WRN
