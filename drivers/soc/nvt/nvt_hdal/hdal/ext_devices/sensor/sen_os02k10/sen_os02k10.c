...
// version
//=============================================================================
VOS_MODULE_VERSION(nvt_sen_os02k10, 1, 44, 000, 00);

//=============================================================================
// information
//=============================================================================
#define SEN_OS02K10_MODULE_NAME     "sen_os02k10"
...
#define SEN_I2C_COMPATIBLE "nvt,sen_os02k10"
...
//=============================================================================
static CTL_SEN_DRV_TAB *sen_get_drv_tab_os02k10(void);
static void sen_pwr_ctrl_os02k10(CTL_SEN_ID id, CTL_SEN_PWR_CTRL_FLAG flag, CTL_SEN_CLK_CB clk_cb);
static ER sen_open_os02k10(CTL_SEN_ID id);
static ER sen_close_os02k10(CTL_SEN_ID id);
static ER sen_sleep_os02k10(CTL_SEN_ID id);
static ER sen_wakeup_os02k10(CTL_SEN_ID id);
static ER sen_write_reg_os02k10(CTL_SEN_ID id, CTL_SEN_CMD *cmd);
static ER sen_read_reg_os02k10(CTL_SEN_ID id, CTL_SEN_CMD *cmd);
static ER sen_chg_mode_os02k10(CTL_SEN_ID id, CTL_SENDRV_CHGMODE_OBJ chgmode_obj);
static ER sen_chg_fps_os02k10(CTL_SEN_ID id, UINT32 fps);
static ER sen_set_info_os02k10(CTL_SEN_ID id, CTL_SENDRV_CFGID drv_cfg_id, void *data);
static ER sen_get_info_os02k10(CTL_SEN_ID id, CTL_SENDRV_CFGID drv_cfg_id, void *data);
static UINT32 sen_calc_chgmode_vd_os02k10(CTL_SEN_ID id, UINT32 fps);
static UINT32 sen_calc_exp_vd_os02k10(CTL_SEN_ID id, UINT32 fps);
static void sen_set_gain_os02k10(CTL_SEN_ID id, void *param);
static void sen_set_expt_os02k10(CTL_SEN_ID id, void *param);
static void sen_set_preset_os02k10(CTL_SEN_ID id, ISP_SENSOR_PRESET_CTRL *ctrl);
static void sen_set_flip_os02k10(CTL_SEN_ID id, CTL_SEN_FLIP *flip);
static ER sen_get_flip_os02k10(CTL_SEN_ID id, CTL_SEN_FLIP *flip);
#if defined(__FREERTOS)
void sen_get_gain_os02k10(CTL_SEN_ID id, void *param);
void sen_get_expt_os02k10(CTL_SEN_ID id, void *param);
#else
static void sen_get_gain_os02k10(CTL_SEN_ID id, void *param);
static void sen_get_expt_os02k10(CTL_SEN_ID id, void *param);
#endif
static void sen_get_min_expt_os02k10(CTL_SEN_ID id, void *param);
static void sen_get_mode_basic_os02k10(CTL_SENDRV_GET_MODE_BASIC_PARAM *mode_basic);
static void sen_get_attr_basic_os02k10(CTL_SENDRV_GET_ATTR_BASIC_PARAM *data);
static void sen_get_attr_signal_os02k10(CTL_SENDRV_GET_ATTR_SIGNAL_PARAM *data);
static ER sen_get_attr_cmdif_os02k10(CTL_SEN_ID id, CTL_SENDRV_GET_ATTR_CMDIF_PARAM *data);
static ER sen_get_attr_if_os02k10(CTL_SENDRV_GET_ATTR_IF_PARAM *data);
static void sen_get_fps_os02k10(CTL_SEN_ID id, CTL_SENDRV_GET_FPS_PARAM *data);
static void sen_get_speed_os02k10(CTL_SEN_ID id, CTL_SENDRV_GET_SPEED_PARAM *data);
static void sen_get_mode_mipi_os02k10(CTL_SENDRV_GET_MODE_MIPI_PARAM *data);
static void sen_get_modesel_os02k10(CTL_SENDRV_GET_MODESEL_PARAM *data);
static UINT32 sen_calc_rowtime_os02k10(CTL_SEN_ID id, CTL_SEN_MODE mode);
static UINT32 sen_calc_rowtime_step_os02k10(CTL_SEN_ID id, CTL_SEN_MODE mode);
static void sen_get_rowtime_os02k10(CTL_SEN_ID id, CTL_SENDRV_GET_MODE_ROWTIME_PARAM *data);
static void sen_set_cur_fps_os02k10(CTL_SEN_ID id, UINT32 fps);
static UINT32 sen_get_cur_fps_os02k10(CTL_SEN_ID id);
static void sen_set_chgmode_fps_os02k10(CTL_SEN_ID id, UINT32 fps);
static UINT32 sen_get_chgmode_fps_os02k10(CTL_SEN_ID id);
//=============================================================================
// global variable
//=============================================================================
...
//1928x1084 60FPS 12bit linear mode 4lane LCG 960Mbps
static CTL_SEN_CMD os02k10_mode_1[] = {
	{0x302a, 1, {0x00, 0x0}},
	{0x0103, 1, {0x01, 0x0}},
	{0x0109, 1, {0x01, 0x0}},
	{0x0104, 1, {0x02, 0x0}},
	...
	{0x3757, 1, {0xe7, 0x0}},
	{0x3762, 1, {0x1d, 0x0}},
	{0x376c, 1, {0x10, 0x0}},//0x00 HCG; 0x10 LCG
	{0x3776, 1, {0x05, 0x0}},
	{0x3777, 1, {0x22, 0x0}},
	{0x3779, 1, {0x60, 0x0}},
	{0x377c, 1, {0x48, 0x0}},
	...
	{0x3801, 1, {0x00, 0x0}},
	{0x3802, 1, {0x00, 0x0}},
	{0x3803, 1, {0x02, 0x0}},//;04
	{0x3804, 1, {0x07, 0x0}},
	{0x3805, 1, {0x8f, 0x0}},
	{0x3806, 1, {0x04, 0x0}},
	{0x3807, 1, {0x45, 0x0}},//;43
	{0x3808, 1, {0x07, 0x0}},
	{0x3809, 1, {0x88, 0x0}},//;80
	{0x380a, 1, {0x04, 0x0}},
	{0x380b, 1, {0x3c, 0x0}},//;38
	{0x380c, 1, {0x05, 0x0}},//;04
	{0x380d, 1, {0xa0, 0x0}},//;c8
	{0x380e, 1, {0x04, 0x0}},//;05
	{0x380f, 1, {0xe2, 0x0}},//;b4
	{0x3811, 1, {0x04, 0x0}},//;08
	{0x3813, 1, {0x04, 0x0}},
	{0x3501, 1, {0x04, 0x0}},
	{0x3502, 1, {0xda, 0x0}},
	{0x3002, 1, {0x02, 0x0}},
	...
	{0x3c3b, 1, {0x18, 0x0}},
	{0x3c3d, 1, {0xc9, 0x0}},
	{0x3c55, 1, {0x08, 0x0}},//0x08 LCG;0xcb HCG
	{0x3c5d, 1, {0xec, 0x0}},
	{0x3c5e, 1, {0xec, 0x0}},
	{0x3ce0, 1, {0x00, 0x0}},
	{0x3ce1, 1, {0x00, 0x0}},
	...
	{0x4654, 1, {0x11, 0x0}},
	{0x4655, 1, {0x22, 0x0}},
	{0x4800, 1, {0x64, 0x0}},// 0x04 continue mode ;0x64 non-continue mode
	{0x4810, 1, {0xff, 0x0}},
	{0x4811, 1, {0xff, 0x0}},
	{0x480e, 1, {0x00, 0x0}},
	{0x4813, 1, {0x00, 0x0}},
	...
	// NOTE: Start of motion detection
	{0x3002, 1, {0x02, 0x0}},
	{0x4380, 1, {0x01, 0x0}},
	{0x4382, 1, {0x00, 0x0}},
	{0x4383, 1, {0x02, 0x0}},
	{0x4384, 1, {0x00, 0x0}},
	{0x4398, 1, {0x00, 0x0}},
	// NOTE: End of motion detection
	// NOTE: Start of temperature
	{0x4D07, 1, {0x11, 0x0}},  // Original 0x31
	// NOTE: End of temperature
	{0x3833, 1, {0x40,0x00}},
	{0x0100, 1, {0x01, 0x0}},
};

//1928x1084 30FPS 12bit hdr mode 2lane 1296Mbps
static CTL_SEN_CMD os02k10_mode_2[] = {
	{0x302a, 1, {0x00, 0x0}},
	{0x0103, 1, {0x01, 0x0}},
	{0x0109, 1, {0x01, 0x0}},
	{0x0104, 1, {0x02, 0x0}},
...
//1928x1084 120FPS 10bit linear mode 4lane LCG 960Mbps
static CTL_SEN_CMD os02k10_mode_3[] = {
	{0x302a, 1, {0x00, 0x0}},
	{0x0103, 1, {0x01, 0x0}},
	{0x0109, 1, {0x01, 0x0}},
	{0x0104, 1, {0x02, 0x0}},
...
//1928x1084 60FPS 12bit linear mode 2lane LCG
static CTL_SEN_CMD os02k10_mode_4[] = {
	{0x302a, 1, {0x00, 0x0}},
	{0x0103, 1, {0x01, 0x0}},
	{0x0109, 1, {0x01, 0x0}},
	{0x0104, 1, {0x02, 0x0}},
...
static CTL_SEN_CMD os02k10_mode_5[] = {
	{0x302a, 1, {0x00, 0x0}},
	{0x0103, 1, {0x01, 0x0}},
	{0x0109, 1, {0x01, 0x0}},
	{0x0104, 1, {0x02, 0x0}},
	...
	{0x0305, 1, {0x50, 0x0}},
	{0x4837, 1, {0x10, 0x0}},
	{0x376c, 1, {0x30, 0x0}},//0x20 HCG; 0x30 LCG
	{0x380e, 1, {0x09, 0x0}},//;06
	{0x380f, 1, {0xc3, 0x0}},//;82
	{0x3501, 1, {0x03, 0x0}},
	{0x3502, 1, {0x3c, 0x0}},
	{0x3541, 1, {0x03, 0x0}},
	{0x3542, 1, {0x3c, 0x0}},
	{0x3833, 1, {0x41, 0x0}}, //for dynamic change lcg/hcg 
	{SEN_CMD_SETVD, 1, {0x00, 0x0}},
	{SEN_CMD_PRESET, 1, {0x00, 0x0}},
	{SEN_CMD_DIRECTION, 1, {0x00, 0x0}},
	// NOTE: Start of motion detection
...
static CTL_SEN_DRV_TAB os02k10_sen_drv_tab = {
	sen_open_os02k10,
	sen_close_os02k10,
	sen_sleep_os02k10,
	sen_wakeup_os02k10,
	sen_write_reg_os02k10,
	sen_read_reg_os02k10,
	sen_chg_mode_os02k10,
	sen_chg_fps_os02k10,
	sen_set_info_os02k10,
	sen_get_info_os02k10,
};

static CTL_SEN_DRV_TAB *sen_get_drv_tab_os02k10(void)
{
	return &os02k10_sen_drv_tab;
}
...
static CTL_SEN_CMD sen_set_cmd_info_os02k10(UINT32 addr, UINT32 data_length, UINT32 data0, UINT32 data1)
{
	CTL_SEN_CMD cmd;
...
#if defined(__KERNEL__)
static void sen_load_cfg_from_compatible_os02k10(struct device_node *of_node)
{
...
static ER sen_open_os02k10(CTL_SEN_ID id)
{
	...
	#if defined(__KERNEL__)
	sen_i2c_reg_cb(sen_load_cfg_from_compatible_os02k10);
	#endif
...
static UINT32 sen_get_cmd_tab_os02k10(CTL_SEN_MODE mode, CTL_SEN_CMD **cmd_tab)
{
	switch (mode) {
	case CTL_SEN_MODE_1:
		*cmd_tab = os02k10_mode_1;
		return sizeof(os02k10_mode_1) / sizeof(CTL_SEN_CMD);

	case CTL_SEN_MODE_2:
		*cmd_tab = os02k10_mode_2;
		return sizeof(os02k10_mode_2) / sizeof(CTL_SEN_CMD);

	case CTL_SEN_MODE_3:
		*cmd_tab = os02k10_mode_3;
		return sizeof(os02k10_mode_3) / sizeof(CTL_SEN_CMD);

	case CTL_SEN_MODE_4:
		*cmd_tab = os02k10_mode_4;
		return sizeof(os02k10_mode_4) / sizeof(CTL_SEN_CMD);

	case CTL_SEN_MODE_5:
		*cmd_tab = os02k10_mode_5;
		return sizeof(os02k10_mode_5) / sizeof(CTL_SEN_CMD);
...
static ER sen_chg_mode_os02k10(CTL_SEN_ID id, CTL_SENDRV_CHGMODE_OBJ chgmode_obj)
{
	...
	if (is_fastboot[id]) {
		...
		sen_set_chgmode_fps_os02k10(id, isp_builtin_get_chgmode_fps(id));
		sen_set_cur_fps_os02k10(id, isp_builtin_get_chgmode_fps(id));
		sen_set_gain_os02k10(id, &sensor_ctrl);
		sen_set_expt_os02k10(id, &sensor_ctrl);
		#endif
	...
	cmd_num = sen_get_cmd_tab_os02k10(chgmode_obj.mode, &p_cmd_list);
	if (p_cmd_list == NULL) {
	...
	if (basic_param.property & CTL_SEN_SUPPORT_PROPERTY_CHGFPS) {
		sensor_vd = sen_calc_chgmode_vd_os02k10(id, chgmode_obj.frame_rate);
	} else {
		DBG_WRN(" not support fps adjust \r\n");
		sen_set_cur_fps_os02k10(id, mode_basic_param[cur_sen_mode[id]].dft_fps);
		sen_set_chgmode_fps_os02k10(id, mode_basic_param[cur_sen_mode[id]].dft_fps);
	...
	for (idx = 0; idx < cmd_num; idx++) {
		if (p_cmd_list[idx].addr == SEN_CMD_DELAY) {
			...
			cmd = sen_set_cmd_info_os02k10(0x380E, 1, (sensor_vd >> 8) & 0xFF, 0x00);
			rt |= sen_write_reg_os02k10(id, &cmd);
			cmd = sen_set_cmd_info_os02k10(0x380F, 1, sensor_vd & 0xFF, 0x00);
			rt |= sen_write_reg_os02k10(id, &cmd);
			...
			sen_set_flip_os02k10(id, &flip);
		} else {
			cmd = sen_set_cmd_info_os02k10(p_cmd_list[idx].addr, p_cmd_list[idx].data_len, p_cmd_list[idx].data[0], p_cmd_list[idx].data[1]);
			rt |= sen_write_reg_os02k10(id, &cmd);
		}
	}
...
static ER sen_chg_fps_os02k10(CTL_SEN_ID id, UINT32 fps)
{
	...
	if (basic_param.property & CTL_SEN_SUPPORT_PROPERTY_CHGFPS) {
		sensor_vd = sen_calc_chgmode_vd_os02k10(id, fps);
	} else {
		DBG_WRN(" not support fps adjust \r\n");
		sen_set_cur_fps_os02k10(id, mode_basic_param[cur_sen_mode[id]].dft_fps);
		sen_set_chgmode_fps_os02k10(id, mode_basic_param[cur_sen_mode[id]].dft_fps);
...
static ER sen_set_info_os02k10(CTL_SEN_ID id, CTL_SENDRV_CFGID drv_cfg_id, void *data)
{
	...
	case CTL_SENDRV_CFGID_SET_EXPT:
		sen_set_expt_os02k10(id, data);
		break;
	case CTL_SENDRV_CFGID_SET_GAIN:
		sen_set_gain_os02k10(id, data);
		break;
	case CTL_SENDRV_CFGID_FLIP_TYPE:
		sen_set_flip_os02k10(id, (CTL_SEN_FLIP *)(data));
		break;
	case CTL_SENDRV_CFGID_USER_DEFINE1:
		sen_set_preset_os02k10(id, (ISP_SENSOR_PRESET_CTRL *)(data));
		break;
	default:
		return E_NOSPT;
	}
...
static ER sen_get_info_os02k10(CTL_SEN_ID id, CTL_SENDRV_CFGID drv_cfg_id, void *data)
{
	...
	case CTL_SENDRV_CFGID_GET_EXPT:
		sen_get_expt_os02k10(id, data);
		break;
	case CTL_SENDRV_CFGID_GET_GAIN:
		sen_get_gain_os02k10(id, data);
		break;
	case CTL_SENDRV_CFGID_GET_ATTR_BASIC:
		sen_get_attr_basic_os02k10((CTL_SENDRV_GET_ATTR_BASIC_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_ATTR_SIGNAL:
		sen_get_attr_signal_os02k10((CTL_SENDRV_GET_ATTR_SIGNAL_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_ATTR_CMDIF:
		rt = sen_get_attr_cmdif_os02k10(id, (CTL_SENDRV_GET_ATTR_CMDIF_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_ATTR_IF:
		rt = sen_get_attr_if_os02k10((CTL_SENDRV_GET_ATTR_IF_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_FPS:
		sen_get_fps_os02k10(id, (CTL_SENDRV_GET_FPS_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_SPEED:
		sen_get_speed_os02k10(id, (CTL_SENDRV_GET_SPEED_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_MODE_BASIC:
		sen_get_mode_basic_os02k10((CTL_SENDRV_GET_MODE_BASIC_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_MODE_MIPI:
		sen_get_mode_mipi_os02k10((CTL_SENDRV_GET_MODE_MIPI_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_MODESEL:
		sen_get_modesel_os02k10((CTL_SENDRV_GET_MODESEL_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_MODE_ROWTIME:
		sen_get_rowtime_os02k10(id, (CTL_SENDRV_GET_MODE_ROWTIME_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_FLIP_TYPE:
		rt = sen_get_flip_os02k10(id, (CTL_SEN_FLIP *)(data));
		break;
	case CTL_SENDRV_CFGID_USER_DEFINE2:
		sen_get_min_expt_os02k10(id, data);
		break;
	default:
		rt = E_NOSPT;
	}
...
static UINT32 sen_calc_chgmode_vd_os02k10(CTL_SEN_ID id, UINT32 fps)
{
	...
	sen_set_chgmode_fps_os02k10(id, fps);
	sen_set_cur_fps_os02k10(id, fps);
...
static void sen_set_gain_os02k10(CTL_SEN_ID id, void *param)
{
	...
	static UINT32 last_hcg_reg1[CTL_SEN_ID_MAX] = {0}, last_hcg_reg2[CTL_SEN_ID_MAX] = {0};
	UINT32 hcg_reg1 = 0, hcg_reg2 = 0, flag = 0, hcg_change_flag = 0;
	UINT32 change_frame_id[2] = {0};
	static UINT32 last_change_frame_id[CTL_SEN_ID_MAX][2] = {{0}};
	ER rt = E_OK;
	...
	if (mode_basic_param[cur_sen_mode[id]].mode_type == CTL_SEN_MODE_STAGGER_HDR) {
		if ((last_hcg_reg1[id]==0) && (last_hcg_reg2[id]==0)) { 
			cmd = sen_set_cmd_info_os02k10(0x376C, 1, 0x0, 0x0);
			rt |= sen_read_reg_os02k10(id, &cmd);
			last_hcg_reg1[id] = cmd.data[0];
			cmd = sen_set_cmd_info_os02k10(0x3C55, 1, 0x0, 0x0);
			rt |= sen_read_reg_os02k10(id, &cmd);
	...
	for (frame_cnt = 0; frame_cnt < total_frame; frame_cnt++) {
		...
		if (mode_basic_param[cur_sen_mode[id]].mode_type == CTL_SEN_MODE_LINEAR) {
			if ((HCG_ENABLE) && (4000 <= (sensor_ctrl->gain_ratio[frame_cnt]))) {
				sensor_ctrl->gain_ratio[frame_cnt] /= 4;
				hcg_change_flag = 1;
			}
		}
	...
	if (mode_basic_param[cur_sen_mode[id]].mode_type == CTL_SEN_MODE_LINEAR) {
		...
		if ((last_hcg_reg1[id] != hcg_reg1) && (last_hcg_reg2[id] != hcg_reg2)) {
			cmd = sen_set_cmd_info_os02k10(0x3208, 1, 0x00, 0x0);
			rt |= sen_write_reg_os02k10(id, &cmd);

			cmd = sen_set_cmd_info_os02k10(0x3504, 1, 0x18, 0x0);
			rt |= sen_write_reg_os02k10(id, &cmd);

			cmd = sen_set_cmd_info_os02k10(0x376C, 1, hcg_reg1, 0x0);
			rt |= sen_write_reg_os02k10(id, &cmd);
			cmd = sen_set_cmd_info_os02k10(0x3C55, 1, hcg_reg2, 0x0);
			rt |= sen_write_reg_os02k10(id, &cmd);
			flag = 1;
		} else {
			cmd = sen_set_cmd_info_os02k10(0x3208, 1, 0x00, 0x0);
	...
	if (mode_basic_param[cur_sen_mode[id]].mode_type == CTL_SEN_MODE_LINEAR) {
		// Write sensor gain
		//Set analog gain
		cmd = sen_set_cmd_info_os02k10(0x3508, 1, (data1[0] >> 4) & 0x0F, 0x0);
		rt |= sen_write_reg_os02k10(id, &cmd);
		cmd = sen_set_cmd_info_os02k10(0x3509, 1, (data1[0] & 0x0F) << 4, 0x0);
		rt |= sen_write_reg_os02k10(id, &cmd);

		//Set Digital gain
		cmd = sen_set_cmd_info_os02k10(0x350A, 1, (data2[0] >> 10) & 0x0F, 0x0);
		rt |= sen_write_reg_os02k10(id, &cmd);
		cmd = sen_set_cmd_info_os02k10(0x350B, 1, (data2[0] >> 2) & 0xFF, 0x0);
		rt |= sen_write_reg_os02k10(id, &cmd);
		cmd = sen_set_cmd_info_os02k10(0x350C, 1, (data2[0] & 0x03) << 6, 0x0);
		rt |= sen_write_reg_os02k10(id, &cmd);

		cmd = sen_set_cmd_info_os02k10(0x3208, 1, 0x10, 0x0);
		rt |= sen_write_reg_os02k10(id, &cmd);
		cmd = sen_set_cmd_info_os02k10(0x320d, 1, 0x00, 0x0);
		rt |= sen_write_reg_os02k10(id, &cmd);

		if (flag) {
			cmd = sen_set_cmd_info_os02k10(0x3208, 1, 0xA0, 0x0);
			rt |= sen_write_reg_os02k10(id, &cmd);
			cmd = sen_set_cmd_info_os02k10(0x3504, 1, 0x08, 0x0);
			rt |= sen_write_reg_os02k10(id, &cmd);
		} else {
			cmd = sen_set_cmd_info_os02k10(0x3208, 1, 0xE0, 0x0);
			rt |= sen_write_reg_os02k10(id, &cmd);
		}
		...
		if ((mode_basic_param[cur_sen_mode[id]].frame_num) == 2) {
			...
			rt |= sen_write_reg_os02k10(id, &cmd);
			//Short Gain
			cmd = sen_set_cmd_info_os02k10(0x3548, 1, (data1[1] >> 4) & 0x0F, 0x0);
			rt |= sen_write_reg_os02k10(id, &cmd);
			cmd = sen_set_cmd_info_os02k10(0x3549, 1, (data1[1] & 0x0F) << 4, 0x0);
			rt |= sen_write_reg_os02k10(id, &cmd);
			...
			cmd = sen_set_cmd_info_os02k10(0x354A, 1, (data2[1] >> 10) & 0x0F, 0x0);
			rt |= sen_write_reg_os02k10(id, &cmd);
			cmd = sen_set_cmd_info_os02k10(0x354B, 1, (data2[1] >> 2) & 0xFF, 0x0);
			rt |= sen_write_reg_os02k10(id, &cmd);
			cmd = sen_set_cmd_info_os02k10(0x354C, 1, (data2[1] & 0x03) << 6, 0x0);
			rt |= sen_write_reg_os02k10(id, &cmd);
			cmd = sen_set_cmd_info_os02k10(0x3208, 1, 0x10, 0x0);
			rt |= sen_write_reg_os02k10(id, &cmd);
			cmd = sen_set_cmd_info_os02k10(0x320d, 1, 0x00, 0x0);
...
static void sen_set_expt_os02k10(CTL_SEN_ID id, void *param)
{
	...
	for (frame_cnt = 0; frame_cnt < total_frame; frame_cnt++) {
		...
		t_row = sen_calc_rowtime_os02k10(id, cur_sen_mode[id]);
		if (0 == t_row) {
	...
	// Write exposure line
	// Get fps
	chgmode_fps = sen_get_chgmode_fps_os02k10(id);
	...
	sen_set_cur_fps_os02k10(id, cur_fps);

	// Calculate new vd
	sensor_vd = sen_calc_exp_vd_os02k10(id, cur_fps);
	...
	cmd = sen_set_cmd_info_os02k10(0x380E, 1, (sensor_vd >> 8) & 0xFF, 0);
	rt |= sen_write_reg_os02k10(id, &cmd);

	cmd = sen_set_cmd_info_os02k10(0x380F, 1, sensor_vd & 0xFF, 0);
	rt |= sen_write_reg_os02k10(id, &cmd);
	...
	if (mode_basic_param[cur_sen_mode[id]].mode_type == CTL_SEN_MODE_LINEAR) {
		...
		cmd = sen_set_cmd_info_os02k10(0x3501, 1, (line[0] >> 8) & 0xFF, 0);
		rt |= sen_write_reg_os02k10(id, &cmd);
		cmd = sen_set_cmd_info_os02k10(0x3502, 1, line[0] & 0xFF , 0);
		rt |= sen_write_reg_os02k10(id, &cmd);
	} else if (mode_basic_param[cur_sen_mode[id]].mode_type == CTL_SEN_MODE_STAGGER_HDR) {
		if ((mode_basic_param[cur_sen_mode[id]].frame_num) == 2) {
			if (line[0] < MIN_EXPOSURE_LINE) {
			...
			if ((line[0]+line[1]) > (sensor_vd - NON_2HDR_EXPOSURE_LINE)) {
				line[0] = sensor_vd - NON_2HDR_EXPOSURE_LINE - line[1];
			}
			// set exposure line to sensor
			//L exp
			cmd = sen_set_cmd_info_os02k10(0x3501, 1, ( line[0] >> 8 ) & 0xFF, 0);
			...
			//S exp
			cmd = sen_set_cmd_info_os02k10(0x3541, 1, ( line[1] >> 8 ) & 0xFF, 0);
			rt |= sen_write_reg_os02k10(id, &cmd);
			cmd = sen_set_cmd_info_os02k10(0x3542, 1, line[1] & 0xFF , 0);
			rt |= sen_write_reg_os02k10(id, &cmd);
		}
	}
	if (rt != E_OK) {
...
static void sen_set_flip_os02k10(CTL_SEN_ID id, CTL_SEN_FLIP *flip)
{
	...
	cmd = sen_set_cmd_info_os02k10(0x3820, 1, 0x0, 0x0);
	rt |= sen_read_reg_os02k10(id, &cmd);
...
static void sen_get_fps_os02k10(CTL_SEN_ID id, CTL_SENDRV_GET_FPS_PARAM *data)
{
	data->cur_fps = sen_get_cur_fps_os02k10(id);
	data->chg_fps = sen_get_chgmode_fps_os02k10(id);
}
...
static void sen_get_rowtime_os02k10(CTL_SEN_ID id, CTL_SENDRV_GET_MODE_ROWTIME_PARAM *data)
{
	data->row_time_step = sen_calc_rowtime_step_os02k10(id, data->mode);
	data->row_time = sen_calc_rowtime_os02k10(id, data->mode) * (data->row_time_step);
}
...
#if defined(__FREERTOS)
void sen_get_i2c_id_os02k10(CTL_SEN_ID id, UINT32 *i2c_id)
{
	*i2c_id = sen_i2c[id].id;
}

void sen_get_i2c_addr_os02k10(CTL_SEN_ID id, UINT32 *i2c_addr)
{
	*i2c_addr = sen_i2c[id].addr;
}

int sen_init_os02k10(SENSOR_DTSI_INFO *info)
{
	...
	sprintf(compatible, "nvt,sen_os02k10");
	if (sen_common_check_compatible(compatible)) {
		...
		sprintf(node_path, "/sensor/sen_cfg/sen_os02k10");
	...
	reg_obj.pwr_ctrl = sen_pwr_ctrl_os02k10;
	reg_obj.det_plug_in = NULL;
	reg_obj.drv_tab = sen_get_drv_tab_os02k10();
	rt = ctl_sen_reg_sendrv("nvt_sen_os02k10", &reg_obj);
	if (rt != E_OK) {
...
void sen_exit_os02k10(void)
{
	ctl_sen_unreg_sendrv("nvt_sen_os02k10");
}

#else
static int __init sen_init_os02k10(void)
{
...
static void __exit sen_exit_os02k10(void)
{
	ctl_sen_unreg_sendrv("nvt_sen_os02k10");
}

module_init(sen_init_os02k10);
module_exit(sen_exit_os02k10);

MODULE_AUTHOR("Novatek Corp.");
MODULE_DESCRIPTION(SEN_OS02K10_MODULE_NAME);
MODULE_LICENSE("GPL");
#endif
