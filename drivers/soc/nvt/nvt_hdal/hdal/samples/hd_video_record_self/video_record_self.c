...
static void *encode_thread(void *arg)
{
	...
	if (p_stream0->enc_type == 0) {
		snprintf(file_path_main, 256, "/mnt/sd/video_bs_%d_%d_h265.dat", VDO_SIZE_W, VDO_SIZE_H);
		snprintf(file_path_len, 256, "/mnt/sd/video_bs_%d_%d_h265.len", VDO_SIZE_W, VDO_SIZE_H);
	} else if (p_stream0->enc_type == 1) {
		snprintf(file_path_main, 256, "/mnt/sd/video_bs_%d_%d_h264.dat", VDO_SIZE_W, VDO_SIZE_H);
		snprintf(file_path_len, 256, "/mnt/sd/video_bs_%d_%d_h264.len", VDO_SIZE_W, VDO_SIZE_H);
	} else if (p_stream0->enc_type == 2) {
		snprintf(file_path_main, 256, "/mnt/sd/video_bs_%d_%d_jpeg.dat", VDO_SIZE_W, VDO_SIZE_H);
