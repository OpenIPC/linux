...
#endif
#define H26X_HW_VERSION_560					0x03131256
...
#define H26X_REG_PLUG_IN_3_FINISH_OFFSET  	0x9E0
...
extern UINT32 h26x_getHwVersion(void);
...
extern void h26x_setDmaChDis2(void);
extern void h26x_setChkSumEn(BOOL enable);
extern void h26x_setAPBLoadEn(void);
extern void h26x_setNextBsSize(UINT32 uiSize);
...
extern void h26x_getEncReport(UINT32 uiEncReport[H26X_REPORT_NUM]);
extern void h26x_getEncReport2(UINT32 uiEncReport[H26X_REPORT_2_NUM]);
...
extern UINT32 h26x_getVirAddr(UINT32 uiAddr);

// cache //
extern void h26x_flushCache(UINT32 uiAddr, UINT32 uiSize);
extern void h26x_flushCacheRead(UINT32 uiAddr, UINT32 uiSize);
...
extern UINT32 h26x_getBsOutSize(void);
...
extern UINT32 h26x_getStableLen(void);
extern UINT32 h26x_getNalLen(UINT32 uiSel);
extern UINT32 h26x_getStableSliceNum(void);
extern void h26x_setCodecClock(BOOL enable);
extern void h26x_setCodecPClock(BOOL enable);

extern UINT32 h26x_getBslen(void);

extern void h26xEmuClkSel(UINT32 uiVal);
extern UINT32 h26x_getCtrl(void);
// for kdrv //
...
extern UINT32 h26x_getDramChkSum(UINT32 adr, UINT32 len);
extern UINT32 h26x_calDramChkSum(UINT32 adr, UINT32 len);
#endif
