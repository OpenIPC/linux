...
#include "../jpeg/kdrv_jpeg_queue.h"
...
extern ER jpeg_set_fpga_sde_reg(UINT32 *ycc_reg);
// pad reg //
...
extern UINT32 jpeg_get_osg_debug(UINT32 oft);
// osg emulation function //
extern ER jpeg_set_fpga_osg_win_reg(UINT32 osg_graph_reg[10][9], UINT32 osg_chroma);
extern ER jpeg_set_fpga_osg_cst_reg(UINT32 *osg_cst_reg);
extern ER jpeg_set_fpga_osg_pal_reg(UINT32 *osg_pal);
extern ER jpeg_set_fpga_osg_win_disable(void);
// ycc api //
