...
#if _USE_USB_CH2_
#define USB_SETREG(ofs, value)          OUTW(IOADDR_USB2_REG_BASE+(ofs), (value))
#define USB_GETREG(ofs)                 INW(IOADDR_USB2_REG_BASE+(ofs))
#else
#define USB_SETREG(ofs, value)          OUTW(IOADDR_USB528_REG_BASE+(ofs), (value))
#define USB_GETREG(ofs)                 INW(IOADDR_USB528_REG_BASE+(ofs))
#define USBPHY_SETREG(ofs, value)       OUTW(IOADDR_USB_REG_BASE+(ofs), (value))
#define USBPHY_GETREG(ofs)              INW(IOADDR_USB_REG_BASE+(ofs))
#endif
...
#define MAX_VDMA_LEN           128 * 1024 - 4
...
#define USB_PutString(x)            {DBG_DUMP(x);}
#define USB_PutString1(x,y)         {DBG_DUMP((x),(y));}
#else
...
extern void USBCtlStartTsk(void *pvParameters);
extern void USBSetupHalTsk(void *pvParameters);
...
extern void             usb528_initFOTG200(void);
extern void             usb_setControllerState(USB_CONTROLLER_STATE eUSBCtrlState);
extern void             usb2dev528_set_vbusi(BOOL bPlug);
...
extern irqreturn_t      usb528_isr(int irq, void *devid);
...
/*
extern void                 usb2dev528_init_management(USB_MNG *p_management);
extern ER                   usb2dev528_set_management(USB_MNG *p_management);
extern ER                   usb2dev528_get_management(USB_MNG *p_management);
extern ER                   usb2dev528_open(void);
extern USB_CHARGER_STS      usb2dev528_check_charger(UINT32 debounce);
extern void                 usb2dev528_power_on_init(BOOL highspeed);
extern BOOL                 usb2dev528_state_change(void);
extern ER                   usb2dev528_close(void);
extern void                 usb2dev528_set_vbusi(BOOL plug);
extern void                 usb2dev528_set_standby_wakeup(DRV_CB fp_isr);
extern USB_CONTROLLER_STATE usb2dev528_get_controller_state(void);
extern BOOL                 usb2dev528_check_configured(void);
extern ER                   usb2dev528_set_config(USB_CONFIG_ID config_id, UINT32 config_context);
extern UINT32               usb2dev528_get_config(USB_CONFIG_ID config_id);
extern ER                   usb2dev528_set_callback(USB_CALLBACK callback_id, USB_GENERIC_CB p_callback);
extern BOOL                 usb2dev528_is_highspeed_enabled(void);
extern void                 usb2dev528_reture_setup_data(void);
extern ER                   usb2dev528_read_endpoint(USB_EP epn, UINT8 *p_buffer, UINT32 *p_dma_length);
extern ER                   usb2dev528_write_endpoint(USB_EP epn, UINT8 *p_buffer, UINT32 *p_dma_length);
extern ER                   usb2dev528_abort_endpoint(USB_EP epn);
extern ER                   usb2dev528_set_ep_read(USB_EP epn, UINT8 *p_buffer, UINT32 *p_dma_length);
extern ER                   usb2dev528_set_ep_write(USB_EP epn, UINT8 *p_buffer, UINT32 *p_dma_length);
extern ER                   usb2dev528_wait_ep_done(USB_EP epn, UINT32 *p_dma_length);
extern void                 usb2dev528_set_ep_config(USB_EP epn, USB_EPCFG_ID config_id, UINT32 config_value);
extern UINT32               usb2dev528_get_ep_config(USB_EP epn, USB_EPCFG_ID config_id);
extern void                 usb2dev528_mask_ep_interrupt(USB_EP epn);
extern void                 usb2dev528_unmask_ep_interrupt(USB_EP epn);
extern void                 usb2dev528_set_ep0_done(void);
extern void                 usb2dev528_set_ep_stall(USB_EP epn);
extern void                 usb2dev528_clear_ep_fifo(USB_EP epn);
extern void                 usb2dev528_clear_fifo(void);
extern void                 usb2dev528_set_tx0byte(USB_EP epn);
extern UINT32               usb2dev528_get_ep_bytecount(USB_EP epn);
extern BOOL                 usb2dev528_check_ep_empty(USB_EP epn);
extern BOOL                 usb2dev528_check_ep_busy(USB_EP epn);
extern UINT32               usb2dev528_get_sof_number(void);
*/

extern BOOL usb_get_fifo_in_int_en(USB_FIFO_NUM FIFOn);
extern BOOL usb_get_fifo_out_int_en(USB_FIFO_NUM FIFOn);
