...
typedef enum {
	NAND_DLL_PHY_PAD_CLOCK_AFTER_PAD = 0x0,
	NAND_DLL_PHY_PAD_CLOCK_BEFORE_PAD,

	NAND_DLL_PHY_PAD_CLOCK_NUM,
	ENUM_DUMMY4WORD(NAND_DLL_PHY_PAD_CLOCK_SEL)
} NAND_DLL_PHY_PAD_CLOCK_SEL;
