...
typedef struct {
	...
	UINT32 CPU: 2;                              //< CPU
	UINT32 USB_0: 2;                            //< USB_0
	UINT32 USB_1: 2;                            //< USB_1
	...
	UINT32 NUE_0: 2;                            //< NUE_0 (in)
	UINT32 NUE_1: 2;                            //< NUE_1 (in)
	UINT32 NUE_2: 2;                            //< NUE_2 (out)
...
typedef enum {
	...
	DMA_QOS_CH_ETH,                             //< QoS channel: ethernet
	DMA_QOS_CH_USB,                             //< QoS channel: USB
