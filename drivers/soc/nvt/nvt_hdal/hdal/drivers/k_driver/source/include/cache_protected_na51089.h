...
extern void 	cpu_v7_outer_cache_disable(void);
extern void 	cpu_v7_outer_cache_enable(void);
extern void 	cpu_invalidateDCacheL1(void);
extern void 	cpu_invalidateDCacheL2(void);
