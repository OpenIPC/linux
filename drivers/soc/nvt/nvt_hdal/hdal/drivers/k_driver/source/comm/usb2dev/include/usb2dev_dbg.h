#ifndef __USB2DEV_DBG_H_
#define __USB2DEV_DBG_H_
...
extern unsigned int usb2dev_debug_level;
#define nvt_dbg(level, fmt, args...)                \
do {                                               \
if (unlikely(NVT_DBG_##level <= usb2dev_debug_level))    \
...
//#define USB2DEV_API_DBG
#ifdef USB2DEV_API_DBG
#define usb2dev_api  printk
#else
#define usb2dev_api(fmt, ...)
#endif
