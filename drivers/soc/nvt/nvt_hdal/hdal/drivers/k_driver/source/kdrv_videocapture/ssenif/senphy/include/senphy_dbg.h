#ifndef __SENPHY_DBG_H_
#define __SENPHY_DBG_H_
...
extern unsigned int senphy_debug_level;
#define nvt_dbg(level, fmt, args...)                \
do {                                               \
if (unlikely(NVT_DBG_##level <= senphy_debug_level))    \
...
//#define SENPHY_API_DBG
#ifdef SENPHY_API_DBG
#define senphy_api  printk
#else
#define senphy_api(fmt, ...)
#endif
