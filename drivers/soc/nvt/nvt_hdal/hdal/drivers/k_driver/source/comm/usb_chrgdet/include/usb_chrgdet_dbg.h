#ifndef __USB_CHRGDET_DBG_H_
#define __USB_CHRGDET_DBG_H_
...
extern unsigned int usb_chrgdet_debug_level;
#define nvt_dbg(level, fmt, args...)                \
do {                                               \
if (unlikely(NVT_DBG_##level <= usb_chrgdet_debug_level))    \
...
//#define USB_CHRGDET_API_DBG
#ifdef USB_CHRGDET_API_DBG
#define usb_chrgdet_api  printk
#else
#define usb_chrgdet_api(fmt, ...)
#endif
