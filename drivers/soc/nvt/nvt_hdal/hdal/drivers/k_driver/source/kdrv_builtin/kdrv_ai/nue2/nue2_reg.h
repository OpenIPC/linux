...
/*
    NUE2 APP DMA WAIT   [0x0, 0x1],		bits : 31_0
*/
#define NUE2_APP_DMA_WAIT_REGISTER_OFS_560 0x00c8
REGDEF_BEGIN(NUE2_APP_DMA_WAIT_REGISTER_560)
    REGDEF_BIT(APP_DMA_WAIT,       32)
REGDEF_END(NUE2_APP_DMA_WAIT_REGISTER_560)
...
typedef struct
{
	...
	//0x00c8
	T_NUE2_APP_DMA_WAIT_REGISTER_560
	NUE2_Register_00c8;
