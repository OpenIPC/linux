...
typedef enum {
	...
	USB_CONFIG_ID_CHECK_CXOUT,					///< Get CX OUT is ready or not. 0: Not Ready. 1: Ready.
...
extern UINT32				usb2dev_set_ep_read_queue(USB_EP epn, UINT8 *p_buffer, UINT32 *p_dma_length);
