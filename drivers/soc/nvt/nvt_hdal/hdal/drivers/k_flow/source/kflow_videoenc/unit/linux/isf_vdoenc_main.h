#ifndef __ISF_VDOENC_MAIN_H
#define __ISF_VDOENC_MAIN_H
...
#define MODULE_NAME          "isf_vdoenc"

typedef struct _ISF_VDOENC_DRV_INFO {
	ISF_VDOENC_INFO module_info;
	...
	struct proc_dir_entry *p_proc_top_entry;
} ISF_VDOENC_DRV_INFO, *PISF_VDOENC_DRV_INFO;
