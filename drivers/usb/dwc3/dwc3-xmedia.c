...
static const struct of_device_id bsp_dwc3_match[] = {
	{ .compatible = "xmedia,dwusb2" },
	{ .compatible = "xmedia,dwusb3" },
	{},
};
...
MODULE_DESCRIPTION("DesignWare USB3 of Xmedia");
MODULE_AUTHOR("Xmedia Technologies Co., Ltd..>");
