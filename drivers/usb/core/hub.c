...
//#if 0
		if (bU2RH) {
			regmap_update_bits((struct regmap *)hcd->utmi_base, (0x16 << 2), 0x03F0, 0x0010);
			regmap_update_bits((struct regmap *)hcd->utmi_base, (0x17 << 2), 0x8138, 0x0000);
...
//#if 0
		if (bU2RH) {//_USB_HS_CHIRP_PATCH
			regmap_update_bits((struct regmap *)hcd->utmi_base, (0x16 << 2), 0x03F0, 0x0210);
			regmap_update_bits((struct regmap *)hcd->utmi_base, (0x17 << 2), 0x8138, 0x8100);
