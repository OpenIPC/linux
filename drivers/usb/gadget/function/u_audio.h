...
#define CAPTURE_VOLUME_MAX	(10)
#define CAPTURE_VOLUME_MIN	(-10)
#define CAPTURE_VOLUME_STEP	(1)
#define CAPTURE_VOLUME_CUR	(CAPTURE_VOLUME_MAX)

#define UAC_VOLUME_ATTR_TO_DB(attr)	(s8)((short)attr / UAC_VOLUME_STEP)
#define DB_TO_UAC_VOLUME_ATTR(db)	(short)(db * UAC_VOLUME_STEP)
