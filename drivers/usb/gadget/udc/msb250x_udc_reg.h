...
#define CHIPTOP_BASE_ADDR  GET_REG_ADDR(RIU_BASE, 0x0F00) /* 0xA0008000 */
#define PM_BASE            GET_REG_ADDR(RIU_BASE, 0x1A00)   /* 0xA0006800 */
#elif defined(CONFIG_ARCH_MSB250X)
#define RIU_BASE            MSB250X_BASE_REG_RIU_PA
#define MSB250X_BASE_REG_RIU_UA MSB250X_BASE_REG_RIU_PA
#define UTMI_BASE_ADDR      MSB250X_BASE_REG_USBUTMI_PA    /* 0xA0003E00 */
#define USBC_BASE_ADDR      MSB250X_BASE_REG_USBC_PA       /* 0xA0004A00 */
#define OTG0_BASE_ADDR      MSB250X_BASE_REG_USBOTG_PA     /* 0xA0004C00 */
#define CHIPTOP_BASE_ADDR   MSB250X_BASE_REG_CHIPTOP_PA    /* 0xA0008000 */
#elif defined(CONFIG_ARCH_COLUMBUS2)
#define RIU_BASE            0xA0000000
#define UTMI_BASE_ADDR     GET_UDC_REG_ADDR(RIU_BASE, 0x0F80) 
#define USBC_BASE_ADDR     GET_UDC_REG_ADDR(RIU_BASE, 0x1280)
#define OTG0_BASE_ADDR     GET_UDC_REG_ADDR(RIU_BASE, 0x1300)
//#define CHIPTOP_BASE_ADDR  GET_REG_ADDR(RIU_BASE, 0x0F00) /* 0xA0008000 */
//#define PM_BASE            GET_REG_ADDR(RIU_BASE, 0x1A00)   /* 0xA0006800 */
//#else
...
#define RIU_BASE           0xfd200000//0xbf800000
...
#define RIU_BASE           0xfd000000//0xbf800000
#define UTMI_BASE_ADDR     GET_UDC_REG_ADDR(RIU_BASE, 0x1F00) 
#define USBC_BASE_ADDR     GET_UDC_REG_ADDR(RIU_BASE, 0x2500)
#define OTG0_BASE_ADDR     GET_UDC_REG_ADDR(RIU_BASE, 0x2600)
#define BC_BASE_ADDR       GET_UDC_REG_ADDR(RIU_BASE, 0x1D00)
#endif
#if defined(CONFIG_ARCH_INFINITY) || defined(CONFIG_ARCH_INFINITY3)
#define RIU_BASE           0xfd200000//0xbf800000
#define UTMI_BASE_ADDR     GET_UDC_REG_ADDR(RIU_BASE, 0x42100)
#define USBC_BASE_ADDR     GET_UDC_REG_ADDR(RIU_BASE, 0x42300)
#define OTG0_BASE_ADDR     GET_UDC_REG_ADDR(RIU_BASE, 0x42500)
#endif
...
#define MSB250X_UDC_RXCSR2_AUTOREQ         (1 << 6)
