...
#else
#define MIN_DMA_TRANSFER_BYTES       32 
#endif

#define M_REG_DMA_INTR               /*IO_ADDRESS*/(otgRegAddress) + (0x200<<OffShift)

#define DMA_BASE_ADDRESS()           /*IO_ADDRESS*/(otgRegAddress) + (0x200<<OffShift)
