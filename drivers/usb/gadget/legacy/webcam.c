...
static struct UVC_FRAME_MJPEG(3) uvc_frame_mjpg_424x240p = {
	.bLength		= UVC_DT_FRAME_MJPEG_SIZE(3),
	.bDescriptorType	= USB_DT_CS_INTERFACE,
	.bDescriptorSubType = UVC_VS_FRAME_MJPEG,
	.bFrameIndex		= 2,
	.bmCapabilities 	= 0,
	.wWidth 		= cpu_to_le16(424),
	.wHeight		= cpu_to_le16(240),
	.dwMinBitRate		= cpu_to_le32(424*240*2*8*10),
	.dwMaxBitRate		= cpu_to_le32(424*240*2*8*10), //overflow
	.dwMaxVideoFrameBufferSize	= cpu_to_le32(424*240*2),
	.dwDefaultFrameInterval = cpu_to_le32(333333),
	.bFrameIntervalType = 3,
	.dwFrameInterval[0] = cpu_to_le32(333333),
	.dwFrameInterval[1] = cpu_to_le32(666666),
...
#define UVC_DESCRIPTOR_HEADERS_OF_MJPG_FRAME \
    ...
    (struct uvc_descriptor_header *) &uvc_frame_mjpg_424x240p, \
...
static struct UVC_FRAME_FRAMEBASE(3) uvc_frame_h264_424x240p = {
	.bLength		= UVC_DT_FRAME_MJPEG_SIZE(3),
	.bDescriptorType	= USB_DT_CS_INTERFACE,
	.bDescriptorSubType = UVC_VS_FRAME_FRAME_BASED,
	.bFrameIndex		= 2,
	...
	.wHeight		= cpu_to_le16(240),
	.dwMinBitRate		= cpu_to_le32(424*240*2*8*10),
	.dwMaxBitRate		= cpu_to_le32(424*240*2*8*10),
	.dwDefaultFrameInterval = cpu_to_le32(333333),
	.bFrameIntervalType = 3,
	.dwFrameInterval[0] = cpu_to_le32(333333),
	.dwFrameInterval[1] = cpu_to_le32(666666),
...
#define UVC_DESCRIPTOR_HEADERS_OF_H264_FRAME \
	...
	(struct uvc_descriptor_header *) &uvc_frame_h264_424x240p, \
...
static struct UVC_FRAME_FRAMEBASE(3) uvc_frame_h265_424x240 = {
	.bLength		= UVC_DT_FRAME_MJPEG_SIZE(3),
	.bDescriptorType	= USB_DT_CS_INTERFACE,
	.bDescriptorSubType = UVC_VS_FRAME_FRAME_BASED,
	.bFrameIndex		= 2,
...
#define UVC_DESCRIPTOR_HEADERS_OF_H265_FRAME \
	...
	(struct uvc_descriptor_header *) &uvc_frame_h265_424x240,  \
