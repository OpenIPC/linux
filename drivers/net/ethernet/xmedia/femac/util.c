...
EXPORT_SYMBOL_GPL(femac_check_hw_capability);
...
EXPORT_SYMBOL_GPL(femac_get_pkt_info);
...
EXPORT_SYMBOL_GPL(femac_sleep_us);
...
EXPORT_SYMBOL_GPL(femac_set_flow_ctrl);
...
EXPORT_SYMBOL_GPL(femac_get_pauseparam);
...
EXPORT_SYMBOL_GPL(femac_set_pauseparam);
...
EXPORT_SYMBOL_GPL(femac_enable_rxcsum_drop);
...
EXPORT_SYMBOL_GPL(femac_set_features);
