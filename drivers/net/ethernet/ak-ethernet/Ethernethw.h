...
#define REG_MAC_CTRL                            (0x1480)  /* DWORD reg */
    #define MAC_CTRL_TXEN_OFF                   0	//bit for Tx Enable
    #define MAC_CTRL_TXEN_BITS                  1  //bit for Tx Enable
    #define MAC_CTRL_RXEN_OFF                   1 //bit for Rx Enable
    #define MAC_CTRL_RXEN_BITS                  1 //bit for Rx Enable
    #define MAC_CTRL_TXFC_OFF                   2
    #define MAC_CTRL_TXFC_BITS                  1
    #define MAC_CTRL_RXFC_OFF                   3
    #define MAC_CTRL_RXFC_BITS                  1
    #define MAC_CTRL_LOOPBACK_OFF               4 //MAC loopback
    ...
    #define MAC_CTRL_MUTI_ALL_OFF               25 //bit for mulicast
    #define MAC_CTRL_MUTI_ALL_BITS              1	//bit for mulicast
    #define MAC_CTRL_BROAD_EN_OFF               26	//bit for broadcast
    #define MAC_CTRL_BROAD_EN_BITS              1	//bit for broadcast
    #define MAC_CTRL_DEBUG_MODE_OFF             27	//bit for debug
    #define MAC_CTRL_DEBUG_MODE_BITS            1	//bit for debug
...
#define REG_ISR                                 (0x1600)  /* DWORD reg */
    ...
    #define ISR_GPHY_OFF                        (1<<12) //bit for PHY INT
    #define ISR_GPHY_BITS                       1		//bit for PHY INT
    #define ISR_GPHY_LPW_OFF                    (1<<13)	//bit for PHY INT
    #define ISR_GPHY_LPW_BITS                   1
    #define ISR_TXQ_OFF                         (1<<14)	//bit for Tx INT
    #define ISR_TXQ_BITS                        1
    #define ISR_TX_PKT_OFF                      (1<<15) //bit for Tx INT
    #define ISR_TX_PKT_BITS                     1
    #define ISR_RX0_PKT_OFF                     (1<<16)	//bit for Rx INT
    #define ISR_RX0_PKT_BITS                    1		//bit for Rx INT
    #define ISR_RX1_PKT_OFF                     17		//bit for Rx INT
    #define ISR_RX1_PKT_BITS                    1		//bit for Rx INT
    #define ISR_RX2_PKT_OFF                     18		//bit for Rx INT
    #define ISR_RX2_PKT_BITS                    1		//bit for Rx INT
    #define ISR_RX3_PKT_OFF                     19		//bit for Rx INT
    #define ISR_RX3_PKT_BITS                    1		//bit for Rx INT
    #define ISR_MAC_RX_OFF                      20		//bit for Rx INT
    #define ISR_MAC_RX_BITS                     1		//bit for Rx INT
    #define ISR_MAC_TX_OFF                      21		//bit for Tx INT
