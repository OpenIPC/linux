...
static const struct sunxi_desc_pin sun50iw11p1_pins[] = {
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(G, 11),
		...
		SUNXI_FUNCTION(0x5, "ir-tx"),		/* SPI1_CS/DBI_CSX */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(G, 14),
		...
		SUNXI_FUNCTION(0x3, "i2s1_b"),		/* DOUT1 */
