...
unsigned char reg4663ValTable[26][7] = {
...
unsigned char reg4663ValTable_wdr[26][7] = {
	//2b3  2b4   2b8   2b9	 515   519   2d9
...
static int sensor_s_hflip(struct v4l2_subdev *sd, int enable)
{
	...
	sensor_print("<sensor_s_vflip> 1. 0x0101 = 0x%x\n", get_value);
	if (enable)
...
//	sensor_read(sd, 0x0101, &get_value);
//	sensor_print("<sensor_s_vflip> 2. 0x0101 = 0x%x\n", get_value);
