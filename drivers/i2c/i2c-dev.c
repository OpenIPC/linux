...
static const struct i2c_vender_operations *i2c_vops;
void i2c_operations_register(const struct i2c_vender_operations *_i2c_vops)
{
	i2c_vops = _i2c_vops;
}
EXPORT_SYMBOL(i2c_operations_register);

void i2c_operations_unregister(void)
{
	i2c_vops = NULL;
}
EXPORT_SYMBOL(i2c_operations_unregister);
...
static noinline int i2c_config_mul_reg(struct i2c_client *client, unsigned long arg)
{
	...
	if (i2c_vops && i2c_vops->i2c_master_send_mul_reg)
		i2c_vops->i2c_master_send_mul_reg(client, msg.buf, msg.len, reg_data_width);
