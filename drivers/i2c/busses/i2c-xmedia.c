...
static inline void xmedia_i2c_disable(struct xmedia_i2c_dev *i2c);
static inline void xmedia_i2c_cfg_irq(struct xmedia_i2c_dev *i2c,
				     unsigned int flag);
static inline unsigned int xmedia_i2c_clr_irq(struct xmedia_i2c_dev *i2c);
static inline void xmedia_i2c_enable(struct xmedia_i2c_dev *i2c);
...
static void xmedia_i2c_rescue(struct xmedia_i2c_dev *i2c)
{
	unsigned int val;
...
static inline void xmedia_i2c_disable_irq(struct xmedia_i2c_dev *i2c,
		unsigned int flag)
{
	unsigned int val;
...
static inline void xmedia_i2c_cmdreg_set(struct xmedia_i2c_dev *i2c,
 ...
 */
static inline void xmedia_i2c_set_addr(struct xmedia_i2c_dev *i2c)
{
 ...
 */
static inline void xmedia_i2c_start_cmd(struct xmedia_i2c_dev *i2c)
{
	unsigned int val;
...
static int xmedia_i2c_wait_rx_noempty(struct xmedia_i2c_dev *i2c)
{
...
static int xmedia_i2c_wait_tx_nofull(struct xmedia_i2c_dev *i2c)
{
	unsigned int time_cnt = 0;
	unsigned int val;
...
static int xmedia_i2c_wait_idle(struct xmedia_i2c_dev *i2c)
{
	unsigned int time_cnt = 0;
	unsigned int val;
 ...
 */
static inline void xmedia_i2c_set_water(struct xmedia_i2c_dev *i2c)
{
 ...
 */
static void xmedia_i2c_cfg_cmd(struct xmedia_i2c_dev *i2c)
{
	struct i2c_msg *msg = i2c->msg;
	int offset = 0;
			  ...
			  struct i2c_msg *msgs, int num)
{
	...
	/* FIXME: The wait_for_completion_timeout in xmedia_i2c_interrupt_xfer_one_msg
 ...
 */
static int xmedia_i2c_break_polling_xfer(struct i2c_adapter *adap,
					struct i2c_msg *msgs, int num)
{
	struct xmedia_i2c_dev *i2c = i2c_get_adapdata(adap);
	int status = -EINVAL;
...
{
	int status;
	struct xmedia_i2c_dev *i2c = NULL;
...
MODULE_DESCRIPTION("XMEDIA I2C Bus driver");
