...
#define eMMC_ST_ERR_REG_RD_CRC    BIT0
#define eMMC_ST_ERR_REG_WR_CRC    BIT1
#define eMMC_ST_ERR_REG_WR_TOUT   BIT2
#define eMMC_ST_ERR_REG_NO_RSP    BIT3
#define eMMC_ST_ERR_REG_RSP_CRC   BIT4
#define eMMC_ST_ERR_REG_RD_TOUT   BIT5
#define eMMC_ST_ERR_REG_CARD_BUSY BIT6
