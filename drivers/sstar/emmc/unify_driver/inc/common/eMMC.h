...
#define eMMC_IF_DISABLE_LOG() (gu32_eMMCDrvExtFlag & eMMCDRV_EXTFLAG_DISABLE_LOG)
...
typedef eMMC_PACK0 struct _eMMC_FCIE_DDRT_EXT_TABLE
...
typedef eMMC_PACK0 struct _eMMC_FCIE_REG_SET
{                       // total 10 bytes
...
typedef struct _eMMC_DRIVER
{
    ...
    U8  u8_WP_GRP_SIZE, u8_WP_GRP_ENABLE;
    U8  u8_R2W_FACTOR;
...
#define BUS_WIDTH_8 8
    ...
    U8  u8_ECSD160_PartSupField, u8_ECSD224_HCEraseGRPSize, u8_ECSD221_HCWpGRPSize, u8_ECSD175_ERASE_GROUP_DEF;
    U8  u8_ECSD174_BootWPStatus, u8_ECSD173_BootWP, u8_ECSD171_UserWP;
...
extern eMMC_DRIVER g_eMMCDrv[EMMC_NUM_TOTAL];
...
{
    EMMC_EMP  = 0x0000,
    EMMC_ADMA = 0x0020, // Add at FCIE5
    EMMC_DMA  = 0x0080, // Change at FCIE5
    EMMC_CIF  = 0x1000, // Change at FCIE5
...
//===========================================================
extern U32 eMMC_IPVerify_Main(struct device* dev, eMMC_IP_EmType emmc_ip);
extern U32 eMMC_IPVerify_Main_Ex(eMMC_IP_EmType emmc_ip, U32 u32_DataPattern);

extern U32  eMMC_IPVerify_WriteOnly(eMMC_IP_EmType emmc_ip, U16 u16_TestPattern);
extern U32  eMMC_IPVerify_ReadOnly(eMMC_IP_EmType emmc_ip);
extern U32  eMMC_IPVerify_SDRDDR_AllClkTemp(eMMC_IP_EmType emmc_ip);
extern void eMMCTest_DownCount(U32 u32_Sec);
extern U32  eMMC_IPVerify_Performance(eMMC_IP_EmType emmc_ip);

extern U32 eMMCTest_BlkWRC_ProbeTiming(eMMC_IP_EmType emmc_ip, U32 u32_eMMC_Addr);
extern U32 eMMCTest_KeepR_TestDDR(U32 u32_LoopCnt);
extern U32 eMMCTest_Lifetime(eMMC_IP_EmType emmc_ip, U8 u8_TestMode);
