...
// Overall
//=====================================================
#define SDIO_SETTING_ONLY               (0)
#define INIT_PADMUX                     (1)
#define PADMUX_CTRL                     (0)
#define DRIVING_CTRL                    (0)
#define MAX_CLK_CTRL                    (0)
#define SET_BY_DTS                      (0)

extern u32 gRegBankFeie0, gRegBankFeie1, gRegBankFeie2;
extern u32 gRegCkgSd, gBitCkgSdGating, gBitCkgSdInverse, gBitCkgSdMask, gBitCkgSdSrcSel;
extern u32 gBitCkgSdGpCtrl;
extern u32 gBitSdModeMask, gBitSdModeSel;
extern u32 gRegDrivingCfg, gBitDrivingClk, gBitDrivingCmd, gBitDrivingData;
...
#define FCIE0_BASE                      GET_REG_ADDR(RIU_BASE, gRegBankFeie0)
#define FCIE1_BASE                      GET_REG_ADDR(RIU_BASE, gRegBankFeie1)
#define FCIE2_BASE                      GET_REG_ADDR(RIU_BASE, gRegBankFeie2)
...
// Not yet support
#else
#define reg_ckg_fcie_VALUE                  (0x43)
#define BIT_FCIE_CLK_GATING_VALUE           (BIT0)
#define BIT_FCIE_CLK_INVERSE_VALUE          (BIT1)
#define BIT_CLKGEN_FCIE_MASK_VALUE          (BIT4|BIT3|BIT2)
#define BIT_FCIE_CLK_SRC_SEL_VALUE          (BIT5) // 0: clk_xtal 12M, 1: clk_nfie_p1
#endif

#define reg_ckg_fcie                    GET_REG_ADDR(CLKGEN0_BASE, gRegCkgSd)
#define BIT_FCIE_CLK_GATING             (gBitCkgSdGating)
#define BIT_FCIE_CLK_INVERSE            (gBitCkgSdInverse)
#define BIT_CLKGEN_FCIE_MASK            (gBitCkgSdMask)
#define BIT_FCIE_CLK_SRC_SEL            (gBitCkgSdSrcSel) // 0: clk_xtal 12M, 1: clk_nfie_p1
...
// Not yet support
#else
#define BIT_CKG_SD_VALUE            (BIT7)
#endif
#define BIT_CKG_SD                  (gBitCkgSdGpCtrl)
...
// Not yet support
#else
#define BIT_SD_MODE_MASK_VALUE          (BIT8|BIT9)
#define BIT_SD_MODE_SEL_VALUE           (BIT8)
#endif
#define BIT_SD_MODE_MASK                (gBitSdModeMask)
#define BIT_SD_MODE_SEL                 (gBitSdModeSel)
...
#define BIT_SDIO_MODE_MASK              0 //(BIT8|BIT9) //[B9:B8]reg_sd1_cdz_mode
