...
{
    int         num_parents;
    struct clk *clk_fcie[EMMC_NUM_TOTAL];
    struct clk *clk_syn[EMMC_NUM_TOTAL];
};
...
struct mstar_mci_driver
{
    struct platform_device *pdev;
    struct mstar_mci_host * emmc_host[EMMC_NUM_TOTAL];
};
