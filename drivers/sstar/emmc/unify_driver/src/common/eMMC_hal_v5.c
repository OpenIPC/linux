...
U32 eMMC_FCIE_Reset(void)
{
    ...
    REG_FCIE_SETBIT(FCIE_MIE_FUNC_CTL, BIT_MIE_FUNC_ENABLE);
...
U32 eMMC_CMD1(void)
{
    ...
    u32_arg = BIT30 | (BIT23|BIT22|BIT21|BIT20|BIT19|BIT18|BIT17|BIT16|BIT15|BIT7); //ARG[<=2G : >2G]/[x00_FF_80_00 : x40_FF_80_00]
...
U32 eMMC_CMD8_MIU(U8 *pu8_DataBuf)
{
    ...
    u32_DataDMAAddr = eMMC_translate_DMA_address_Ex(dma_DataMapAddr, eMMC_SECTOR_512BYTE);
...
U32 eMMC_CMD18_MIU(U32 u32_eMMCBlkAddr, U8 *pu8_DataBuf, U16 u16_BlkCnt)
{
    ...
    u32_DataDMAAddr = eMMC_translate_DMA_address_Ex(dma_DataMapAddr, eMMC_SECTOR_512BYTE*u16_BlkCnt);
