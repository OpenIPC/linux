...
int aead_encrypt(struct cryptodev_ctx* ctx, const void* iv, const void* plaintext, void* ciphertext, size_t size,
                 void* digest)
{
...
int aead_test(int cipher, int mac, void* ukey, int ukey_size, void* user_ctx,
              void (*user_combo)(void* user_ctx, void* plaintext, void* ciphertext, int size, void* res))
{
    int                  cfd = -1, i, ret;
