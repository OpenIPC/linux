...
extern int    hal_rtc_read_time(struct hal_rtcpwc_t *hal, unsigned long *second);
extern int    hal_rtc_set_time(struct hal_rtcpwc_t *hal, u32 seconds);
extern void   hal_rtc_set_alarm(struct hal_rtcpwc_t *hal, unsigned long seconds);
...
extern void   hal_rtc_get_alarm(struct hal_rtcpwc_t *hal, unsigned long *seconds);
