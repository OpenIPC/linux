...
#ifndef _DWMAC4_SSTAR_DMA_H_
#define _DWMAC4_SSTAR_DMA_H_
...
#define DMA_CHAN_INTR_NORMAL (DMA_CHAN_INTR_ENA_NIE | DMA_CHAN_INTR_ENA_RIE | DMA_CHAN_INTR_ENA_TIE)

#if defined(CONFIG_ARCH_SSTAR) && defined(CONFIG_SSTAR_SNPS_GMAC_RXIC)
#define DMA_CHAN_INTR_ABNORMAL (DMA_CHAN_INTR_ENA_AIE | DMA_CHAN_INTR_ENA_FBE | DMA_CHAN_INTR_ENA_RBUE)
#else
#define DMA_CHAN_INTR_ABNORMAL (DMA_CHAN_INTR_ENA_AIE | DMA_CHAN_INTR_ENA_FBE)
#endif

/* DMA default interrupt mask for 4.00 */
#define DMA_CHAN_INTR_DEFAULT_MASK (DMA_CHAN_INTR_NORMAL | DMA_CHAN_INTR_ABNORMAL)
#define DMA_CHAN_INTR_DEFAULT_RX   (DMA_CHAN_INTR_ENA_RIE)
#define DMA_CHAN_INTR_DEFAULT_TX   (DMA_CHAN_INTR_ENA_TIE)

#define DMA_CHAN_INTR_NORMAL_4_10 (DMA_CHAN_INTR_ENA_NIE_4_10 | DMA_CHAN_INTR_ENA_RIE | DMA_CHAN_INTR_ENA_TIE)

#if defined(CONFIG_ARCH_SSTAR) && defined(CONFIG_SSTAR_SNPS_GMAC_RXIC)
#define DMA_CHAN_INTR_ABNORMAL_4_10 (DMA_CHAN_INTR_ENA_AIE_4_10 | DMA_CHAN_INTR_ENA_FBE | DMA_CHAN_INTR_ENA_RBUE)
#else
#define DMA_CHAN_INTR_ABNORMAL_4_10 (DMA_CHAN_INTR_ENA_AIE_4_10 | DMA_CHAN_INTR_ENA_FBE)
#endif

/* DMA default interrupt mask for 4.10a */
#define DMA_CHAN_INTR_DEFAULT_MASK_4_10 (DMA_CHAN_INTR_NORMAL_4_10 | DMA_CHAN_INTR_ABNORMAL_4_10)
