/*
* infinity2m-cpufreq.c- Sigmastar
*
...
extern void set_core_voltage(VOLTAGE_DEMANDER_E demander, int mV)
;
...
static int ms_cpufreq_init(struct cpufreq_policy *policy)
{
    ...
    // TODO: use operating-points in DTS to control policy max/min range
    //policy->min = 1000000;
    //policy->max = 1000000;
