...
void MHal_EMAC_Set_Tx_Wrong_Packet_Fix(void* hal, u32 xval)
{
    u32 value;
    value = MHal_EMAC_ReadReg32(hal, REG_EMAC_JULIAN_0138);
    value &= 0xfffffffD;
    value |= xval << 1;
    MHal_EMAC_WritReg32(hal, REG_EMAC_JULIAN_0138, value);

    value = MHal_EMAC_ReadReg32(hal, REG_EMAC_JULIAN_01D2);
    value &= 0xfffffffE;
    value |= xval << 0;
    MHal_EMAC_WritReg32(hal, REG_EMAC_JULIAN_01D2, value);
}
...
void MHal_EMAC_HW_init(void* hal)
{
    ...
    MHal_EMAC_Set_Tx_Wrong_Packet_Fix(hal, 1);
...
#ifndef CONFIG_CAM_CLK
#if CONFIG_OF
    num_parents = (dev) ? of_clk_get_parent_count(dev->of_node) : 0;
    if (num_parents > 0)
    {
