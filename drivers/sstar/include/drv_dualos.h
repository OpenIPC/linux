...
#define RTKINFO_TTFF_ISP() \
    if (!_rtk->ttff_isp)   \
        _rtk->ttff_isp = (unsigned int)(_getsysts() - epiod);
#define RTKINFO_TTFF_SCL() \
    if (!_rtk->ttff_scl)   \
        _rtk->ttff_scl = (unsigned int)(_getsysts() - epiod);
#define RTKINFO_TTFF_MFE() \
    if (!_rtk->ttff_mfe)   \
        _rtk->ttff_mfe = (unsigned int)(_getsysts() - epiod);
