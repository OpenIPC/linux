...
typedef struct
{
    ...
    unsigned long
        u32CropXstart; ///< the start x coordinate for Scaler crop to calculate the crop width, available for bCropEn=1
    unsigned long
        u32CropXend; ///< the end x coordinate for Scaler crop to calculate the crop width, available for bCropEn=1
    unsigned long
        u32CropYstart; ///< the start y coordinate for Scaler crop to calculate the crop height, available for bCropEn=1
    unsigned long
        u32CropYend; ///< the end y coordinate for Scaler crop to calculate the crop height, available for bCropEn=1
