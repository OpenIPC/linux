...
typedef enum
{
    ...
    SCA_MODE_MONITOR_STABLE_UN_SUPPORT_MODE, ///< Input timing stable, has stable input sync but this timing is not
                                             ///< supported
...
typedef struct
{
    ...
    // 0x10
    MS_U8 INT_F2_IPHCS1_DET : 1; ///< pwm rising edge of left frame, please use MDrv_XC_InterruptAvaliable() to check if
                                 ///< avalible or not
    MS_U8 INT_F1_IPHCS1_DET : 1; ///< pwm falling edge of left frame, please use MDrv_XC_InterruptAvaliable() to check
                                 ///< if avalible or not
    ...
    MS_U8 INT_DVI_CK_LOSE_F2 : 1; ///< pwm rising edge of right frame, please use MDrv_XC_InterruptAvaliable() to check
                                  ///< if avalible or not
    MS_U8 INT_DVI_CK_LOSE_F1 : 1; ///< pwm falling edge of right frame, please use MDrv_XC_InterruptAvaliable() to check
                                  ///< if avalible or not
    MS_U8 INT_F2_CSOG : 1; ///< composite sync or SoG input signal type changed (for example, SoG signal from none ->
                           ///< valid, valid -> none)
    MS_U8 INT_F1_CSOG : 1;
