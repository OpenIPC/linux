...
#define BASE_REG_LPLL_PA        GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x103300)
...
#define BASE_REG_SSUSB_PHYA0_PA GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x152400)
#define BASE_REG_SSUSB_PHYA1_PA GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x152500)
