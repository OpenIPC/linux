...
/**
 * Used to get alpha blending conditon including disable or constant_alpha or pixel_alpha, return type is
 * FB_GOP_ALPHA_CONFIG.
 */
#define IOCTL_FB_GETALPHA _IO(G3D_IOC_MAGIC_INFINITY, 28)

/**
 * Used to set alpha blending conditon including disable or constant_alpha or pixel_alpha, using type is
 * FB_GOP_ALPHA_CONFIG.
 */
...
/**
 * Used to trigger driver to update AE information from ISP driver and return value to user, using type is
