 ...
 * sysfs R/W mode: R/W
 *
 * sysfs Usage & Description: R:print vsync count,err times W: if 0 close ptgen ,if echo 1 open check crop ,echo 2 open
 * check hvsp and dma count
 *
 * sysfs Node: /sys/devices/platform/mhvsp1.0/ptgen
 *
 * sysfs R/W mode: R/W
 *
 * sysfs Usage & Description: R:print explain W: if 0 close ptgen ,if echo 1 open static ptgen ,echo 2 open dynamic
 * ptgen,echo 3 open scl time gen
 *
 * @{
 */
