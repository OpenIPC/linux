...
/* CLK FILENAME: M6\Mercury6_Clock_Table_SW_0707.xls */
/* REG FILENAME: M6\Mercury6_reg_CLKGEN.xls, M6\Mercury6_reg_pm_sleep.xls, M6\Mercury6_reg_block.xls,
 * M6\Mercury6_reg_chiptop.xls */
...
#define REG_CKG_BT656_0_BASE   (REG_SC_GP_CTRL_BASE + 0x27 * 4)
#define REG_CKG_BT656_0_OFFSET (0)

#define REG_CKG_BT656_1_BASE   (REG_SC_GP_CTRL_BASE + 0x27 * 4)
#define REG_CKG_BT656_1_OFFSET (8)

#define REG_CKG_EMAC1_RX_BASE   (REG_SC_GP_CTRL_BASE + 0x2A * 4)
#define REG_CKG_EMAC1_RX_OFFSET (0)

#define REG_CKG_EMAC1_RX_REF_BASE   (REG_SC_GP_CTRL_BASE + 0x2A * 4)
#define REG_CKG_EMAC1_RX_REF_OFFSET (8)

#define REG_CKG_EMAC1_TX_BASE   (REG_SC_GP_CTRL_BASE + 0x2B * 4)
#define REG_CKG_EMAC1_TX_OFFSET (0)

#define REG_CKG_EMAC1_TX_REF_BASE   (REG_SC_GP_CTRL_BASE + 0x2B * 4)
...
#define REG_CKG_GOP3_PSRAM_BASE   (REG_SC_GP_CTRL_BASE + 0x2C * 4)
#define REG_CKG_GOP3_PSRAM_OFFSET (0)

#define REG_CKG_GOP4_PSRAM_BASE   (REG_SC_GP_CTRL_BASE + 0x2C * 4)
#define REG_CKG_GOP4_PSRAM_OFFSET (4)

#define REG_CKG_GOP5_PSRAM_BASE   (REG_SC_GP_CTRL_BASE + 0x2C * 4)
#define REG_CKG_GOP5_PSRAM_OFFSET (8)
...
#define REG_CKG_SNR2_BASE   (REG_SC_GP_CTRL_BASE + 0x29 * 4)
#define REG_CKG_SNR2_OFFSET (0)

#define REG_CKG_SNR3_BASE   (REG_SC_GP_CTRL_BASE + 0x29 * 4)
#define REG_CKG_SNR3_OFFSET (8)

#define REG_CLK_MCU_BRG_FREE_RUN_BASE   (REG_SC_GP_CTRL_BASE + 0x20 * 4)
#define REG_CLK_MCU_BRG_FREE_RUN_OFFSET (8)

#define REG_CLK_SC_SRC0_DFS_CFG_BASE   (REG_SC_GP_CTRL_BASE + 0x2D * 4)
#define REG_CLK_SC_SRC0_DFS_CFG_OFFSET (0)

#define REG_CLK_SC_SRC0_DFS_EN_BASE   (REG_SC_GP_CTRL_BASE + 0x2D * 4)
#define REG_CLK_SC_SRC0_DFS_EN_OFFSET (7)

#define REG_CLK_SC_SRC1_DFS_CFG_BASE   (REG_SC_GP_CTRL_BASE + 0x2D * 4)
#define REG_CLK_SC_SRC1_DFS_CFG_OFFSET (8)

#define REG_CLK_SC_SRC1_DFS_EN_BASE   (REG_SC_GP_CTRL_BASE + 0x2D * 4)
#define REG_CLK_SC_SRC1_DFS_EN_OFFSET (15)

#define REG_CLK_SC_SRC2_DFS_CFG_BASE   (REG_SC_GP_CTRL_BASE + 0x2E * 4)
#define REG_CLK_SC_SRC2_DFS_CFG_OFFSET (0)

#define REG_CLK_SC_SRC2_DFS_EN_BASE   (REG_SC_GP_CTRL_BASE + 0x2E * 4)
#define REG_CLK_SC_SRC2_DFS_EN_OFFSET (7)

#define REG_CLK_SC_SRC3_DFS_CFG_BASE   (REG_SC_GP_CTRL_BASE + 0x2E * 4)
#define REG_CLK_SC_SRC3_DFS_CFG_OFFSET (8)

#define REG_CLK_SC_SRC3_DFS_EN_BASE   (REG_SC_GP_CTRL_BASE + 0x2E * 4)
...
#define REG_CKG_LIVE_PM_BASE   (REG_PM_SLEEP_CKG_BASE + 0x34 * 4)
#define REG_CKG_LIVE_PM_OFFSET (0)

#define REG_CKG_MCU_PM_BASE   (REG_PM_SLEEP_CKG_BASE + 0x20 * 4)
#define REG_CKG_MCU_PM_OFFSET (7)

#define REG_CKG_MCU_PM_P1_BASE   (REG_PM_SLEEP_CKG_BASE + 0x20 * 4)
#define REG_CKG_MCU_PM_P1_OFFSET (0)
...
#define REG_CKG_BIST_USB30_GP_BASE   (REG_CKG_BASE + 0x05 * 4)
#define REG_CKG_BIST_USB30_GP_OFFSET (8)
...
#define REG_CKG_CSI_MAC_LPTX_TOP_I_M00_BASE   (REG_CKG_BASE + 0x58 * 4)
#define REG_CKG_CSI_MAC_LPTX_TOP_I_M00_OFFSET (0)

#define REG_CKG_CSI_MAC_LPTX_TOP_I_M01_BASE   (REG_CKG_BASE + 0x59 * 4)
#define REG_CKG_CSI_MAC_LPTX_TOP_I_M01_OFFSET (8)

#define REG_CKG_CSI_MAC_LPTX_TOP_I_M10_BASE   (REG_CKG_BASE + 0x5B * 4)
#define REG_CKG_CSI_MAC_LPTX_TOP_I_M10_OFFSET (0)

#define REG_CKG_CSI_MAC_LPTX_TOP_I_M11_BASE   (REG_CKG_BASE + 0x5D * 4)
#define REG_CKG_CSI_MAC_LPTX_TOP_I_M11_OFFSET (0)

#define REG_CKG_CSI_MAC_TOP_I_M00_BASE   (REG_CKG_BASE + 0x58 * 4)
#define REG_CKG_CSI_MAC_TOP_I_M00_OFFSET (8)

#define REG_CKG_CSI_MAC_TOP_I_M01_BASE   (REG_CKG_BASE + 0x5A * 4)
#define REG_CKG_CSI_MAC_TOP_I_M01_OFFSET (0)

#define REG_CKG_CSI_MAC_TOP_I_M10_BASE   (REG_CKG_BASE + 0x5B * 4)
#define REG_CKG_CSI_MAC_TOP_I_M10_OFFSET (8)

#define REG_CKG_CSI_MAC_TOP_I_M11_BASE   (REG_CKG_BASE + 0x5D * 4)
#define REG_CKG_CSI_MAC_TOP_I_M11_OFFSET (8)
...
#define REG_CKG_FCLK2_BASE   (REG_CKG_BASE + 0x64 * 4)
#define REG_CKG_FCLK2_OFFSET (8)
...
#define REG_CKG_NJPD_BASE   (REG_CKG_BASE + 0x4A * 4)
#define REG_CKG_NJPD_OFFSET (0)

#define REG_CKG_NS_BASE   (REG_CKG_BASE + 0x6B * 4)
#define REG_CKG_NS_OFFSET (0)

#define REG_CKG_NS_TOP_I_M00_BASE   (REG_CKG_BASE + 0x59 * 4)
#define REG_CKG_NS_TOP_I_M00_OFFSET (0)

#define REG_CKG_NS_TOP_I_M01_BASE   (REG_CKG_BASE + 0x5A * 4)
#define REG_CKG_NS_TOP_I_M01_OFFSET (8)

#define REG_CKG_NS_TOP_I_M10_BASE   (REG_CKG_BASE + 0x5C * 4)
#define REG_CKG_NS_TOP_I_M10_OFFSET (0)

#define REG_CKG_NS_TOP_I_M11_BASE   (REG_CKG_BASE + 0x5E * 4)
#define REG_CKG_NS_TOP_I_M11_OFFSET (0)
...
#define REG_CKG_SATA_AXI_OFFSET (12)
...
#define REG_CKG_SD_SYN_OFFSET (12)
...
#define REG_CKG_SR1_MCLK_BASE   (REG_CKG_BASE + 0x65 * 4)
#define REG_CKG_SR1_MCLK_OFFSET (8)

#define REG_CKG_SR2_MCLK_BASE   (REG_CKG_BASE + 0x66 * 4)
#define REG_CKG_SR2_MCLK_OFFSET (8)
