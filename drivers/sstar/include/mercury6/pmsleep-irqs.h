...
#define INT_PMSLEEP_GPIO0     (PMSLEEP_FIQ_START + 0)
#define INT_PMSLEEP_GPIO1     (PMSLEEP_FIQ_START + 1)
#define INT_PMSLEEP_GPIO2     (PMSLEEP_FIQ_START + 2)
#define INT_PMSLEEP_GPIO3     (PMSLEEP_FIQ_START + 3)
#define INT_PMSLEEP_GPIO4     (PMSLEEP_FIQ_START + 4)
#define INT_PMSLEEP_GPIO5     (PMSLEEP_FIQ_START + 5)
#define INT_PMSLEEP_GPIO6     (PMSLEEP_FIQ_START + 6)
#define INT_PMSLEEP_GPIO7     (PMSLEEP_FIQ_START + 7)
...
#define INT_PMSLEEP_I2CM_SCL  (PMSLEEP_FIQ_START + 11)
#define INT_PMSLEEP_I2CM_SDA  (PMSLEEP_FIQ_START + 12)
#define INT_PMSLEEP_SPI_CZ    (PMSLEEP_FIQ_START + 13)
#define INT_PMSLEEP_SPI_CK    (PMSLEEP_FIQ_START + 14)
#define INT_PMSLEEP_SPI_DI    (PMSLEEP_FIQ_START + 15)
#define INT_PMSLEEP_SPI_DO    (PMSLEEP_FIQ_START + 16)
#define INT_PMSLEEP_SPI_WPZ   (PMSLEEP_FIQ_START + 17)
#define INT_PMSLEEP_SPI_HLD   (PMSLEEP_FIQ_START + 18)
#define INT_PMSLEEP_UART_RX1  (PMSLEEP_FIQ_START + 19)
#define INT_PMSLEEP_UART_TX1  (PMSLEEP_FIQ_START + 20)
#define INT_PMSLEEP_UART_RX   (PMSLEEP_FIQ_START + 21)
#define INT_PMSLEEP_UART_TX   (PMSLEEP_FIQ_START + 22)
...
#define INT_PMSLEEP_SAR_GPIO4 (PMSLEEP_FIQ_START + 27)
#define INT_PMSLEEP_SAR_GPIO5 (PMSLEEP_FIQ_START + 28)
