...
/* CLK FILENAME: I7\Infinity7_Clock_Table_0927(1).xls */
/* REG FILENAME: I7\Infinity7_reg_CLKGEN.xls, I7\infinity7_reg_CLKGEN2.xls, I7\infinity7_reg_pm_sleep.xls,
 * I7\Infinity7_reg_block.xls, I7\Infinity7_reg_chiptop.xls */
...
#define REG_CKG_BIST_DSP_GP_BASE   (REG_CKG2_BASE + 0x21 * 4)
#define REG_CKG_BIST_DSP_GP_OFFSET (0)

#define REG_CKG_BIST_IPU_GP_BASE   (REG_CKG_BASE + 0x05 * 4)
#define REG_CKG_BIST_IPU_GP_OFFSET (0)

#define REG_CKG_BIST_ISP1_GP_BASE   (REG_CKG2_BASE + 0x08 * 4)
#define REG_CKG_BIST_ISP1_GP_OFFSET (0)
...
#define REG_CKG_BIST_MIU1_BASE   (REG_CKG2_BASE + 0x0C * 4)
#define REG_CKG_BIST_MIU1_OFFSET (0)

#define REG_CKG_BIST_NET_GP_BASE   (REG_CKG2_BASE + 0x34 * 4)
#define REG_CKG_BIST_NET_GP_OFFSET (0)

#define REG_CKG_BIST_PCIE0_GP_BASE   (REG_CKG2_BASE + 0x40 * 4)
#define REG_CKG_BIST_PCIE0_GP_OFFSET (0)

#define REG_CKG_BIST_PCIE1_GP_BASE   (REG_CKG2_BASE + 0x46 * 4)
#define REG_CKG_BIST_PCIE1_GP_OFFSET (0)
...
#define REG_CKG_CSI_MAC_LPTX_TOP_I_B0_BASE   (REG_CKG2_BASE + 0x58 * 4)
#define REG_CKG_CSI_MAC_LPTX_TOP_I_B0_OFFSET (0)

#define REG_CKG_CSI_MAC_LPTX_TOP_I_B1_BASE   (REG_CKG2_BASE + 0x59 * 4)
#define REG_CKG_CSI_MAC_LPTX_TOP_I_B1_OFFSET (8)

#define REG_CKG_CSI_MAC_LPTX_TOP_I_B2_BASE   (REG_CKG2_BASE + 0x5B * 4)
#define REG_CKG_CSI_MAC_LPTX_TOP_I_B2_OFFSET (0)

#define REG_CKG_CSI_MAC_LPTX_TOP_I_B3_BASE   (REG_CKG2_BASE + 0x5D * 4)
#define REG_CKG_CSI_MAC_LPTX_TOP_I_B3_OFFSET (0)
...
#define REG_CKG_CSI_MAC_TOP_I_B0_BASE   (REG_CKG2_BASE + 0x58 * 4)
#define REG_CKG_CSI_MAC_TOP_I_B0_OFFSET (8)

#define REG_CKG_CSI_MAC_TOP_I_B1_BASE   (REG_CKG2_BASE + 0x5A * 4)
#define REG_CKG_CSI_MAC_TOP_I_B1_OFFSET (0)

#define REG_CKG_CSI_MAC_TOP_I_B2_BASE   (REG_CKG2_BASE + 0x5B * 4)
#define REG_CKG_CSI_MAC_TOP_I_B2_OFFSET (8)

#define REG_CKG_CSI_MAC_TOP_I_B3_BASE   (REG_CKG2_BASE + 0x5D * 4)
#define REG_CKG_CSI_MAC_TOP_I_B3_OFFSET (8)
...
#define REG_CKG_DISP_PIXEL_2_BASE   (REG_CKG2_BASE + 0x29 * 4)
#define REG_CKG_DISP_PIXEL_2_OFFSET (0)

#define REG_CKG_DISP_PIXEL_BT1120_BASE   (REG_CKG2_BASE + 0x1B * 4)
#define REG_CKG_DISP_PIXEL_BT1120_OFFSET (0)

#define REG_CKG_DSP_BASE   (REG_CKG2_BASE + 0x22 * 4)
#define REG_CKG_DSP_OFFSET (0)
...
#define REG_CKG_GE2_BASE   (REG_CKG2_BASE + 0x2A * 4)
#define REG_CKG_GE2_OFFSET (0)
...
#define REG_CKG_ISP1_BASE   (REG_CKG2_BASE + 0x09 * 4)
#define REG_CKG_ISP1_OFFSET (0)
...
#define REG_CKG_JPD2_BASE   (REG_CKG2_BASE + 0x32 * 4)
#define REG_CKG_JPD2_OFFSET (0)

#define REG_CKG_JPD3_BASE   (REG_CKG2_BASE + 0x33 * 4)
#define REG_CKG_JPD3_OFFSET (0)
...
#define REG_CKG_LDCFEYE2_BASE   (REG_CKG2_BASE + 0x2B * 4)
#define REG_CKG_LDCFEYE2_OFFSET (0)

#define REG_CKG_LIVE_BASE   (REG_CKG_BASE + 0x00 * 4)
#define REG_CKG_LIVE_OFFSET (8)

#define REG_CKG_LVDS_FUNC_A0_BASE   (REG_CKG2_BASE + 0x60 * 4)
#define REG_CKG_LVDS_FUNC_A0_OFFSET (0)

#define REG_CKG_LVDS_FUNC_A1_BASE   (REG_CKG2_BASE + 0x61 * 4)
#define REG_CKG_LVDS_FUNC_A1_OFFSET (0)

#define REG_CKG_LVDS_FUNC_A2_BASE   (REG_CKG2_BASE + 0x62 * 4)
#define REG_CKG_LVDS_FUNC_A2_OFFSET (0)

#define REG_CKG_LVDS_FUNC_A3_BASE   (REG_CKG2_BASE + 0x63 * 4)
#define REG_CKG_LVDS_FUNC_A3_OFFSET (0)

#define REG_CKG_LVDS_FUNC_A4_BASE   (REG_CKG2_BASE + 0x64 * 4)
#define REG_CKG_LVDS_FUNC_A4_OFFSET (0)

#define REG_CKG_LVDS_FUNC_A5_BASE   (REG_CKG2_BASE + 0x65 * 4)
#define REG_CKG_LVDS_FUNC_A5_OFFSET (0)

#define REG_CKG_LVDS_FUNC_A6_BASE   (REG_CKG2_BASE + 0x66 * 4)
#define REG_CKG_LVDS_FUNC_A6_OFFSET (0)

#define REG_CKG_LVDS_FUNC_A7_BASE   (REG_CKG2_BASE + 0x67 * 4)
#define REG_CKG_LVDS_FUNC_A7_OFFSET (0)
...
#define REG_CKG_MIIC10_BASE   (REG_CKG2_BASE + 0x07 * 4)
#define REG_CKG_MIIC10_OFFSET (0)
...
#define REG_CKG_MIIC6_BASE   (REG_CKG2_BASE + 0x03 * 4)
#define REG_CKG_MIIC6_OFFSET (0)

#define REG_CKG_MIIC7_BASE   (REG_CKG2_BASE + 0x04 * 4)
#define REG_CKG_MIIC7_OFFSET (0)

#define REG_CKG_MIIC8_BASE   (REG_CKG2_BASE + 0x05 * 4)
#define REG_CKG_MIIC8_OFFSET (0)

#define REG_CKG_MIIC9_BASE   (REG_CKG2_BASE + 0x06 * 4)
#define REG_CKG_MIIC9_OFFSET (0)
...
#define REG_CKG_MOP2_BASE   (REG_CKG2_BASE + 0x26 * 4)
#define REG_CKG_MOP2_OFFSET (0)
...
#define REG_CKG_MSPI3_BASE   (REG_CKG_BASE + 0x32 * 4)
#define REG_CKG_MSPI3_OFFSET (12)
...
#define REG_CKG_NS_TOP_I_B0_BASE   (REG_CKG2_BASE + 0x59 * 4)
#define REG_CKG_NS_TOP_I_B0_OFFSET (0)

#define REG_CKG_NS_TOP_I_B1_BASE   (REG_CKG2_BASE + 0x5A * 4)
#define REG_CKG_NS_TOP_I_B1_OFFSET (8)

#define REG_CKG_NS_TOP_I_B2_BASE   (REG_CKG2_BASE + 0x5C * 4)
#define REG_CKG_NS_TOP_I_B2_OFFSET (0)

#define REG_CKG_NS_TOP_I_B3_BASE   (REG_CKG2_BASE + 0x5E * 4)
#define REG_CKG_NS_TOP_I_B3_OFFSET (0)

#define REG_CKG_PAD_TEST_BASE   (REG_CKG2_BASE + 0x0F * 4)
#define REG_CKG_PAD_TEST_OFFSET (0)

#define REG_CKG_PCIE0_BASE   (REG_CKG2_BASE + 0x45 * 4)
#define REG_CKG_PCIE0_OFFSET (0)

#define REG_CKG_PCIE0_BS_BASE   (REG_CKG2_BASE + 0x44 * 4)
#define REG_CKG_PCIE0_BS_OFFSET (0)

#define REG_CKG_PCIE0_JTG_BASE   (REG_CKG2_BASE + 0x43 * 4)
#define REG_CKG_PCIE0_JTG_OFFSET (0)

#define REG_CKG_PCIE0_REF_ALT_BASE   (REG_CKG2_BASE + 0x42 * 4)
#define REG_CKG_PCIE0_REF_ALT_OFFSET (0)

#define REG_CKG_PCIE0_SLV_ACLK_BASE   (REG_CKG2_BASE + 0x41 * 4)
#define REG_CKG_PCIE0_SLV_ACLK_OFFSET (0)

#define REG_CKG_PCIE1_BASE   (REG_CKG2_BASE + 0x4B * 4)
#define REG_CKG_PCIE1_OFFSET (0)

#define REG_CKG_PCIE1_BS_BASE   (REG_CKG2_BASE + 0x4A * 4)
#define REG_CKG_PCIE1_BS_OFFSET (0)

#define REG_CKG_PCIE1_JTG_BASE   (REG_CKG2_BASE + 0x49 * 4)
#define REG_CKG_PCIE1_JTG_OFFSET (0)

#define REG_CKG_PCIE1_REF_ALT_BASE   (REG_CKG2_BASE + 0x48 * 4)
#define REG_CKG_PCIE1_REF_ALT_OFFSET (0)

#define REG_CKG_PCIE1_SLV_ACLK_BASE   (REG_CKG2_BASE + 0x47 * 4)
#define REG_CKG_PCIE1_SLV_ACLK_OFFSET (0)
...
#define REG_CKG_SDIO2_BASE   (REG_CKG2_BASE + 0x24 * 4)
#define REG_CKG_SDIO2_OFFSET (0)

#define REG_CKG_SDIO2_PHASE_BASE   (REG_CKG2_BASE + 0x24 * 4)
#define REG_CKG_SDIO2_PHASE_OFFSET (8)

#define REG_CKG_SDIO3_BASE   (REG_CKG2_BASE + 0x25 * 4)
#define REG_CKG_SDIO3_OFFSET (0)

#define REG_CKG_SDIO3_PHASE_BASE   (REG_CKG2_BASE + 0x25 * 4)
#define REG_CKG_SDIO3_PHASE_OFFSET (8)
...
#define REG_CKG_SPI_FLASH_BASE   (REG_CKG_BASE + 0x38 * 4)
#define REG_CKG_SPI_FLASH_OFFSET (0)
...
#define REG_CKG_UART1_OFFSET (4)

#define REG_CKG_UART2_BASE   (REG_CKG_BASE + 0x31 * 4)
#define REG_CKG_UART2_OFFSET (8)

#define REG_CKG_UART3_BASE   (REG_CKG_BASE + 0x31 * 4)
#define REG_CKG_UART3_OFFSET (12)

#define REG_CKG_UART4_BASE   (REG_CKG2_BASE + 0x01 * 4)
#define REG_CKG_UART4_OFFSET (0)

#define REG_CKG_UART5_BASE   (REG_CKG2_BASE + 0x02 * 4)
#define REG_CKG_UART5_OFFSET (0)
...
#define REG_CLK_DISP_PIXEL2_DFS_CFG_BASE   (REG_CKG2_BASE + 0x6B * 4)
#define REG_CLK_DISP_PIXEL2_DFS_CFG_OFFSET (1)

#define REG_CLK_DISP_PIXEL2_DFS_EN_BASE   (REG_CKG2_BASE + 0x6B * 4)
#define REG_CLK_DISP_PIXEL2_DFS_EN_OFFSET (0)

#define REG_CLK_GE2_DFS_CFG_BASE   (REG_CKG2_BASE + 0x6C * 4)
#define REG_CLK_GE2_DFS_CFG_OFFSET (1)

#define REG_CLK_GE2_DFS_EN_BASE   (REG_CKG2_BASE + 0x6C * 4)
#define REG_CLK_GE2_DFS_EN_OFFSET (0)
...
#define REG_CLK_ISP1_DFS_CFG_BASE   (REG_CKG2_BASE + 0x6A * 4)
#define REG_CLK_ISP1_DFS_CFG_OFFSET (1)

#define REG_CLK_ISP1_DFS_EN_BASE   (REG_CKG2_BASE + 0x6A * 4)
#define REG_CLK_ISP1_DFS_EN_OFFSET (0)
...
#define REG_CLK_JPD2_DFS_CFG_BASE   (REG_CKG2_BASE + 0x6E * 4)
#define REG_CLK_JPD2_DFS_CFG_OFFSET (9)

#define REG_CLK_JPD2_DFS_EN_BASE   (REG_CKG2_BASE + 0x6E * 4)
#define REG_CLK_JPD2_DFS_EN_OFFSET (8)

#define REG_CLK_JPD3_DFS_CFG_BASE   (REG_CKG2_BASE + 0x6F * 4)
#define REG_CLK_JPD3_DFS_CFG_OFFSET (1)

#define REG_CLK_JPD3_DFS_EN_BASE   (REG_CKG2_BASE + 0x6F * 4)
#define REG_CLK_JPD3_DFS_EN_OFFSET (0)
...
#define REG_CLK_LDCFEYE2_DFS_CFG_BASE   (REG_CKG2_BASE + 0x30 * 4)
#define REG_CLK_LDCFEYE2_DFS_CFG_OFFSET (1)

#define REG_CLK_LDCFEYE2_DFS_EN_BASE   (REG_CKG2_BASE + 0x30 * 4)
#define REG_CLK_LDCFEYE2_DFS_EN_OFFSET (0)
...
#define REG_CLK_MOP2_DFS_CFG_BASE   (REG_CKG2_BASE + 0x70 * 4)
#define REG_CLK_MOP2_DFS_CFG_OFFSET (1)

#define REG_CLK_MOP2_DFS_EN_BASE   (REG_CKG2_BASE + 0x70 * 4)
#define REG_CLK_MOP2_DFS_EN_OFFSET (0)
...
#define REG_GMACPLL_125_FORCE_OFF_BASE   (REG_CKG_BASE + 0x76 * 4)
#define REG_GMACPLL_125_FORCE_OFF_OFFSET (10)

#define REG_GMACPLL_125_FORCE_ON_BASE   (REG_CKG_BASE + 0x74 * 4)
#define REG_GMACPLL_125_FORCE_ON_OFFSET (14)
