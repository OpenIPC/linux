...
static BOOL_T   gb_ReverseCDZ[3]          = {FALSE, FALSE, FALSE};
...
U32_T gu32_EnEightPhase[3] = {0};
U32_T gu32_TXEightPhase[3] = {0};
U32_T gu32_RXEightPhase[3] = {0};
#endif
U32_T gu32_SlotEnPwrHighValid[3] = {0};
...
static int ms_sdmmc_dts_init(struct platform_device *p_dev)
{
    ...
    U32_T u32_EnEightPhase[3];
    U32_T u32_TXEightPhase[3];
    U32_T u32_RXEightPhase[3];
#endif
    ...
    if (of_property_read_u32_array(p_dev->dev.of_node, "slot-revcdz", (U32_T *)u32_ReverseCDZ, u32_SlotNums))
    {
        pr_err(">> [sdmmc] Err: Could not get dts [slot-revcdz] option!\n");
        return 1;
    }
    ...
    if (of_property_read_u32_array(p_dev->dev.of_node, "slot-en-pwr-high-valid", (U32_T *)gu32_SlotEnPwrHighValid,
                                   u32_SlotNums))
    {
    ...
    if (of_property_read_u32_array(p_dev->dev.of_node, "slot-en-eight-phase", (U32_T *)u32_EnEightPhase, u32_SlotNums))
    {
        pr_err(">> [sdmmc] Warn: Could not get dts [slot-en-eight-phase] option!\n");
    }

    if (of_property_read_u32_array(p_dev->dev.of_node, "slot-tx-eight-phase", (U32_T *)u32_TXEightPhase, u32_SlotNums))
    {
        pr_err(">> [sdmmc] Warn: Could not get dts [slot-tx-eight-phase] option!\n");
    }

    if (of_property_read_u32_array(p_dev->dev.of_node, "slot-rx-eight-phase", (U32_T *)u32_RXEightPhase, u32_SlotNums))
    {
        pr_err(">> [sdmmc] Warn: Could not get dts [slot-rx-eight-phase] option!\n");
    }
#endif
    ...
    for (slotNo = 0; slotNo < gu8_SlotNums; slotNo++)
    {
        ...
        {
            if ((geIpTypeIp[u32_IPOrderSlot[eSlot]] != IP_TYPE_SDIO) && (gu8_SlotNums > 1))
            {
                pr_err(
        ...
        gb_ReverseCDZ[eSlot]                          = (BOOL_T)u32_ReverseCDZ[eSlot];
        ...
        gu32_EnEightPhase[ge_IPOrderSlot[eSlot]] = (BOOL_T)u32_EnEightPhase[eSlot];
        gu32_TXEightPhase[ge_IPOrderSlot[eSlot]] = (BOOL_T)u32_TXEightPhase[eSlot];
        gu32_RXEightPhase[ge_IPOrderSlot[eSlot]] = (BOOL_T)u32_RXEightPhase[eSlot];
#endif
        ...
        // CDZ irq
        u16_cdz_irq[slotNo] = of_irq_get_byname(p_dev->dev.of_node, gu8_irq_name[u32_IPOrderSlot[eSlot]]);
    ...
    pr_sd_dbg(">> [sdmmc] RevCDZ[0-2]= %u, %u, %u \n", gb_ReverseCDZ[0], gb_ReverseCDZ[1], gb_ReverseCDZ[2]);
    ...
    pr_sd_dbg(">> [sdmmc] EnPwrHighValid[0-2]= %u, %u, %u \n", gu32_SlotEnPwrHighValid[0], gu32_SlotEnPwrHighValid[1],
              gu32_SlotEnPwrHighValid[2]);
    ...
    pr_sd_dbg(">> [sdmmc] gu32_RXClkPhase[0-2]= %u, %u, %u \n", gu32_RXClkPhase[0], gu32_RXClkPhase[1],
              gu32_RXClkPhase[2]);
    pr_sd_dbg(">> [sdmmc] gu32_EnEightPhase[0-2]= %u, %u, %u \n", gu32_EnEightPhase[0], gu32_EnEightPhase[1],
              gu32_EnEightPhase[2]);
    pr_sd_dbg(">> [sdmmc] gu32_TXEightPhase[0-2]= %u, %u, %u \n", gu32_TXEightPhase[0], gu32_TXEightPhase[1],
              gu32_TXEightPhase[2]);
    pr_sd_dbg(">> [sdmmc] gu32_RXEightPhase[0-2]= %u, %u, %u \n", gu32_RXEightPhase[0], gu32_RXEightPhase[1],
              gu32_RXEightPhase[2]);
#endif
