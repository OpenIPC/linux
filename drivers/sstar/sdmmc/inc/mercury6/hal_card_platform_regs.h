...
#define A_PLL_1_1_BANK GET_CARD_REG_ADDR(A_RIU_BASE, 0xA0D00) // not used
#define A_PLL_1_2_BANK GET_CARD_REG_ADDR(A_RIU_BASE, 0xA0D80)
#define A_PLL_2_0_BANK GET_CARD_REG_ADDR(A_RIU_BASE, 0xA0E00)
#define A_PLL_2_1_BANK GET_CARD_REG_ADDR(A_RIU_BASE, 0xA0E80)
#define A_PLL_2_2_BANK GET_CARD_REG_ADDR(A_RIU_BASE, 0xA0F00)

#define A_PLL_3_0_BANK GET_CARD_REG_ADDR(A_RIU_BASE, 0xA0E00) // not used
#define A_PLL_3_1_BANK GET_CARD_REG_ADDR(A_RIU_BASE, 0xA0E80)
#define A_PLL_3_2_BANK GET_CARD_REG_ADDR(A_RIU_BASE, 0xA0F00)
