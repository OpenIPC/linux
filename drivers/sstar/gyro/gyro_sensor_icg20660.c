...
static int icg20660_init(struct gyro_dev *dev)
{
    ...
    ret = dev->reg_ops->write_reg(dev, GSEN_ICG20660_INT_ENABLE,
            GYROSENSOR_ICG20660_INT_DATA_READY);
    if (ret < 0) {
        return ret;
    }
...
static int icg20660_set_sample_rate(struct gyro_dev *dev, struct gyro_arg_sample_rate rate)
{
    u8 div = 0;
    switch (rate.rate) {
        case 1000:
...
static int icg20660_get_sample_rate(struct gyro_dev *dev, struct gyro_arg_sample_rate *rate)
{
    int ret = 0;
    u8 div = 0;
...
static int icg20660_set_gyro_range(struct gyro_dev *dev, struct gyro_arg_gyro_range range)
{
    int ret = 0;
    u8 val;
...
static int icg20660_set_accel_range(struct gyro_dev *dev, struct gyro_arg_accel_range range)
{
    int ret = 0;
    u8 val;
...
static int icg20660_get_gyro_range(struct gyro_dev *dev, struct gyro_arg_gyro_range *range)
{
    int ret = 0;
    u8 val;
...
static int icg20660_get_gyro_sensitivity(struct gyro_dev *dev, struct gyro_arg_sensitivity *sensitivity)
{
    int ret = 0;
    u8 val = 0;
...
static int icg20660_get_accel_range(struct gyro_dev *dev, struct gyro_arg_accel_range *range)
{
    int ret = 0;
    u8 val;
...
static int icg20660_get_accel_sensitivity(struct gyro_dev *dev, struct gyro_arg_sensitivity *sensitivity)
{
    int ret = 0;
    u8 val = 0;
...
static struct gyro_sensor_ops gyro_icg20660_ops = {
    ...
    .set_sample_rate       = icg20660_set_sample_rate,
    .get_sample_rate       = icg20660_get_sample_rate,
