...
#if 1
//#define FUNC_MSG(fmt, args...)            ({do{printf(ASCII_COLOR_GREEN"%s[%d] ",__FUNCTION__,__LINE__);printf(fmt,
//##args);printf(ASCII_COLOR_END);}while(0);})
...
#define FUNC_ERR(fmt, args...)                                             \
    (                                                                      \
        {                                                                  \
            do                                                             \
            {                                                              \
                printf(ASCII_COLOR_RED "%s[%d] ", __FUNCTION__, __LINE__); \
                printf(fmt, ##args);                                       \
