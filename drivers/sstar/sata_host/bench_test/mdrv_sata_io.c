...
#define CMD_PARSING(x)                                                          \
    (x == IOCTL_SATA_SET_LOOPBACK_TEST      ? "IOCTL_SATA_SET_LOOPBACK_TEST"    \
...
static SATA_DEV _devSATA = {.s32Major = MDRV_MAJOR_SATA,
...
static struct platform_driver Sstar_sata_driver = {.probe   = sstar_sata_drv_probe,
...
static struct platform_device sg_mdrv_sata_device = {.name = "msata",
                                                     .id   = 0,
                                                     .dev  = {.release           = sstar_sata_drv_platfrom_release,
