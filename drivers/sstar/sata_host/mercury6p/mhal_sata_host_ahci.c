...
void ss_sata_phy_init(void *mmio, int phy_mode, int n_ports)
{
    ...
    // printk("sata phy init A\n"); // this printk is used to check sata bank active status

    OUTREG16((GHC_GP_CTRL + REG_ID_21), 0x0000); //*** Bank 0x1445 h0021 => 0x0 , sata interrupt mask

    OUTREG16((GHC_PHY_D + REG_ID_0D), 0xC000);   //*** Bank 0x143B h000D => 0xC000
    OUTREG16((GHC_PHY_ANA + REG_ID_20), 0x0100); //*** Bank 0x143C h0020 => 0x0100
    ...
    OUTREG16((GHC_PHY_D + REG_ID_26), 0x2003);   //*** Bank 0x143B h0026 => 0x1905
    OUTREG16((GHC_PHY_D + REG_ID_3E), 0xB6E0);   //*** Bank 0x143B h003E => 0xB659
    OUTREG16((GHC_PHY_D + REG_ID_3F), 0x1060);   //*** Bank 0x143B h003E => 0xB659
    OUTREG16((GHC_PHY_D + REG_ID_40), 0x18A9);   //*** Bank 0x143B h0040 => 0xD819
    OUTREG16((GHC_PHY_D + REG_ID_41), 0x147C);   //*** Bank 0x143B h0040 => 0xD819
    ...
    // #chiyun suggestion
    OUTREG16((GHC_PHY_D + REG_ID_0A), 0x4412);   //*** Bank 0x143B h000A => 0x4402 # 143B h0A[6:2] = 5'b00000
    ...
    OUTREG16((GHC_PHY_ANA + REG_ID_40), 0x0A3D); //*** Bank 0x143C h0040 => 0x147C # 143B h41[13:8] = 6'b011110
    OUTREG16((GHC_PHY_ANA + REG_ID_41), 0x0017); //*** Bank 0x143C h0041 => 0x147C # 143B h41[13:8] = 6'b011110
    ...
    OUTREG16((GHC_PHY_ANA + REG_ID_21), 0x0005);  //*** Bank 0x143C h0021 => 0x0010 # 143C h21[7:0] = 8'b00010000
    OUTREG16((GHC_PHY_ANA + REG_ID_10), 0x0000);  //*** Bank 143C h11[15:0],10[15:0] = 32'h2a00 0000
    OUTREG16((GHC_PHY_ANA + REG_ID_11), 0x0A00);  //*** Bank 143C h11[15:0],10[15:0] = 32'h2a00 0000
    ...
    OUTREG16((GHC_PHY2_ANA + REG_ID_06), 0x0060); //*** Bank 0x143D h0006 => 0x0060
    udelay(10);
    ...
    OUTREG16((GHC_PHY2_ANA + REG_ID_2B), 0x0004); //*** Bank 0x143D h002B => 0x0004
