 ...
 */
void foe_to_org_tcphdr(struct foe_entry *entry, struct iphdr *iph, struct tcphdr *th)
{
 ...
 */
void foe_to_org_udphdr(struct foe_entry *entry, struct iphdr *iph, struct udphdr *uh)
{
    /* TODO: how to recovery 6rd/dslite packet */
