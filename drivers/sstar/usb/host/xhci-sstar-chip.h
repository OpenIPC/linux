...
#ifndef _XHCI_SSTAR_CIP_H_
#define _XHCI_SSTAR_CIP_H_
...
#define SSTAR_LOST_SLOT_PATCH 0
...
extern ptrdiff_t sstar_pm_base;
#define _SSTAR_PM_BASE (sstar_pm_base)
#elif defined(CONFIG_ARM)
#define _SSTAR_PM_BASE 0xFD000000
#else
#define _SSTAR_PM_BASE 0xBF000000
#endif

//------ U3TOP, DTOP, ATOP and XHC base address -----------------------------
//---- Port0
//#define _SSTAR_U3PHY_DTOP_BASE (_SSTAR_USB_BASEADR+(0x11C00*2))
//#define _SSTAR_U3PHY_ATOP_BASE (_SSTAR_USB_BASEADR+(0x22100*2))
//#define _SSTAR_U3UTMI_BASE     0
//#define _SSTAR_U3TOP_BASE      (_SSTAR_USB_BASEADR+(0x40200*2))
//#define _SSTAR_XHCI_BASE       (_SSTAR_PM_BASE+(0x380000*2))
//#define _SSTAR_U3BC_BASE       0

#define _SSTAR_U3PHY_DTOP0_BASE (_SSTAR_USB_BASEADR + (0x02000 * 2))
#define _SSTAR_U3PHY_ATOP0_BASE (_SSTAR_USB_BASEADR + (0x02100 * 2))
#define _SSTAR_U3TOP0_BASE      (_SSTAR_USB_BASEADR + (0x40200 * 2))
#define _SSTAR_XHCI0_BASE       (_SSTAR_PM_BASE + (0x380000 * 2))
#define _SSTAR_U3UTMI0_BASE     0
#define _SSTAR_U3BC0_BASE       0

//---- Port1
#ifdef ENABLE_SECOND_XHC
#define _SSTAR_U3PHY_DTOP1_BASE (_SSTAR_USB_BASEADR + (0x02200 * 2))
#define _SSTAR_U3PHY_ATOP1_BASE (_SSTAR_USB_BASEADR + (0x02300 * 2))
#define _SSTAR_U3TOP1_BASE      (_SSTAR_USB_BASEADR + (0x71900 * 2))
#define _SSTAR_XHCI1_BASE       (_SSTAR_PM_BASE + (0x390000 * 2))
#define _SSTAR_U3UTMI1_BASE     0
#define _SSTAR_U3BC1_BASE       0
#endif
