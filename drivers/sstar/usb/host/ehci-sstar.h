...
#define EHCI_SSTAR_VERSION "20180309"
...
/*#define SSTAR_USB_INREG16(x)     readw((x))
#define SSTAR_USB_OUTREG16(x, y) writew((y), (x))
#define SSTAR_USB_CLRREG16(x, y) SSTAR_USB_OUTREG16((x), SSTAR_USB_INREG16(x) & ~(y))
#define SSTAR_USB_SETREG16(x, y) SSTAR_USB_OUTREG16((x), SSTAR_USB_INREG16(x) | (y))

#define SSTAR_USB_INREG8(x)     readb((x))
#define SSTAR_USB_OUTREG8(x, y) writeb((y), (x))
#define SSTAR_USB_CLRREG8(x, y) SSTAR_USB_OUTREG8((x), SSTAR_USB_INREG8(x) & ~(y))
#define SSTAR_USB_SETREG8(x, y) SSTAR_USB_OUTREG8((x), SSTAR_USB_INREG8(x) | (y))*/

//------ RIU base addr and bus-addr to phy-addr translation ----------
#ifdef CONFIG_ARM64
#define _SSTAR_USB_BASEADR ((VMALLOC_START & 0xFFFFFFFF00000000) + 0xFD200000)
#ifdef CONFIG_MIU0_BUS_BASE
#define MIU0_BASE UL(CONFIG_MIU0_BUS_BASE)
#else
#define MIU0_BASE 0x20000000
#endif
#define MIU_HPAGE_BASE     0x1000000000L
#define MIU_IF_HPAGE       0x100000000L
#define MIU0_BUS_BASE_ADDR SSTAR_MIU0_BUS_BASE
#define MIU1_BUS_BASE_ADDR SSTAR_MIU1_BUS_BASE
...
#define BUS2PA(A) (A - MIU0_BASE)
#define PA2BUS(A) (A + MIU0_BASE)
#endif
#if defined(CONFIG_ARM)
//#include <sstar/sstar_chip.h>
#define _SSTAR_USB_BASEADR 0xfd200000
