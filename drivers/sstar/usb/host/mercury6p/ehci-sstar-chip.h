...
#define REG_ADDR_BASE_CHIPTOP (_SSTAR_USB_BASEADR + (0x1E00 << 1))
#define REG_ADDR_BASE_OTP     (_SSTAR_USB_BASEADR + (0x1F00 << 1))
...
#define _SSTAR_UTMI2_BASE (_SSTAR_USB_BASEADR + (0x43700 * 2))
