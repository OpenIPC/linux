...
#ifdef CONFIG_ARM64
#define RIU_BASE ((VMALLOC_START & 0xFFFFFFFF00000000) + 0xFD200000)
#else
...
#define REG_ADDR_BASE_CHIPTOP GET_BASE_ADDR_BY_BANK(RIU_BASE, 0x1E00)
#define REG_ADDR_BASE_OTP     GET_BASE_ADDR_BY_BANK(RIU_BASE, 0x1F00)

#define UTMI2_BASE_ADDR GET_BASE_ADDR_BY_BANK(RIU_BASE, 0x43700)
...
#define MSB250X_HIGH_OUT_EP(_dev, _ep)       _ep = ((_dev)->ep[2].ep.desc) ? NULL : &((_dev)->ep[2].ep)
#define MSB250X_HIGH_IN_EP(_dev, _ep)        _ep = ((_dev)->ep[1].ep.desc) ? NULL : &((_dev)->ep[1].ep)
#define MSB250X_PARAM_EP(_dev, _epnum, _ep)  _ep = ((_dev)->ep[_epnum].ep.desc) ? NULL : &((_dev)->ep[_epnum].ep)

#define MSB250X_PA2BUS(a) (a - MIU0_BASE)
#define MSB250X_BUS2PA(a) (a + MIU0_BASE)
