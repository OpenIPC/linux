...
/*        BDMA registers                                                     */
/****************************************************************************/
#define REG_BDMA_BK_TRIG        (0x00 << 1)
#define REG_BDMA_BK_STATUS      (0x01 << 1)
#define REG_BDMA_BK_SEL_SRCDST  (0x02 << 1)
#define REG_BDMA_BK_REPALCE_MIU (0x03 << 1)

#define REG_BDMA_BK_SRC_ADDR_L (0x04 << 1)
#define REG_BDMA_BK_SRC_ADDR_H (0x05 << 1)
#define REG_BDMA_BK_DST_ADDR_L (0x06 << 1)
#define REG_BDMA_BK_DST_ADDR_H (0x07 << 1)
#define REG_BDMA_BK_SIZE_L     (0x08 << 1)
#define REG_BDMA_BK_SIZE_H     (0x09 << 1)

#define REG_BDMA_BK_SPECIAL_CMD0_L (0x0A << 1)
#define REG_BDMA_BK_SPECIAL_CMD0_H (0x0B << 1)
#define REG_BDMA_BK_SPECIAL_CMD1_L (0x0C << 1)
#define REG_BDMA_BK_SPECIAL_CMD1_H (0x0D << 1)
#define REG_BDMA_BK_SPECIAL_CMD2_L (0x0E << 1)
#define REG_BDMA_BK_SPECIAL_CMD3_H (0x0F << 1)
#define REG_BDMA_BK_OFFSET_ENABLE  (0x10 << 1)

#define REG_BDMA_BK_SRC_WIDTH_L  (0x12 << 1)
#define REG_BDMA_BK_SRC_WIDTH_H  (0x13 << 1)
#define REG_BDMA_BK_SRC_OFFSET_L (0x14 << 1)
#define REG_BDMA_BK_SRC_OFFSET_H (0x15 << 1)

#define REG_BDMA_BK_DST_WIDTH_L  (0x16 << 1)
#define REG_BDMA_BK_DST_WIDTH_H  (0x17 << 1)
#define REG_BDMA_BK_DST_OFFSET_L (0x18 << 1)
#define REG_BDMA_BK_DST_OFFSET_H (0x19 << 1)

#define REG_BDMA_BK_SRC_ADDR_MSB4 (0x1A << 1)
#define REG_BDMA_BK_DST_ADDR_MSB4 (0x1B << 1)
