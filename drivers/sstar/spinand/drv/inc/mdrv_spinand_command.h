...
typedef enum
{
    ECC_STATUS_3BIT_PASS = 0x0 << 4,
    ECC_STATUS_3BIT_1BITFLIP = 0x1 << 4,
    ECC_STATUS_3BIT_2BITFLIP = 0x2 << 4,
    ECC_STATUS_3BIT_3BITFLIP = 0x3 << 4,
    ECC_STATUS_3BIT_4BITFLIP = 0x4 << 4,
    ECC_STATUS_3BIT_ERR = 0x7 << 4,
} SPINAND_ECC_STATUS_3BIT;
