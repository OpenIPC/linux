...
static BOOL HAL_HWI2C_DMA_SetMiuData(U16 u16PortOffset, U32 u32Length, U8* pu8SrcData)
{
    ...
    Chip_Flush_Cache_Range((u32)pu8SrcData, u32Length);
    memcpy(pMiuData,pu8SrcData,u32Length);
    Chip_Flush_Cache_Range((u32)pMiuData,u32Length);
...
static BOOL HAL_HWI2C_DMA_GetMiuData(U16 u16PortOffset, U32 u32Length, U8* pu8DstData)
{
    ...
    u32PhyAddr = g_u32DmaPhyAddr[u8Port];
    pMiuData = HWI2C_DMA[u8Port].i2c_virt_addr;
    Chip_Inv_Cache_Range((u32)pMiuData, u32Length);
    memcpy((void*)pu8DstData,(void*)pMiuData,u32Length);
    Chip_Inv_Cache_Range((u32)pu8DstData, u32Length);
    return TRUE;
}
...
/// @param <RET>        \b TRUE : ok, FALSE : fail
////////////////////////////////////////////////////////////////////////////////
static irqreturn_t HAL_HWI2C_DMA_WN_I2c0_Isr(int IntNum, void* dev_id)
{
	U16 u16PortOffset;
...
/// @param <RET>        \b TRUE : ok, FALSE : fail
////////////////////////////////////////////////////////////////////////////////
static irqreturn_t HAL_HWI2C_DMA_WN_I2c1_Isr(int IntNum, void* dev_id)
{
	U16 u16PortOffset;
...
/// @param <RET>        \b TRUE : ok, FALSE : fail
////////////////////////////////////////////////////////////////////////////////
static irqreturn_t HAL_HWI2C_DMA_WN_I2c2_Isr(int IntNum, void* dev_id)
{
	U16 u16PortOffset;
...
/// @param <RET>        \b TRUE : ok, FALSE : fail
////////////////////////////////////////////////////////////////////////////////
static BOOL HAL_HWI2C_DMA_WN_SetMiuData(U16 u16PortOffset, struct i2c_msg* pmsg, U32 u32cnt)
{
	U32 u32PhyAddr = 0;
    U8 *pMiuData = 0;
    U8 u8Port;
	U32 i;
	struct i2c_msg* pCurmsg = pmsg;
...
/// @param <RET>        \b TRUE : ok, FALSE : fail
////////////////////////////////////////////////////////////////////////////////
BOOL HAL_HWI2C_DMA_WN_WriteBytes(U16 u16PortOffset, U16 u16SlaveCfg, struct i2c_msg* pmsg, U32 u32cnt)
{
	U8 u8SlaveAddr = LOW_BYTE(u16SlaveCfg)>>1;
...
{
	U16 u16nwritecnt[HAL_HWI2C_NWRITE_MAXNUM] = {0};
	U16 i = 1;
	U16 u16index = 0;
	U16 len;
	struct i2c_msg* pi2cmsg = (struct i2c_msg*)pmsg;

	memset(u16nwritecnt, 0xFFFF, sizeof(u16nwritecnt));
