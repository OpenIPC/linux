...
//
//############################
#define CHIP_REG_BASE                   0//(0x103C00)
...
//for port 3
#define CHIP_REG_HWI2C_MIIC3            (CHIP_REG_BASE+ (0x50*2))
    #define CHIP_MIIC3_PAD_0            (0)
    #define CHIP_MIIC3_PAD_1            (__BIT0)
    #define CHIP_MIIC3_PAD_2            (__BIT1)
    #define CHIP_MIIC3_PAD_3            (__BIT0|__BIT1)
    #define CHIP_MIIC3_PAD_4            (__BIT2)
    #define CHIP_MIIC3_PAD_5            (__BIT0|__BIT2)
    #define CHIP_MIIC3_PAD_MSK          (__BIT0|__BIT1|__BIT2)

#define CHIP_REG_PM_PAD_EXT_MODE1       (0x56*2)
    #define CHIP_PAD_PM_I2CM_SCL        (__BIT5)
    #define CHIP_PAD_PM_I2CM_SDA        (__BIT6)
...
#define REG_HWI2C_RESERVE0              (HWI2C_REG_BASE+0x10*2)
	#define _INT_CFG_CORE2DMA           (__BIT0)
...
#define REG_HWI2C_DMA_GROUP_LEN         (HWI2C_REG_BASE+0x32*2)
#define REG_HWI2C_DMA_WNMODE_EN   		(HWI2C_REG_BASE+0x33*2)
	#define _DMA_CTL_WNMODE_EN          (__BIT0)
#define REG_HWI2C_DMA_WN_WAITCNT  		(HWI2C_REG_BASE+0x34*2)
