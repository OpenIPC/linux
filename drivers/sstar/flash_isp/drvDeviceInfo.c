...
//
//  Special Block Table (List)
//

ST_SPECIAL_BLOCKS _stSpecialBlocks_EN25F10 = {
...
ST_SPECIAL_BLOCKS _stSpecialBlocks_EN25B32B = {
    .u16Start     = 0, // Start block# of special block size
...
ST_SPECIAL_BLOCKS _stSpecialBlocks_EN25B64B = {
    .u16Start     = 0, // Start block# of special block size
    .u16End       = 4, // End   block# of special block size
    .au32SizeList =    // List of special size;Total size must be equal to block size
    {
...
ST_WRITE_PROTECT _pstWriteProtectTable_W25X32[] = {
    ...
    {BITS(5 : 2, 1), 0x003F0000, 0x003FFFFF},  {BITS(5 : 2, 2), 0x003E0000, 0x003FFFFF},
    {BITS(5 : 2, 3), 0x003C0000, 0x003FFFFF},  {BITS(5 : 2, 4), 0x00380000, 0x003FFFFF},
    {BITS(5 : 2, 5), 0x00300000, 0x003FFFFF},  {BITS(5 : 2, 6), 0x00200000, 0x003FFFFF},
    {BITS(5 : 2, 9), 0x00000000, 0x0000FFFF},  {BITS(5 : 2, 10), 0x00000000, 0x0001FFFF},
    {BITS(5 : 2, 11), 0x00000000, 0x0003FFFF}, {BITS(5 : 2, 12), 0x00000000, 0x0007FFFF},
    {BITS(5 : 2, 13), 0x00000000, 0x000FFFFF}, {BITS(5 : 2, 14), 0x00000000, 0x001FFFFF},
    {BITS(5 : 2, 15), 0x00000000, 0x003FFFFF}, {BITS(5 : 2, 0), 0xFFFFFFFF, 0xFFFFFFFF},
};

ST_WRITE_PROTECT _pstWriteProtectTable_W25X64[] = {
    //   BPX,                    Lower Bound         Upper Bound
    {BITS(5 : 2, 1), 0x007E0000, 0x007FFFFF},  {BITS(5 : 2, 2), 0x007C0000, 0x007FFFFF},
    {BITS(5 : 2, 3), 0x00780000, 0x007FFFFF},  {BITS(5 : 2, 4), 0x00700000, 0x007FFFFF},
    {BITS(5 : 2, 5), 0x00600000, 0x007FFFFF},  {BITS(5 : 2, 6), 0x00400000, 0x007FFFFF},
    {BITS(5 : 2, 9), 0x00000000, 0x0001FFFF},  {BITS(5 : 2, 10), 0x00000000, 0x0003FFFF},
    {BITS(5 : 2, 11), 0x00000000, 0x0007FFFF}, {BITS(5 : 2, 12), 0x00000000, 0x000FFFFF},
    {BITS(5 : 2, 13), 0x00000000, 0x001FFFFF}, {BITS(5 : 2, 14), 0x00000000, 0x003FFFFF},
    {BITS(5 : 2, 15), 0x00000000, 0x007FFFFF}, {BITS(5 : 2, 0), 0xFFFFFFFF, 0xFFFFFFFF},
};
...
ST_WRITE_PROTECT _pstWriteProtectTable_GD25Q128_CMP0[] = {
    //   BPX,             Lower Bound     Upper Bound
    {BITS(6 : 2, 0x00), 0xFFFFFFFF, 0xFFFFFFFF}, {BITS(6 : 2, 0x01), 0x00FC0000, 0x00FFFFFF},
    {BITS(6 : 2, 0x02), 0x00F80000, 0x00FFFFFF}, {BITS(6 : 2, 0x03), 0x00F00000, 0x00FFFFFF},
    {BITS(6 : 2, 0x04), 0x00E00000, 0x00FFFFFF}, {BITS(6 : 2, 0x05), 0x00C00000, 0x00FFFFFF},
    {BITS(6 : 2, 0x06), 0x00800000, 0x0000FFFF},

    {BITS(6 : 2, 0x09), 0x00000000, 0x0003FFFF}, {BITS(6 : 2, 0x0A), 0x00000000, 0x0007FFFF},
    {BITS(6 : 2, 0x0B), 0x00000000, 0x000FFFFF}, {BITS(6 : 2, 0x0C), 0x00000000, 0x001FFFFF},
    {BITS(6 : 2, 0x0D), 0x00000000, 0x003FFFFF}, {BITS(6 : 2, 0x0E), 0x00000000, 0x007FFFFF},
    {BITS(6 : 2, 0x0F), 0x00000000, 0x00FFFFFF},

    {BITS(6 : 2, 0x11), 0x00FFF000, 0x00FFFFFF}, {BITS(6 : 2, 0x12), 0x00FEE000, 0x00FFFFFF},
    {BITS(6 : 2, 0x13), 0x00FFC000, 0x00FFFFFF}, {BITS(6 : 2, 0x14), 0x00FF8000, 0x00FFFFFF},
    {BITS(6 : 2, 0x16), 0x00FF8000, 0x00FFFFFF},

    {BITS(6 : 2, 0x19), 0x00000000, 0x00000FFF}, {BITS(6 : 2, 0x1A), 0x00000000, 0x00001FFF},
    {BITS(6 : 2, 0x1B), 0x00000000, 0x00003FFF}, {BITS(6 : 2, 0x1C), 0x00000000, 0x00007FFF},
    {BITS(6 : 2, 0x1E), 0x00000000, 0x00007FFF},
};

#if 0 // researved for GD25Q16 flash
ST_WRITE_PROTECT _pstWriteProtectTable_GD25Q16_CMP1[] =
{
    //   BPX,                    Lower Bound         Upper Bound
...
ST_WRITE_PROTECT _pstWriteProtectTable_W25Q64CV_CMP1[] = {
    //   BPX,                    Lower Bound         Upper Bound
    {BITS(6 : 2, 0x00), 0x00000000, 0x007FFFFF}, {BITS(6 : 2, 0x01), 0x00000000, 0x007DFFFF},
    {BITS(6 : 2, 0x02), 0x00000000, 0x007BFFFF}, {BITS(6 : 2, 0x03), 0x00000000, 0x0077FFFF},
    {BITS(6 : 2, 0x04), 0x00000000, 0x006FFFFF}, {BITS(6 : 2, 0x05), 0x00000000, 0x005FFFFF},
    {BITS(6 : 2, 0x06), 0x00000000, 0x003FFFFF},

    {BITS(6 : 2, 0x09), 0x00020000, 0x007FFFFF}, {BITS(6 : 2, 0x0A), 0x00040000, 0x007FFFFF},
    {BITS(6 : 2, 0x0B), 0x00080000, 0x007FFFFF}, {BITS(6 : 2, 0x0C), 0x00100000, 0x007FFFFF},
    {BITS(6 : 2, 0x0D), 0x00200000, 0x007FFFFF}, {BITS(6 : 2, 0x0E), 0x00400000, 0x007FFFFF},
    {BITS(6 : 2, 0x1F), 0xFFFFFFFF, 0xFFFFFFFF},

    {BITS(6 : 2, 0x11), 0x00000000, 0x007FEFFF}, {BITS(6 : 2, 0x12), 0x00000000, 0x007FDFFF},
    {BITS(6 : 2, 0x13), 0x00000000, 0x007FBFFF}, {BITS(6 : 2, 0x14), 0x00000000, 0x007F7FFF},

    {BITS(6 : 2, 0x19), 0x00001000, 0x007FFFFF}, {BITS(6 : 2, 0x1A), 0x00002000, 0x007FFFFF},
    {BITS(6 : 2, 0x1B), 0x00004000, 0x007FFFFF}, {BITS(6 : 2, 0x1C), 0x00008000, 0x007FFFFF},
};

ST_WRITE_PROTECT _pstWriteProtectTable_W25Q32BV_CMP1[] = {
    //   BPX,                    Lower Bound         Upper Bound
    {BITS(6 : 2, 0x00), 0x00000000, 0x003FFFFF}, {BITS(6 : 2, 0x01), 0x00000000, 0x003EFFFF},
    {BITS(6 : 2, 0x02), 0x00000000, 0x003DFFFF}, {BITS(6 : 2, 0x03), 0x00000000, 0x003BFFFF},
    {BITS(6 : 2, 0x04), 0x00000000, 0x0037FFFF}, {BITS(6 : 2, 0x05), 0x00000000, 0x002FFFFF},
    {BITS(6 : 2, 0x06), 0x00000000, 0x001FFFFF},

    {BITS(6 : 2, 0x09), 0x00010000, 0x003FFFFF}, {BITS(6 : 2, 0x0A), 0x00020000, 0x003FFFFF},
    {BITS(6 : 2, 0x0B), 0x00040000, 0x003FFFFF}, {BITS(6 : 2, 0x0C), 0x00080000, 0x003FFFFF},
    {BITS(6 : 2, 0x0D), 0x00100000, 0x003FFFFF}, {BITS(6 : 2, 0x0E), 0x00200000, 0x003FFFFF},
    {BITS(6 : 2, 0x1F), 0xFFFFFFFF, 0xFFFFFFFF},

    {BITS(6 : 2, 0x11), 0x00000000, 0x003FEFFF}, {BITS(6 : 2, 0x12), 0x00000000, 0x003FDFFF},
    {BITS(6 : 2, 0x13), 0x00000000, 0x003FBFFF}, {BITS(6 : 2, 0x14), 0x00000000, 0x003F7FFF},

    {BITS(6 : 2, 0x19), 0x00001000, 0x003FFFFF}, {BITS(6 : 2, 0x1A), 0x00002000, 0x003FFFFF},
    {BITS(6 : 2, 0x1B), 0x00004000, 0x003FFFFF}, {BITS(6 : 2, 0x1C), 0x00008000, 0x003FFFFF},
};
...
static ST_WRITE_PROTECT _pstWriteProtectTable_XM25QH128A[] = {
    ...
    {BITS(6 : 2, 0X02), 0x00F80000, 0x00FFFFFF}, {BITS(6 : 2, 0X03), 0x00F00000, 0x00FFFFFF},
    {BITS(6 : 2, 0X04), 0x00E00000, 0x00FFFFFF}, {BITS(6 : 2, 0X05), 0x00C00000, 0x00FFFFFF},
    {BITS(6 : 2, 0X06), 0x00800000, 0x00FFFFFF}, {BITS(6 : 2, 0X07), 0x00000000, 0x00FFFFFF},
    {BITS(6 : 2, 0X08), 0xFFFFFFFF, 0xFFFFFFFF}, {BITS(6 : 2, 0X09), 0x00000000, 0x0003FFFF},
    {BITS(6 : 2, 0X0A), 0x00000000, 0x0007FFFF}, {BITS(6 : 2, 0X0B), 0x00000000, 0x000FFFFF},
    {BITS(6 : 2, 0X0C), 0x00000000, 0x001FFFFF}, {BITS(6 : 2, 0X0D), 0x00000000, 0x003FFFFF},
    {BITS(6 : 2, 0X0E), 0x00000000, 0x007FFFFF}, {BITS(6 : 2, 0X0F), 0x00000000, 0x00FFFFFF},

    {BITS(6 : 2, 0X10), 0xFFFFFFFF, 0xFFFFFFFF}, {BITS(6 : 2, 0X11), 0x00000000, 0x00FBFFFF},
    {BITS(6 : 2, 0X12), 0x00000000, 0x00F7FFFF}, {BITS(6 : 2, 0X13), 0x00000000, 0x00EFFFFF},
    {BITS(6 : 2, 0X14), 0x00000000, 0x00DFFFFF}, {BITS(6 : 2, 0X15), 0x00000000, 0x00BFFFFF},
    {BITS(6 : 2, 0X16), 0x00000000, 0x007FFFFF}, {BITS(6 : 2, 0X17), 0x00000000, 0x00FFFFFF},
    {BITS(6 : 2, 0X18), 0xFFFFFFFF, 0xFFFFFFFF}, {BITS(6 : 2, 0X19), 0x00040000, 0x00FFFFFF},
    {BITS(6 : 2, 0X1A), 0x00080000, 0x00FFFFFF}, {BITS(6 : 2, 0X1B), 0x00100000, 0x00FFFFFF},
    {BITS(6 : 2, 0X1C), 0x00200000, 0x00FFFFFF}, {BITS(6 : 2, 0X1D), 0x00400000, 0x00FFFFFF},
    {BITS(6 : 2, 0X1E), 0x00800000, 0x00FFFFFF}, {BITS(6 : 2, 0X1F), 0x00000000, 0x00FFFFFF},
...
static ST_WRITE_PROTECT _pstWriteProtectTable_XM25QH64A[] = {
    //   BPX,                    Lower Bound         Upper Bound
    {BITS(6 : 2, 0X00), 0xFFFFFFFF, 0xFFFFFFFF}, {BITS(6 : 2, 0X01), 0x007F0000, 0x007FFFFF},
    {BITS(6 : 2, 0X02), 0x007E0000, 0x007FFFFF}, {BITS(6 : 2, 0X03), 0x007C0000, 0x007FFFFF},
    {BITS(6 : 2, 0X04), 0x00780000, 0x007FFFFF}, {BITS(6 : 2, 0X05), 0x00700000, 0x007FFFFF},
    {BITS(6 : 2, 0X06), 0x00600000, 0x007FFFFF}, {BITS(6 : 2, 0X07), 0x00400000, 0x007FFFFF},
    {BITS(6 : 2, 0X08), 0x00200000, 0x007FFFFF}, {BITS(6 : 2, 0X09), 0x00100000, 0x007FFFFF},
    {BITS(6 : 2, 0X0A), 0x00080000, 0x007FFFFF}, {BITS(6 : 2, 0X0B), 0x00040000, 0x007FFFFF},
    {BITS(6 : 2, 0X0C), 0x00020000, 0x007FFFFF}, {BITS(6 : 2, 0X0D), 0x00010000, 0x007FFFFF},
    {BITS(6 : 2, 0X0E), 0x00000000, 0x007FFFFF}, {BITS(6 : 2, 0X0F), 0x00000000, 0x007FFFFF},

    {BITS(6 : 2, 0X10), 0xFFFFFFFF, 0xFFFFFFFF}, {BITS(6 : 2, 0X11), 0x00000000, 0x0000FFFF},
    {BITS(6 : 2, 0X12), 0x00000000, 0x0001FFFF}, {BITS(6 : 2, 0X13), 0x00000000, 0x0003FFFF},
    {BITS(6 : 2, 0X14), 0x00000000, 0x0007FFFF}, {BITS(6 : 2, 0X15), 0x00000000, 0x000FFFFF},
    {BITS(6 : 2, 0X16), 0x00000000, 0x001FFFFF}, {BITS(6 : 2, 0X17), 0x00000000, 0x003FFFFF},
    {BITS(6 : 2, 0X18), 0x00000000, 0x005FFFFF}, {BITS(6 : 2, 0X19), 0x00000000, 0x006FFFFF},
    {BITS(6 : 2, 0X1A), 0x00000000, 0x0077FFFF}, {BITS(6 : 2, 0X1B), 0x00000000, 0x007BFFFF},
    {BITS(6 : 2, 0X1C), 0x00000000, 0x007DFFFF}, {BITS(6 : 2, 0X1D), 0x00000000, 0x007EFFFF},
    {BITS(6 : 2, 0X1E), 0x00000000, 0x007FFFFF}, {BITS(6 : 2, 0X1F), 0x00000000, 0x007FFFFF},
...
ST_WRITE_PROTECT _pstWriteProtectTable_W25Q80[] = {
    //   BPX,                    Lower Bound         Upper Bound
    {BITS(6 : 2, 1), 0x000F0000, 0x000FFFFF},  {BITS(6 : 2, 2), 0x000E0000, 0x000FFFFF},
    {BITS(6 : 2, 3), 0x000C0000, 0x000FFFFF},  {BITS(6 : 2, 4), 0x00080000, 0x000FFFFF},
    {BITS(6 : 2, 9), 0x00000000, 0x0000FFFF},  {BITS(6 : 2, 10), 0x00000000, 0x0001FFFF},
    {BITS(6 : 2, 11), 0x00000000, 0x0003FFFF}, {BITS(6 : 2, 12), 0x00000000, 0x0007FFFF},
    {BITS(6 : 2, 15), 0x00000000, 0x000FFFFF}, {BITS(6 : 2, 17), 0x000FF000, 0x000FFFFF},
    {BITS(6 : 2, 18), 0x000FE000, 0x000FFFFF}, {BITS(6 : 2, 19), 0x000FC000, 0x000FFFFF},
    {BITS(6 : 2, 20), 0x000F8000, 0x000FFFFF}, {BITS(6 : 2, 25), 0x00000000, 0x00000FFF},
    {BITS(6 : 2, 26), 0x00000000, 0x00001FFF}, {BITS(6 : 2, 27), 0x00000000, 0x00003FFF},
    {BITS(6 : 2, 28), 0x00000000, 0x00007FFF}, {BITS(6 : 2, 0), 0xFFFFFFFF, 0xFFFFFFFF},
};

ST_WRITE_PROTECT _pstWriteProtectTable_W25X80[] = {
    //   BPX,                    Lower Bound         Upper Bound
    {BITS(5 : 2, 1), 0x000F0000, 0x000FFFFF},  {BITS(5 : 2, 2), 0x000E0000, 0x000FFFFF},
    {BITS(5 : 2, 3), 0x000C0000, 0x000FFFFF},  {BITS(5 : 2, 4), 0x00080000, 0x000FFFFF},
    {BITS(5 : 2, 9), 0x00000000, 0x0000FFFF},  {BITS(5 : 2, 10), 0x00000000, 0x0001FFFF},
    {BITS(5 : 2, 11), 0x00000000, 0x0003FFFF}, {BITS(5 : 2, 12), 0x00000000, 0x0007FFFF},
    {BITS(5 : 2, 13), 0x00000000, 0x000FFFFF}, {BITS(5 : 2, 15), 0x00000000, 0x000FFFFF},
    {BITS(5 : 2, 0), 0xFFFFFFFF, 0xFFFFFFFF},
};
...
static ST_WRITE_PROTECT _pstWriteProtectTable_ZB25Q64[] = {
    //   BPX,           Lower Bound     Upper Bound
    {BITS(5 : 2, 1), 0x007F0000, 0x007FFFFF},  {BITS(5 : 2, 2), 0x007E0000, 0x007FFFFF},
    {BITS(5 : 2, 3), 0x007C0000, 0x007FFFFF},  {BITS(5 : 2, 4), 0x00780000, 0x007FFFFF},
    {BITS(5 : 2, 5), 0x00700000, 0x007FFFFF},  {BITS(5 : 2, 6), 0x00600000, 0x007FFFFF},
    {BITS(5 : 2, 7), 0x00400000, 0x007FFFFF},  {BITS(5 : 2, 8), 0x00200000, 0x007FFFFF},
    {BITS(5 : 2, 9), 0x00100000, 0x007FFFFF},  {BITS(5 : 2, 10), 0x00080000, 0x007FFFFF},
    {BITS(5 : 2, 11), 0x00040000, 0x007FFFFF}, {BITS(5 : 2, 12), 0x00020000, 0x007FFFFF},
    {BITS(5 : 2, 13), 0x00010000, 0x007FFFFF}, {BITS(5 : 2, 14), 0x00000000, 0x007FFFFF},
    {BITS(5 : 2, 15), 0x00000000, 0x007FFFFF}, {BITS(5 : 2, 0), 0xFFFFFFFF, 0xFFFFFFFF},
};

static ST_WRITE_PROTECT _pstWriteProtectTable_ZB25Q128[] = {
    //   BPX,           Lower Bound     Upper Bound
    {BITS(5 : 2, 1), 0x00FC0000, 0x00FFFFFF},  {BITS(5 : 2, 2), 0x00F80000, 0x00FFFFFF},
    {BITS(5 : 2, 3), 0x00F00000, 0x00FFFFFF},  {BITS(5 : 2, 4), 0x00E00000, 0x00FFFFFF},
    {BITS(5 : 2, 5), 0x00C00000, 0x00FFFFFF},  {BITS(5 : 2, 6), 0x00800000, 0x00FFFFFF},
    {BITS(5 : 2, 7), 0x00000000, 0x00FFFFFF},  {BITS(5 : 2, 8), 0xFFFFFFFF, 0xFFFFFFFF},
    {BITS(5 : 2, 9), 0x00000000, 0x0003FFFF},  {BITS(5 : 2, 10), 0x00000000, 0x0007FFFF},
    {BITS(5 : 2, 11), 0x00000000, 0x000FFFFF}, {BITS(5 : 2, 12), 0x00000000, 0x001FFFFF},
    {BITS(5 : 2, 13), 0x00000000, 0x003FFFFF}, {BITS(5 : 2, 14), 0x00000000, 0x007FFFFF},
    {BITS(5 : 2, 15), 0x00000000, 0x00FFFFFF}, {BITS(5 : 2, 0), 0xFFFFFFFF, 0xFFFFFFFF},
};
...
static ST_WRITE_PROTECT _pstWriteProtectTable_XTX_XT25F64B[] = {
    //  BPX,            Lower Bound                  Upper Bound
    {BITS(6 : 2, 0X00), 0x00000000, 0x007FFFFF},

    {BITS(6 : 2, 0X01), 0x00000000, 0x007DFFFF}, {BITS(6 : 2, 0X02), 0x00000000, 0x007BFFFF},
    {BITS(6 : 2, 0X03), 0x00000000, 0x0077FFFF}, {BITS(6 : 2, 0X04), 0x00000000, 0x006FFFFF},
    {BITS(6 : 2, 0X05), 0x00000000, 0x005FFFFF}, {BITS(6 : 2, 0X06), 0x00000000, 0x004FFFFF},

    {BITS(6 : 2, 0X07), 0xFFFFFFFF, 0xFFFFFFFF}, {BITS(6 : 2, 0X08), 0x00000000, 0x007FFFFF},

    {BITS(6 : 2, 0X09), 0x00020000, 0x007FFFFF}, {BITS(6 : 2, 0X0A), 0x00040000, 0x007FFFFF},
    {BITS(6 : 2, 0X0B), 0x00080000, 0x007FFFFF}, {BITS(6 : 2, 0X0C), 0x00100000, 0x007FFFFF},
    {BITS(6 : 2, 0X0D), 0x00200000, 0x007FFFFF}, {BITS(6 : 2, 0X0E), 0x00400000, 0x007FFFFF},

    {BITS(6 : 2, 0X0F), 0xFFFFFFFF, 0xFFFFFFFF}, {BITS(6 : 2, 0X10), 0x00000000, 0x007FFFFF},

    {BITS(6 : 2, 0X11), 0x00000000, 0x007FEFFF}, {BITS(6 : 2, 0X12), 0x00000000, 0x007FDFFF},
    {BITS(6 : 2, 0X13), 0x00000000, 0x007FBFFF}, {BITS(6 : 2, 0X14), 0x00000000, 0x007F7FFF},
    {BITS(6 : 2, 0X15), 0x00000000, 0x007F7FFF}, {BITS(6 : 2, 0X16), 0x00000000, 0x007F7FFF},

    {BITS(6 : 2, 0X17), 0xFFFFFFFF, 0xFFFFFFFF}, {BITS(6 : 2, 0X18), 0x00000000, 0x007FFFFF},

    {BITS(6 : 2, 0X19), 0x00001000, 0x007FFFFF}, {BITS(6 : 2, 0X1A), 0x00002000, 0x007FFFFF},
    {BITS(6 : 2, 0X1B), 0x00004000, 0x007FFFFF}, {BITS(6 : 2, 0X1C), 0x00008000, 0x007FFFFF},
    {BITS(6 : 2, 0X1D), 0x00008000, 0x007FFFFF}, {BITS(6 : 2, 0X1E), 0x00008000, 0x007FFFFF},

    {BITS(6 : 2, 0X1F), 0xFFFFFFFF, 0xFFFFFFFF},
};

static ST_WRITE_PROTECT _pstWriteProtectTable_XTX_XT25F128B[] = {
    //  BPX,            Lower Bound                  Upper Bound
    {BITS(6 : 2, 0X00), 0xFFFFFFFF, 0xFFFFFFFF},

    {BITS(6 : 2, 0X01), 0x00FC0000, 0x00FFFFFF}, {BITS(6 : 2, 0X02), 0x00F80000, 0x00FFFFFF},
    {BITS(6 : 2, 0X03), 0x00F00000, 0x00FFFFFF}, {BITS(6 : 2, 0X04), 0x00E00000, 0x00FFFFFF},
    {BITS(6 : 2, 0X05), 0x00C00000, 0x00FFFFFF}, {BITS(6 : 2, 0X06), 0x00800000, 0x00FFFFFF},

    {BITS(6 : 2, 0X07), 0x00000000, 0x00FFFFFF}, {BITS(6 : 2, 0X08), 0x00FFFFFF, 0x00FFFFFF},

    {BITS(6 : 2, 0X09), 0x00000000, 0x0003FFFF}, {BITS(6 : 2, 0X0A), 0x00000000, 0x0007FFFF},
    {BITS(6 : 2, 0X0B), 0x00000000, 0x000FFFFF}, {BITS(6 : 2, 0X0C), 0x00000000, 0x001FFFFF},
    {BITS(6 : 2, 0X0D), 0x00000000, 0x003FFFFF}, {BITS(6 : 2, 0X0E), 0x00000000, 0x007FFFFF},

    {BITS(6 : 2, 0X0F), 0x00000000, 0x00FFFFFF}, {BITS(6 : 2, 0X10), 0xFFFFFFFF, 0xFFFFFFFF},

    {BITS(6 : 2, 0X11), 0x00FFF000, 0x00FFFFFF}, {BITS(6 : 2, 0X12), 0x00FFE000, 0x00FFFFFF},
    {BITS(6 : 2, 0X13), 0x00FFC000, 0x00FFFFFF}, {BITS(6 : 2, 0X14), 0x00FF8000, 0x00FFFFFF},
    {BITS(6 : 2, 0X15), 0x00FF8000, 0x00FFFFFF}, {BITS(6 : 2, 0X16), 0x00FF8000, 0x00FFFFFF},

    {BITS(6 : 2, 0X17), 0x00000000, 0x00FFFFFF}, {BITS(6 : 2, 0X18), 0xFFFFFFFF, 0xFFFFFFFF},

    {BITS(6 : 2, 0X19), 0x00000000, 0x00000FFF}, {BITS(6 : 2, 0X1A), 0x00000000, 0x00001FFF},
    {BITS(6 : 2, 0X1B), 0x00000000, 0x00003FFF}, {BITS(6 : 2, 0X1C), 0x00000000, 0x00007FFF},
    {BITS(6 : 2, 0X1D), 0x00000000, 0x00007FFF}, {BITS(6 : 2, 0X1E), 0x00000000, 0x00007FFF},
...
static ST_WRITE_PROTECT _pstWriteProtectTable_FS25Q128F2TFI[] = {
    //   BPX,                    Lower Bound         Upper Bound
    {BITS(6 : 2, 0X00), 0xFFFFFFFF, 0x00FFFFFF}, {BITS(6 : 2, 0X01), 0x00FC0000, 0x00FFFFFF},
    {BITS(6 : 2, 0X02), 0x00F80000, 0x00FFFFFF}, {BITS(6 : 2, 0X03), 0x00F00000, 0x00FFFFFF},
    {BITS(6 : 2, 0X04), 0x00E00000, 0x00FFFFFF}, {BITS(6 : 2, 0X05), 0x00C00000, 0x00FFFFFF},
    {BITS(6 : 2, 0X06), 0x00800000, 0x00FFFFFF}, {BITS(6 : 2, 0X07), 0x00000000, 0x00FFFFFF},
    {BITS(6 : 2, 0X08), 0x00FFFFFF, 0x00FFFFFF}, {BITS(6 : 2, 0X09), 0x00000000, 0x0003FFFF},
    {BITS(6 : 2, 0X0A), 0x00000000, 0x0007FFFF}, {BITS(6 : 2, 0X0B), 0x00000000, 0x000FFFFF},
    {BITS(6 : 2, 0X0C), 0x00000000, 0x001FFFFF}, {BITS(6 : 2, 0X0D), 0x00000000, 0x003FFFFF},
    {BITS(6 : 2, 0X0E), 0x00000000, 0x007FFFFF}, {BITS(6 : 2, 0X0F), 0x00000000, 0x00FFFFFF},

    {BITS(6 : 2, 0X10), 0x00000000, 0x00FFFFFF}, {BITS(6 : 2, 0X11), 0x00000000, 0x00FBFFFF},
    {BITS(6 : 2, 0X12), 0x00000000, 0x00F7FFFF}, {BITS(6 : 2, 0X13), 0x00000000, 0x00EFFFFF},
    {BITS(6 : 2, 0X14), 0x00000000, 0x00DFFFFF}, {BITS(6 : 2, 0X15), 0x00000000, 0x00BFFFFF},
    {BITS(6 : 2, 0X16), 0x00000000, 0x007FFFFF}, {BITS(6 : 2, 0X17), 0x00FFFFFF, 0x00FFFFFF},
    {BITS(6 : 2, 0X18), 0x00000000, 0x00FFFFFF}, {BITS(6 : 2, 0X19), 0x00040000, 0x00FFFFFF},
    {BITS(6 : 2, 0X1A), 0x00080000, 0x00FFFFFF}, {BITS(6 : 2, 0X1B), 0x00100000, 0x00FFFFFF},
    {BITS(6 : 2, 0X1C), 0x00200000, 0x00FFFFFF}, {BITS(6 : 2, 0X1D), 0x00400000, 0x00FFFFFF},
    {BITS(6 : 2, 0X1E), 0x00800000, 0x00FFFFFF}, {BITS(6 : 2, 0X1F), 0x00FFFFFF, 0x00FFFFFF},
...
hal_SERFLASH_t _hal_SERFLASH_table[] = // Need to Add more sample for robust
    {
        ...
        {FLASH_IC_UNKNOWN,
         ...
         BITS(2 : 0, 0x07),
         ISP_DEV_PMC,
         ISP_SPI_ENDIAN_LITTLE,
         {E_SPI_54M, E_FAST_MODE},
         FALSE,
         FALSE},
        {FLASH_IC_SST25VF032B,
         MID_SST,
         0x25,
         0x4A,
         _pstWriteProtectTable_SST25VF032B,
         NULL,
         0x400000,
         64,
         SIZE_64KB,
        ...
        {FLASH_IC_MX25L6455E,
         ...
         0x26,
         0x17,
         _pstWriteProtectTable_MX25L6455E,
         NULL,
         0x800000,
         128,
         SIZE_64KB,
         ...
         TRUE,
         TRUE},
        {FLASH_IC_MX25L12855E,
         MID_MXIC,
         0x26,
         0x18,
         _pstWriteProtectTable_MX25L12845E,
         NULL,
         0x1000000,
         256,
         SIZE_64KB,
        ...
        {FLASH_IC_MX25L3205D,
         ...
         0x20,
         0x16,
         _pstWriteProtectTable_MX25L3205D,
         NULL,
         0x400000,
         64,
         SIZE_64KB,
        ...
        {FLASH_IC_MX25L4006E,
         ...
         0x20,
         0x13,
         _pstWriteProtectTable_MX25L4006E,
         NULL,
         0x80000,
         8,
         SIZE_64KB,
        ...
        {FLASH_IC_MX25L6405D,
         ...
         0x20,
         0x17,
         _pstWriteProtectTable_MX25L6405D,
         NULL,
         0x800000,
         128,
         SIZE_64KB,
        ...
        {FLASH_IC_MX25L1606E,
         ...
         0x20,
         0x15,
         _pstWriteProtectTable_MX25L1606E,
         NULL,
         0x200000,
         32,
         SIZE_64KB,
         ...
         ISP_DEV_PMC,
         ISP_SPI_ENDIAN_LITTLE,
         {E_SPI_54M, E_DUAL_D_MODE},
         TRUE,
         TRUE},
        {FLASH_IC_MX25L12805D,
         MID_MXIC,
         0x20,
         0x18,
         _pstWriteProtectTable_MX25L12805D,
         NULL,
         0x1000000,
         256,
         SIZE_64KB,
        ...
        {FLASH_IC_MX25L3206E,
         ...
         0x20,
         0x15,
         _pstWriteProtectTable_MX25L3206E,
         NULL,
         0x400000,
         64,
         SIZE_64KB,
        ...
        {FLASH_IC_MX25L8005,
         ...
         0x20,
         0x14,
         _pstWriteProtectTable_MX25L8005,
         NULL,
         0x100000,
         16,
         SIZE_64KB,
        ...
        {FLASH_IC_MX25L6406E,
         ...
         0x20,
         0x17,
         _pstWriteProtectTable_MX25L6406E,
         NULL,
         0x800000,
         128,
         SIZE_64KB,
        ...
        {FLASH_IC_W25Q256JV,
         ...
         0x40,
         0x19,
         /*_pstWriteProtectTable_W25Q256*/ NULL,
         NULL,
         0x2000000,
         512,
         SIZE_64KB,
        ...
        {FLASH_IC_AT25DF321A,
         ...
         0x47,
         0x01,
         _pstWriteProtectTable_AT25DF321,
         NULL,
         0x400000,
         64,
         SIZE_64KB,
        ...
        {FLASH_IC_AT26DF321,
         ...
         0x47,
         0x00,
         _pstWriteProtectTable_AT26DF321,
         NULL,
         0x400000,
         64,
         SIZE_64KB,
        ...
        {FLASH_IC_EN25Q32A,
         ...
         0x30,
         0x16,
         _pstWriteProtectTable_EN25Q32A,
         NULL,
         0x400000,
         64,
         SIZE_64KB,
        ...
        {FLASH_IC_EN25Q128,
         ...
         0x30,
         0x18,
         _pstWriteProtectTable_EN25Q128,
         NULL,
         0x1000000,
         256,
         SIZE_64KB,
        ...
        {FLASH_IC_S25FL032P,
         ...
         0x02,
         0x15,
         _pstWriteProtectTable_S25FL032,
         NULL,
         0x400000,
         64,
         SIZE_64KB,
        ...
        {FLASH_IC_S25FL064P,
         ...
         0x02,
         0x16,
         _pstWriteProtectTable_S25FL064,
         NULL,
         0x800000,
         128,
         SIZE_64KB,
        ...
        {FLASH_IC_S25FL032K,
         ...
         0x40,
         0x16,
         _pstWriteProtectTable_S25FL032K_CMP0,
         NULL,
         0x400000,
         64,
         SIZE_64KB,
        ...
        {FLASH_IC_S25FL128P,
         ...
         0x20,
         0x18,
         _pstWriteProtectTable_S25FL128P,
         NULL,
         0x1000000,
         256,
         SIZE_64KB,
        ...
        {FLASH_IC_S25FL008A,
         ...
         0x20,
         0x13,
         _pstWriteProtectTable_S25FL008A,
         NULL,
         0x100000,
         16,
         SIZE_64KB,
        ...
        {FLASH_IC_PM25LQ032C,
         ...
         0x46,
         0x15,
         _pstWriteProtectTable_PM25LQ032C,
         NULL,
         0x400000,
         64,
         SIZE_64KB,
        ...
        {FLASH_IC_GD25Q32,
         ...
         0x40,
         0x16,
         _pstWriteProtectTable_GD25Q32_CMP0,
         NULL,
         0x400000,
         64,
         SIZE_64KB,
        ...
        {FLASH_IC_GD25Q16,
         ...
         0x40,
         0x15,
         _pstWriteProtectTable_GD25Q16_CMP0,
         NULL,
         0x200000,
         32,
         SIZE_64KB,
        ...
        {FLASH_IC_GD25Q256C,
         ...
         TRUE,
         TRUE},
        {FLASH_IC_MICRON_M25P16,
         MID_MICRON,
         0x20,
         0x15,
         _pstWriteProtectTable_M25P16,
         NULL,
         0x200000,
         32,
         SIZE_64KB,
         ...
         FALSE,
         TRUE},
        {FLASH_IC_MICRON_N25Q32,
         MID_MICRON,
         0xBA,
         0x16,
         _pstWriteProtectTable_N25Q32,
         NULL,
         0x400000,
         64,
         SIZE_64KB,
         ...
         ISP_DEV_PMC,
         ISP_SPI_ENDIAN_LITTLE,
         {E_SPI_86M, E_DUAL_D_MODE},
         TRUE,
         TRUE},
        {FLASH_IC_MICRON_N25Q64,
         MID_MICRON,
         0xBA,
         0x17,
         _pstWriteProtectTable_N25Q64,
         NULL,
         0x800000,
         128,
         SIZE_64KB,
         ...
         TRUE,
         TRUE},
        {FLASH_IC_MICRON_N25Q128,
         MID_MICRON,
         0xBA,
         0x18,
         _pstWriteProtectTable_N25Q128,
         NULL,
         0x1000000,
         256,
         SIZE_64KB,
         ...
         TRUE,
         TRUE},
        {FLASH_IC_NUMONYX_M25PX16,
         MID_NUMONYX,
         0x73,
         0x15,
         _pstWriteProtectTable_M25PX16,
         NULL,
         0x200000,
         32,
         SIZE_64KB,
        ...
        {FLASH_IC_ST25Q128,
         ...
         0x40,
         0x18,
         _pstWriteProtectTable_ZB25Q128,
         NULL,
         0x1000000,
         256,
         SIZE_64KB,
        ...
        {FLASH_IC_ZB25VQ128,
         ...
         0x40,
         0x18,
         _pstWriteProtectTable_ZB25VQ128,
         NULL,
         0x1000000,
         256,
         SIZE_64KB,
        ...
        {FLASH_IC_25Q128AS,
         ...
         ISP_DEV_PMC,
         ISP_SPI_ENDIAN_LITTLE,
         {E_SPI_54M, E_SINGLE_MODE},
         TRUE,
         TRUE},

        {FLASH_IC_WUHAN_XM25QH64A,
         MID_WUHAN,
         0X70,
         0X17,
         _pstWriteProtectTable_XM25QH64A,
         NULL,
         0x800000,
         128,
         SIZE_64KB,
         ...
         TRUE,
         TRUE},
        {FLASH_IC_WUHAN_XM25QH128A,
         MID_WUHAN,
         0X70,
         0X18,
         _pstWriteProtectTable_XM25QH128A,
         NULL,
         0x1000000,
         256,
         SIZE_64KB,
         ...
         TRUE,
         TRUE},
        {FLASH_IC_WUHAN_XM25QH128C,
         MID_WUHAN,
         0X40,
         0X18,
         _pstWriteProtectTable_XM25QH128C,
         NULL,
         0x1000000,
         256,
         SIZE_64KB,
         ...
         TRUE,
         TRUE},
        {FLASH_IC_XTX_XT25F64B,
         MID_XTX,
         0X40,
         0X17,
         _pstWriteProtectTable_XTX_XT25F64B,
         NULL,
         0x800000,
         128,
         SIZE_64KB,
         ...
         TRUE,
         TRUE},
        {FLASH_IC_XTX_XT25F128B,
         MID_XTX,
         0X40,
         0X18,
         _pstWriteProtectTable_XTX_XT25F128B,
         NULL,
         0x1000000,
         256,
         SIZE_64KB,
         ...
         TRUE,
         TRUE},
        {FLASH_IC_FS25Q128F2TFI,
         MID_FS,
         0x40,
         0x18,
         _pstWriteProtectTable_FS25Q128F2TFI,
         NULL,
         0x1000000,
         256,
         SIZE_64KB,
