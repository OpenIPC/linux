...
#define BASE_REG_FSP_PM_ADDR  GET_BASE_ADDR_BY_BANK(IO_ADDRESS(MS_BASE_REG_RIU_PA), 0x001600)
#define BASE_REG_QSPI_PM_ADDR GET_BASE_ADDR_BY_BANK(IO_ADDRESS(MS_BASE_REG_RIU_PA), 0x001700)
#define BASE_REG_FSP_ADDR     GET_BASE_ADDR_BY_BANK(IO_ADDRESS(MS_BASE_REG_RIU_PA), 0x100D00)
#define BASE_REG_QSPI_ADDR    GET_BASE_ADDR_BY_BANK(IO_ADDRESS(MS_BASE_REG_RIU_PA), 0x100E00)
...
#define REG_ISP_CHIP_RST \
    0x3F // SPI clock source  [0]:gate  [1]:inv  [4:2]:clk_sel  000:Xtal clock 001:27MHz 010:36MHz 011:43.2MHz 100:54MHz
         // 101:72MHz 110:86MHz 111:108MHz  [5]:0:xtal 1:clk_Sel
...
#define SFSH_CHIP_FAST_MASK        BMASK(3 : 0)
#define SFSH_CHIP_NORMOL_ENABLE    BITS(3 : 0, 0x0) // SPI CMD [0x03]
#define SFSH_CHIP_FAST_ENABLE      BITS(3 : 0, 0x1) // SPI CMD [0x0B]
#define SFSH_CHIP_DUALREAD_ENABLE  BITS(3 : 0, 0x2) // SPI CMD [0x3B]
#define SFSH_CHIP_2XREAD_ENABLE    BITS(3 : 0, 0x3) // SPI CMD [0xBB]
#define SFSH_CHIP_4XREAD_ENABLE    BITS(3 : 0, 0xA) // SPI CMD [0xEB]
...
#define REG_PIU_SPI_CLK_SRC \
    0x26 // SPI clock source  [0]:gate  [1]:inv  [4:2]:clk_sel  000:Xtal clock 001:27MHz 010:36MHz 011:43.2MHz 100:54MHz
         // 101:72MHz 110:86MHz 111:108MHz  [5]:0:xtal 1:clk_Sel
...
#define REG_FSP_WDB10         0x70
#define REG_FSP_WDB10_MASK    BMASK(7 : 0)
#define REG_FSP_WDB10_DATA(d) BITS(7 : 0, d)
#define REG_FSP_WDB11         0x70
#define REG_FSP_WDB11_MASK    BMASK(15 : 8)
#define REG_FSP_WDB11_DATA(d) BITS(15 : 8, d)
#define REG_FSP_WDB12         0x71
#define REG_FSP_WDB12_MASK    BMASK(7 : 0)
#define REG_FSP_WDB12_DATA(d) BITS(7 : 0, d)
#define REG_FSP_WDB13         0x71
#define REG_FSP_WDB13_MASK    BMASK(15 : 8)
#define REG_FSP_WDB13_DATA(d) BITS(15 : 8, d)
#define REG_FSP_WDB14         0x72
#define REG_FSP_WDB14_MASK    BMASK(7 : 0)
#define REG_FSP_WDB14_DATA(d) BITS(7 : 0, d)
#define REG_FSP_WDB15         0x72
#define REG_FSP_WDB15_MASK    BMASK(15 : 8)
#define REG_FSP_WDB15_DATA(d) BITS(15 : 8, d)
#define REG_FSP_WDB16         0x73
#define REG_FSP_WDB16_MASK    BMASK(7 : 0)
#define REG_FSP_WDB16_DATA(d) BITS(7 : 0, d)
...
#define REG_FSP_MAX_WRITEDATA_SIZE 0xF
