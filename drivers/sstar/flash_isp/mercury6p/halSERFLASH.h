...
#define WAIT_SFSH_CS_STAT()                                                   \
    {                                                                         \
        while (ISP_READ(REG_ISP_SPI_CHIP_SELE_BUSY) == SFSH_CHIP_SELE_SWITCH) \
        {                                                                     \
        }                                                                     \
    }
...
extern EN_WP_AREA_EXISTED_RTN HAL_SERFLASH_WP_Area_Existed(MS_U32 u32UpperBound, MS_U32 u32LowerBound,
