...
//     .disp_table = {.resolution = MHAL_WARP_MAP_RESLOUTION_16X16, .format = MHAL_WARP_MAP_FORMAT_ABSOLUTE, .size =
//     263296, .absolute_table = NULL/*mi_3840x2160_disp_484x136_abs.bin*/}, .bb_table = {.size = 816, .table = NULL
//     /*bb_undist.bin.bin*/}, .coeff = {0, 0, 0, 0, 0, 0, 0, 0, 0}, .input_image = {.format =
//     MHAL_WARP_IMAGE_FORMAT_YUV420, .width = 3840, .height = 2160}, .input_data = {.num_planes = 2, .data[0] =
//     NULL/*input Y buffer*/, .data[1] = NULL/*input UV buffer*/}, .output_image = {.format =
//     MHAL_WARP_IMAGE_FORMAT_YUV420, .width = 3840, .height = 2160}, .output_data = {.num_planes = 2, .data[0] =
//     NULL/*output Y buffer*/, .data[1] = NULL/*output UV buffer*/}, .afbc_en = 0, .fill_value = {0, 0x80},
