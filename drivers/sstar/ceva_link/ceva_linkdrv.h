...
extern int  ceva_linkdrv_broadcast_events(struct ceva_linkdrv *link, ceva_event_t *events, int sz);
extern int  ceva_linkdrv_open_cb(struct ceva_linkdrv *link);
extern int  ceva_linkdrv_release_cb(struct ceva_linkdrv *link);
extern long ceva_linkdrv_ioctl(struct ceva_linkdrv *link, unsigned int cmd, unsigned long arg);
extern int  ceva_linkdrv_init(struct ceva_linkdrv *link, struct xm6_dev_data *owner);
