...
/*!
 * Device name for shared memory driver
 */
...
struct boot_config_t
{
    ...
    struct boot_buffer_t share_mem;   // address of share memory is physical address
    ...
    __u32                dsp_log_size;
    __u32                log_enable;
    dsp_dma_image_info_t dsp_dma_image_info;
};
...
#define IOC_CEVADRV_SHUT_DOWN      _IOWR(IOC_CEVADRV_MAGIC, 7, int)
#define IOC_CEVADRV_BOOT_CHECK     _IOWR(IOC_CEVADRV_MAGIC, 8, int)
#define IOC_CEVADRV_MIU_2_PHYS     _IOWR(IOC_CEVADRV_MAGIC, 9, __u64)
#define IOC_CEVADRV_PHYS_2_MIU     _IOWR(IOC_CEVADRV_MAGIC, 10, __u64)
#define IOC_CEVADRV_VERSION_CHECK  _IOWR(IOC_CEVADRV_MAGIC, 11, struct Version_Info)

#define IOC_CEVADRV_MAXNR 11
