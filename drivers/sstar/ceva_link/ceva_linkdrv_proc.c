...
static void *host_log_seq_start(struct seq_file *s, loff_t *pos)
{
    ...
    if ((*pos) == 0)
    {
        // seq_printf(s, "head = %d, tail=%d, size=%d, index=%d\n", host_log_head, host_log_tail, host_log_size,
        // host_log_index);
        *pos = host_log_index;
...
static struct seq_operations host_log_seq_ops = {
    .start = host_log_seq_start, .next = host_log_seq_next, .stop = host_log_seq_stop, .show = host_log_seq_show};
...
static struct seq_operations dsp_log_seq_ops = {
    .start = dsp_log_seq_start, .next = dsp_log_seq_next, .stop = dsp_log_seq_stop, .show = dsp_log_seq_show};
...
static int proc_reg_show(struct seq_file *m, void *v)
{
    ...
    seq_printf(m, "0x00 ~ 0x07: 0x%04x 0x%04x 0x%04x 0x%04x 0x%04x 0x%04x 0x%04x 0x%04x\n",
               REGR(p_dev_data->ceva_hal.base_sys, 0x00), REGR(p_dev_data->ceva_hal.base_sys, 0x01),
               REGR(p_dev_data->ceva_hal.base_sys, 0x02), REGR(p_dev_data->ceva_hal.base_sys, 0x03),
               REGR(p_dev_data->ceva_hal.base_sys, 0x04), REGR(p_dev_data->ceva_hal.base_sys, 0x05),
               REGR(p_dev_data->ceva_hal.base_sys, 0x06), REGR(p_dev_data->ceva_hal.base_sys, 0x07));

    seq_printf(m, "0x08 ~ 0x0F: 0x%04x 0x%04x 0x%04x 0x%04x 0x%04x 0x%04x 0x%04x 0x%04x\n",
               REGR(p_dev_data->ceva_hal.base_sys, 0x08), REGR(p_dev_data->ceva_hal.base_sys, 0x09),
               REGR(p_dev_data->ceva_hal.base_sys, 0x0A), REGR(p_dev_data->ceva_hal.base_sys, 0x0B),
               REGR(p_dev_data->ceva_hal.base_sys, 0x0C), REGR(p_dev_data->ceva_hal.base_sys, 0x0D),
               REGR(p_dev_data->ceva_hal.base_sys, 0x0E), REGR(p_dev_data->ceva_hal.base_sys, 0x0F));

    seq_printf(m, "0x10 ~ 0x17: 0x%04x 0x%04x 0x%04x 0x%04x 0x%04x 0x%04x 0x%04x 0x%04x\n",
               REGR(p_dev_data->ceva_hal.base_sys, 0x10), REGR(p_dev_data->ceva_hal.base_sys, 0x11),
               REGR(p_dev_data->ceva_hal.base_sys, 0x12), REGR(p_dev_data->ceva_hal.base_sys, 0x13),
               REGR(p_dev_data->ceva_hal.base_sys, 0x14), REGR(p_dev_data->ceva_hal.base_sys, 0x15),
               REGR(p_dev_data->ceva_hal.base_sys, 0x16), REGR(p_dev_data->ceva_hal.base_sys, 0x17));

    seq_printf(m, "0x18 ~ 0x1F: 0x%04x 0x%04x 0x%04x 0x%04x 0x%04x 0x%04x 0x%04x 0x%04x\n",
               REGR(p_dev_data->ceva_hal.base_sys, 0x18), REGR(p_dev_data->ceva_hal.base_sys, 0x19),
               REGR(p_dev_data->ceva_hal.base_sys, 0x1A), REGR(p_dev_data->ceva_hal.base_sys, 0x1B),
               REGR(p_dev_data->ceva_hal.base_sys, 0x1C), REGR(p_dev_data->ceva_hal.base_sys, 0x1D),
               REGR(p_dev_data->ceva_hal.base_sys, 0x1E), REGR(p_dev_data->ceva_hal.base_sys, 0x1F));

    seq_printf(m, "0x20 ~ 0x22: 0x%04x 0x%04x 0x%04x\n", REGR(p_dev_data->ceva_hal.base_sys, 0x20),
               REGR(p_dev_data->ceva_hal.base_sys, 0x21), REGR(p_dev_data->ceva_hal.base_sys, 0x22));

    seq_printf(m, "0x40 ~ 0x44: 0x%04x 0x%04x 0x%04x 0x%04x 0x%04x\n", REGR(p_dev_data->ceva_hal.base_sys, 0x40),
               REGR(p_dev_data->ceva_hal.base_sys, 0x41), REGR(p_dev_data->ceva_hal.base_sys, 0x42),
               REGR(p_dev_data->ceva_hal.base_sys, 0x43), REGR(p_dev_data->ceva_hal.base_sys, 0x44));

    seq_printf(m, "0x60 ~ 0x63: 0x%04x 0x%04x 0x%04x 0x%04x\n", REGR(p_dev_data->ceva_hal.base_sys, 0x60),
               REGR(p_dev_data->ceva_hal.base_sys, 0x61), REGR(p_dev_data->ceva_hal.base_sys, 0x62),
