    0x9C, 0x44, 0x5F, 0x34, 0x61, 0x20, 0x3D, 0xC0, 0000, 0000, 0000, 0000, 0000, 0000, 0x04, 0000, 0000, 0000, 0xEF,
    0x97, 0xA2, 0xFF, 0x81, 0x90, 0xFF, 0xFF, 0000, 0000, 0000, 0000, 0000, 0000, 0000, 0000, 0000, 0000, 0000, 0000,
...
static const u8 boot_copier_binary[0x200] = {
    ,
};
...
static long detect_dsp_acting(ceva_hal_handle *handle, u8 *buffer_virt)
{
    ...
    while (retry--)
    {
        ...
        // mdelay(500);
        mdelay(30);
        XM6_MSG(XM6_MSG_DBG, "DSP is not ready (%d, %d), dummy = 0x%x\n", dsp_info->dsp_id, dsp_info->dsp_reg_state,
                dsp_ceva_hal_read_dummy_data(handle, 0));
    }
...
int dsp_dma_image_ext_transfer(struct boot_config_t boot_config, u8 *image_virt)
{
    ...
    src_phy_addr = boot_config.boot_image.miu + MIU0_BASE + boot_config.dsp_dma_image_info.code_int_size
                   + boot_config.dsp_dma_image_info.data_int_size;
    src_virt_addr =
        image_virt + boot_config.dsp_dma_image_info.code_int_size + boot_config.dsp_dma_image_info.data_int_size;
    ...
    src_virt_addr = image_virt + boot_config.dsp_dma_image_info.code_int_size
                    + boot_config.dsp_dma_image_info.data_int_size + boot_config.dsp_dma_image_info.code_ext_size;
...
int dsp_boot_up(ceva_hal_handle *handle, dev_dsp_buf *copier_buf, void *share_mem_virt, dsp_mem_info_t *dsp_mem_info)
{
    ...
    XM6_MSG(XM6_MSG_DBG, "boot_image.addr  = 0x%x, size = %d\n", dsp_mem_info->boot_image.addr,
            dsp_mem_info->boot_image.size);
    XM6_MSG(XM6_MSG_DBG, "share_mem.addr   = 0x%x, size = %d\n", dsp_mem_info->share_mem.addr,
            dsp_mem_info->share_mem.size);
    XM6_MSG(XM6_MSG_DBG, "ext_heap.addr    = 0x%x, size = %d\n", dsp_mem_info->ext_heap.addr,
            dsp_mem_info->ext_heap.size);
    XM6_MSG(XM6_MSG_DBG, "hprintf_buf.addr = 0x%x, size = %d\n", dsp_mem_info->hprintf_buf.addr,
            dsp_mem_info->hprintf_buf.size);
    XM6_MSG(XM6_MSG_DBG, "dsp_log_buf.addr = 0x%x, size = %d\n", dsp_mem_info->dsp_log_buf.addr,
            dsp_mem_info->dsp_log_buf.size);
    XM6_MSG(XM6_MSG_DBG, "work_buffer.addr = 0x%x, size = %d\n", dsp_mem_info->work_buffer.addr,
            dsp_mem_info->work_buffer.size);
...
#ifdef _FAST_DMA_BOOT_
    Add_DSP_Copier_Address(copier_virt->boot_copier_binary + 0x1F8, dsp_mem_info->boot_image.addr,
                           dsp_mem_info->boot_image.addr + 0x40000);
#else
    copier_virt->pdma_buff_addr   = 0;
    copier_virt->image_start_addr = dsp_mem_info->boot_image.addr;
    copier_virt->entry_point_addr = 0;
    XM6_MSG(XM6_MSG_DBG, "boot_copier_binary = 0x%02x       (@ 0x%p)\n", copier_virt->boot_copier_binary[0],
            &copier_virt->boot_copier_binary);
    XM6_MSG(XM6_MSG_DBG, "pdma_buff_addr     = 0x%08x (@ 0x%p)\n", copier_virt->pdma_buff_addr,
            &copier_virt->pdma_buff_addr);
    XM6_MSG(XM6_MSG_DBG, "image_start_addr   = 0x%08x (@ 0x%p)\n", copier_virt->image_start_addr,
            &copier_virt->image_start_addr);
    XM6_MSG(XM6_MSG_DBG, "entry_point_addr   = 0x%08x (@ 0x%p)\n", copier_virt->entry_point_addr,
            &copier_virt->entry_point_addr);
#endif

    XM6_MSG(XM6_MSG_DBG, "endian check %02x %02x %02x %02x = %08x\n", copier_virt->boot_copier_binary[0],
            copier_virt->boot_copier_binary[1], copier_virt->boot_copier_binary[2], copier_virt->boot_copier_binary[3],
            *(u32 *)(&copier_virt->boot_copier_binary[0]));
