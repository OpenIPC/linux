...
#define MIU_GRP_NUM           (0x06) // group 0/1/3/4/5
#define MIU_ARB_CLIENT_NUM    (0x60) // 16 clients per group, total 4 groups
...
#define MIU_EFFI_NET0_BASE  (0x50B00UL) // 0x150B
#define MIU_EFFI_DISP0_BASE (0x66B00UL) // 0x166B
#define MIU_EFFI_ISP0_BASE  (0x66D00UL) // 0x166D
...
// MMU Protection HIT
#if 1
#define REG_MMU_RCMD_PROTECT_STATUS (MIU_MMU_REG_BASE + 0x68UL)
#define REG_MMU_WCMD_PROTECT_STATUS (MIU_MMU_REG_BASE + 0x6AUL)
#define REG_MMU_RCMD_PROTECT_LOADDR (MIU_MMU_REG_BASE + 0x70UL)
#define REG_MMU_RCMD_PROTECT_HIADDR (MIU_MMU_REG_BASE + 0x72UL)
#define REG_MMU_WCMD_PROTECT_LOADDR (MIU_MMU_REG_BASE + 0x74UL)
#define REG_MMU_WCMD_PROTECT_HIADDR (MIU_MMU_REG_BASE + 0x76UL)
#else
...
#define REG_MMU_PROTECT_HIT_ID   15 : 7
...
// MIU Protection HIT
#if 1
#define REG_MIU_RCMD_PROTECT_STATUS (MIU_MMU_REG_BASE + 0x48UL)
#define REG_MIU_WCMD_PROTECT_STATUS (MIU_MMU_REG_BASE + 0x4AUL)
#define REG_MIU_RCMD_PROTECT_LOADDR (MIU_MMU_REG_BASE + 0x50UL)
#define REG_MIU_RCMD_PROTECT_HIADDR (MIU_MMU_REG_BASE + 0x52UL)
#define REG_MIU_WCMD_PROTECT_LOADDR (MIU_MMU_REG_BASE + 0x54UL)
#define REG_MIU_WCMD_PROTECT_HIADDR (MIU_MMU_REG_BASE + 0x56UL)
...
#define REG_MIU_PROTECT_HIT_ID   15 : 7
...
#define REG_MMU_W_DATA_MASK 0x1FFF
...
#define REG_MMU_RCMD_COLLISION_ENTRY (MIU_MMU_REG_BASE + 0x20UL)
...
#define REG_MMU_RCMD_INVALID_ENTRY (MIU_MMU_REG_BASE + 0x28UL) // bit[12:0]
#define REG_MMU_WCMD_INVALID_ENTRY (MIU_MMU_REG_BASE + 0x2AUL) // bit[12:0]

#define REG_MMU_RCMD_INVALID_CLIENT_ID (MIU_MMU_REG_BASE + 0x16UL) // offset:0x0b, bit[8:0]
...
#define REG_MMU_IRQ_RW_CLR      (BIT0 | BIT2)
#define REG_MMU_IRQ_RW_MASK     (BIT1 | BIT3)
#define REG_MMU_IRQ_RCMD_CLR    (BIT8)
#define REG_MMU_IRQ_RCMD_MASK   (BIT9) // rcmd
#define REG_MMU_IRQ_WCMD_CLR    (BIT10)
#define REG_MMU_IRQ_WCMD_MASK   (BIT11) // wcmd

// IRQ flga
#define REG_MMU_IRQ_RCMD_RW_FLAG (BIT0)
#define REG_MMU_IRQ_WCMD_RW_FLAG (BIT1)
#define REG_MMU_IRQ_RW_FLAG      (BIT0 | BIT1)
