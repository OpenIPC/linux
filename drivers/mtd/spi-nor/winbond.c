...
static int
winbond_post_bfpt_fixups(struct spi_nor *nor,
			    const struct sfdp_parameter_header *bfpt_header,
			    const struct sfdp_bfpt *bfpt,
			    struct spi_nor_flash_parameter *params)
{
...
static struct spi_nor_fixups g_winbond_fixups = {
	.post_bfpt = winbond_post_bfpt_fixups,
};
#endif
...
static const struct flash_info winbond_parts[] = {
	...
	{ "w25Q16jv-iq/s25fl016k", INFO(0xef4015, 0,  64 * 1024,  32,
			SECT_4K | SPI_NOR_QUAD_READ) .fixups = &g_winbond_fixups, CLK_MHZ_2X(80) },
	...
	{ "w25q128(b/f)v", INFO(0xef4018, 0, 64 * 1024, 256,
			SECT_4K | SPI_NOR_QUAD_READ) .fixups = &g_winbond_fixups, CLK_MHZ_2X(104) },
	{ "w25q128jv_im", INFO(0xef7018, 0, 64 * 1024, 256,
			SECT_4K | SPI_NOR_QUAD_READ) .fixups = &g_winbond_fixups, CLK_MHZ_2X(80) },
	{ "w25q256", INFO(0xef4019, 0, 64 * 1024, 512,
			SECT_4K | SPI_NOR_QUAD_READ | SPI_NOR_4B_OPCODES) .fixups = &g_winbond_fixups, CLK_MHZ_2X(80) },
	/* Winbond 1.8V */
	{ "w25q32fw", INFO(0xef6016, 0, 64 * 1024,	64,
			SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ |
			SPI_NOR_HAS_LOCK | SPI_NOR_HAS_TB) .fixups = &g_winbond_fixups, CLK_MHZ_2X(80) },
	...
	{ "w25q256jw-im", INFO(0xef8019, 0, 64 * 1024, 512,
			...
			.fixups = &g_winbond_fixups, CLK_MHZ_2X(80) },
	{ "w25q512nw-im", INFO(0xef8020, 0, 64 * 1024, 1024,
			SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ |
			SPI_NOR_HAS_LOCK | SPI_NOR_HAS_TB | SPI_NOR_4B_OPCODES)
			.fixups = &g_winbond_fixups, CLK_MHZ_2X(133) },
	{ "w25q256jw-iq", INFO(0xef6019, 0, 64 * 1024, 512,
			SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ |
			SPI_NOR_HAS_LOCK | SPI_NOR_HAS_TB | SPI_NOR_4B_OPCODES)
			.fixups = &g_winbond_fixups, CLK_MHZ_2X(133) },
#else
	{ "w25Q16jv-iq/s25fl016k", INFO(0xef4015, 0, 64 * 1024,  32, SECT_4K) },
