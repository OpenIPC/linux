...
static int
micron_post_bfpt_fixups(struct spi_nor *nor,
			    ...
			    struct spi_nor_flash_parameter *params)
{
	...
	struct spi_nor_read_command read_1_2_2 = SNOR_OP_READ(8, 8, SPINOR_OP_READ_1_2_2, SNOR_PROTO_1_2_2);
	struct spi_nor_read_command read_1_1_4 = SNOR_OP_READ(1, 7, SPINOR_OP_READ_1_1_4, SNOR_PROTO_1_1_4);
	struct spi_nor_read_command read_1_4_4 = SNOR_OP_READ(0, 40, SPINOR_OP_READ_1_4_4,SNOR_PROTO_1_4_4);
...
static struct spi_nor_fixups g_micron_fixups = {
	.post_bfpt = micron_post_bfpt_fixups,
};

static int
micron_4k_post_bfpt_fixups(struct spi_nor *nor,
			    const struct sfdp_parameter_header *bfpt_header,
			    const struct sfdp_bfpt *bfpt,
			    struct spi_nor_flash_parameter *params)
{
	...
	struct spi_nor_read_command read_fast =  SNOR_OP_READ(0, 8, SPINOR_OP_READ_FAST, SNOR_PROTO_1_1_1);
	struct spi_nor_read_command read_1_1_2 = SNOR_OP_READ(0, 8, SPINOR_OP_READ_1_1_2, SNOR_PROTO_1_1_2);
	struct spi_nor_read_command read_1_2_2 = SNOR_OP_READ(1, 7, SPINOR_OP_READ_1_2_2, SNOR_PROTO_1_2_2);
	struct spi_nor_read_command read_1_1_4 = SNOR_OP_READ(1, 7, SPINOR_OP_READ_1_1_4, SNOR_PROTO_1_1_4);
	struct spi_nor_read_command read_1_4_4 = SNOR_OP_READ(1, 9, SPINOR_OP_READ_1_4_4,SNOR_PROTO_1_4_4);
	struct spi_nor_pp_command PP =       SNOR_OP_PROGRAMS(SPINOR_OP_PP, SNOR_PROTO_1_1_1);
	struct spi_nor_pp_command PP_1_1_4 = SNOR_OP_PROGRAMS(SPINOR_OP_PP_1_1_4, SNOR_PROTO_1_1_4);
...
static struct spi_nor_fixups g_micron_4k_fixups = {
	.post_bfpt = micron_4k_post_bfpt_fixups,
};
#endif
...
static const struct flash_info st_parts[] = {
	...
	{ "n25q128a13",  INFO(0x20ba18, 0, 64 * 1024,  256, SPI_NOR_QUAD_READ)
				  .fixups = &g_micron_fixups, CLK_MHZ_2X(108) },
	...
	{ "mt25qu256a",  INFO(0x20bb19, 0, 64 * 1024,  512,
			SPI_NOR_4B_OPCODES | SPI_NOR_QUAD_READ) .fixups = &g_micron_fixups, CLK_MHZ_2X(108) },
	{ "n25q512a",    INFO(0x20bb20, 0, 64 * 1024, 1024, USE_FSR | SPI_NOR_QUAD_READ)
				  .fixups = &g_micron_4k_fixups, CLK_MHZ_2X(80) },
#else
