...
/*****************************************************************************/
struct nand_sync_timing xmedia_fmc100_nand_sync_timing[] = {
...
/*****************************************************************************/
static void xmedia_fmc100_set_timing_3_3v(struct nand_sync_timing *nand_sync_timing)
{
...
static void xmedia_fmc100_set_timing_1_8v(struct nand_sync_timing *nand_sync_timing)
{
	unsigned int i, regval;
	u8 syncmode = nand_sync_timing->syncmode;
...
void xmedia_fmc100_set_sync_timing(struct nand_sync_timing *nand_sync_timing)
{
	...
	if (io_voltage == NAND_IO_VOL_3_3V)
		return xmedia_fmc100_set_timing_3_3v(nand_sync_timing);
	else
		return xmedia_fmc100_set_timing_1_8v(nand_sync_timing);
}
