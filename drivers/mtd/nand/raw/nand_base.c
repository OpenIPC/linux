		...
		if (realpage != chip->pagecache.page || oob) {
			...
			if (use_bounce_buf && aligned)
				pr_debug("%s: using read bounce buffer for buf@%p\n",
						 __func__, buf);
#ifndef CONFIG_MTD_XMEDIA_FMC100
read_retry:
#endif
			/*
...
#ifdef CONFIG_MTD_XMEDIA_FMC100
...
#ifdef CONFIG_ARCH_XMEDIA
#ifndef CONFIG_MTD_SPI_NAND_XMEDIA
	/* Parallel Nand Flash */
...
#endif /* endif CONFIG_ARCH_XMEDIA */
...
ident_done:
	...
	/* Print ecc type and ecc mode about xmedia flash controller */
