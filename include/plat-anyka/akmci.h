...
struct ak_mci_platform_data {
	...
	struct gpio_info gpio_pwr;      ///< Power Controller
};
 ...
 *	timeout is 419ms */
//#define TRANS_DATA_TIMEOUT	0x800000 //0xffffffff /*0x800000*/
#define TRANS_DATA_TIMEOUT      0x17D7840  //1s 25M
...
struct akmci_host {
	...
	struct power_gpio_attribute power;
};
