...
struct i2c_vender_operations {
	int (*i2c_master_send_mul_reg) (const struct i2c_client *client, const char *buf,
					unsigned int count, unsigned int reg_data_width);
};
void i2c_operations_register(const struct i2c_vender_operations *__i2c_vops);
void i2c_operations_unregister(void);

extern int xmedia_i2c_master_send(const struct i2c_client *client, const char *buf,
					int count);

extern int xmedia_i2c_master_send_mul_reg(const struct i2c_client *client, const char *buf,
					unsigned int count, unsigned int reg_data_width);

extern int xmedia_i2c_master_recv(const struct i2c_client *client, char *buf,
					int count);

extern int xmedia_i2c_transfer(struct i2c_adapter *adap, struct i2c_msg *msgs,
					int num);
