...
/*
 * NVT UART header for NA51068 platform
 *
...
#define NVT_BK                           1               /* A flag to distinguish between different platforms */
#define UART_MCR_AFC                     0x10            /* Enable NVT auto-RTS/CTS */
...
#define HW_FLOW_CTRL_BIT                 BIT(4)          /* Hardware Flow Control */
...
#define TXFIFO_TRGL_MASK                 GENMASK(5, 4)   /* Tx trigger level for DMA mode beat setting */
#define _UART_FCR_RX_TRIGGER_SHIFT       4
#define _UART_FCR_RX_TRIGGER_LEVEL_0     0x0             /* character =  1 (max to 64 beats) */
#define _UART_FCR_RX_TRIGGER_LEVEL_1     0x1             /* character = 16 (max to 32 beats) */
#define _UART_FCR_RX_TRIGGER_LEVEL_2     0x2             /* character = 48 (max to 16 beats) */
#define _UART_FCR_RX_TRIGGER_LEVEL_3     0x3             /* character = 56 (max to 8 beats) */
#define RXFIFO_TRGL_MASK                 GENMASK(7, 6)   /* Rx trigger level for data ready interrupt */
#define _UART_FCR_RX_TRIGGER_SHIFT       6
#define _UART_FCR_RX_TRIGGER_LEVEL_0     0x0             /* character =  1 (64 FIFO) */
#define _UART_FCR_RX_TRIGGER_LEVEL_1     0x1             /* character = 16 (64 FIFO) */
#define _UART_FCR_RX_TRIGGER_LEVEL_2     0x2             /* character = 48 (64 FIFO) */
#define _UART_FCR_RX_TRIGGER_LEVEL_3     0x3             /* character = 56 (64 FIFO) */
...
#define DMA_MODE_BIT                     BIT(5)          /* Enable DMA mode */
