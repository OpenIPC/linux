...
void mercury6_smp_init_cpus(void);
void mercury6_smp_prepare_cpus(unsigned int max_cpus);
 ...
 */
void mercury6_platform_cpu_die(unsigned int cpu)
{
    int spurious = 0;
//  printk(KERN_ERR "[%s]\n",__FUNCTION__);
...
struct smp_operations mercury6_smp_ops  = {
