...
struct ak_mci_platform_data mci1_plat_data = {
	...
	.max_speed_hz = 30*1000*1000,//25*1000*1000,
	.cap_highspeed = 1,
    .gpio_init = ak_gpio_set,
	.bus_width = MCI_BUS_WIDTH_1,
    .gpio_cd = {
        .pin = AK_GPIO_82, // cdh: AK_GPIO_57
        .pulldown = -1, 
        .pullup = -1,
        .value = -1,
        .dir = AK_GPIO_DIR_INPUT,
	...
	.gpio_pwr = {
        ...
        .value = AK_GPIO_ENABLE, ///< 这里统一 value=1 为有效即默认电源启用，具体底层高低电平有效操作通过 pwr_dn 在内部实现。
        .dir = AK_GPIO_DIR_OUTPUT,
        .int_pol = -1,
		.pwr_dn = AK_GPIO_OUT_HIGH, ///< 高电平时停用。
    }
};
...
struct akwifi_platform_data akwifi_pdata = {
	...
	.gpio_cs = {    
         ...
         .pulldown   = AK_PULLDOWN_DISABLE,
         .pullup     = -1,
         .value      = AK_GPIO_OUT_HIGH,   // cs 脫脨脨搂脰碌
         .dir        = AK_GPIO_DIR_OUTPUT,
		.int_pol    = -1,
    },
	.gpio_on = {
...
static unsigned int ak39_custom_gpiopin[] = {
	AK_GPIO_5,AK_GPIO_6,AK_GPIO_7,AK_GPIO_8,AK_GPIO_9,AK_GPIO_41,AK_GPIO_42,\
	AK_GPIO_65,AK_GPIO_66,AK_GPIO_67,AK_GPIO_68,AK_GPIO_69,AK_GPIO_81,AK_GPIO_84,
};
...
MACHINE_START(AK39XX, "AK3918EV300_JW_F37_V10")
/* Maintainer: */
	.atag_offset = 0x100,
	.fixup = NULL,
	.map_io = ak39_map_io,
