...
struct adgpio_key adkey[][3] = {	
    {
        { .code = KEY_1,		.min = 0,	  .max = 100},	//145+30/-40
        { .code = KEY_0,       .min = 1600,  .max = 1720}, //696+30/-40
    },
};
...
MACHINE_START(AK39XX, "CLOUD39EV300_AK3918E_YTJ_MAINBD(SC2232)_V1.0.0")
/* Maintainer: */
	.atag_offset = 0x100,
	.fixup = NULL,
	.map_io = ak39_map_io,
