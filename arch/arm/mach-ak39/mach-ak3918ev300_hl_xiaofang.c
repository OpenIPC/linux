...
struct ak_mci_platform_data mci1_plat_data = {
	...
	.cap_highspeed = 1,
    .gpio_cd = {
        .pin = AK_GPIO_6, // cdh: acohao,2018,11,20
        .pulldown = AK_PULLDOWN_DISABLE, 
        .pullup = -1,
        .value = -1,
        .dir = AK_GPIO_DIR_INPUT,
...
struct akwifi_platform_data akwifi_pdata = {
	...
	.gpio_on = {
		.pin		= AK_GPIO_20,
		.pulldown	= AK_PULLDOWN_DISABLE, //-1,
		.pullup		= -1,//AK_PULLUP_DISABLE,
		.value		= AK_GPIO_OUT_LOW, //AK_GPIO_OUT_HIGH,
		.dir		= AK_GPIO_DIR_OUTPUT,
		.int_pol	= -1,
	},
	.gpio_off = {
		...
		.pulldown	= AK_PULLDOWN_DISABLE,//-1,
		.pullup		= -1,//AK_PULLUP_DISABLE,
		.value		= AK_GPIO_OUT_HIGH, //AK_GPIO_OUT_LOW,
		.dir		= AK_GPIO_DIR_OUTPUT,
		.int_pol	= -1,
	},
	.power_on_delay   = 2000,
...
struct ak39_codec_platform_data ak39_codec_pdata =
{
	...
	.spk_down_gpio =
	{
		.pin        = AK_GPIO_13, //adh:caohao,2018.11.21,speak_en(gpio13) exchange with WL_CL
		.dir		= AK_GPIO_DIR_OUTPUT,
		.pullup		= -1,
		.pulldown	= AK_PULLDOWN_DISABLE,
		.value      = AK_GPIO_OUT_LOW,
...
static struct user_gpio_info user_gpios[] = {
	...
	},
	{
		...
		.info = {
			.pin = AK_GPIO_15,
			.pulldown = AK_PULLUP_DISABLE,
			.pullup = -1,
			.value = AK_GPIO_OUT_HIGH, // in daytime level
			.dir = AK_GPIO_DIR_OUTPUT,
			.int_pol = -1,
		},
	},
...
static struct platform_device user_gpio = {
	.name = "user_gpio",
	.id = -1,
	.dev = {
...
struct adgpio_key adkey[][1] = {	
	{{ .code = KEY_0,		.min = 0,	  .max = 700},
    }, 
};
...
struct multi_addetect multi_det[] = {
	{.unpress_min = 0, .unpress_max = 3000, .fixkeys = adkey[0], .plugdev = PLUGIN_DEV1},	// = null		3251+/-20	
};
...
MACHINE_START(AK39XX, "AK3918EV300_HL_XIAOFANG")
/* Maintainer: */
	.atag_offset = 0x100,
	.fixup = NULL,
	.map_io = ak39_map_io,
