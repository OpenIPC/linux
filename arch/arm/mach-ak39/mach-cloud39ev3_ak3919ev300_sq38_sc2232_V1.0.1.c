...
static struct aksensor_camera_info ak_soc_camera_info = {
	...
	.pin_pwdn = INVALID_GPIO,//AK_GPIO_0,		//initialize GPIO for the power of camera.
	.pin_reset = AK_GPIO_33,
	.link = {
		.bus_id = 39,
		.power = NULL,
 ...
 * @date: 2014-01-09
 */
/*deamon process need to open the gpio_key device.
** If fail,deamon process will exit and lead to 
** watchdog rebooting the system. 
*/ 
static struct gpio_keys_button gpio_keys_button[] = {
	{
		.code			= KEY_0,
		.type			= EV_KEY,
		.gpio			= AK_GPIO_81, //AK_GPIO_5(CAM_RESET), /*To make sure gpio_key device exist. */
		.active_low		= 1,
		.wakeup			= 1,
...
MACHINE_START(AK39XX, "Cloud39EV3_AK3918E80PIN_MNBD")
/* Maintainer: */
	.atag_offset = 0x100,
	.fixup = NULL,
	.map_io = ak39_map_io,
