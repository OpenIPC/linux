...
#define AK_GPIO_DISABLE         (0)
#define AK_GPIO_ENABLE          (1)
...
#define AK_GPIO_64			AK_GPIO_GROUP2_NO(32)
#define AK_GPIO_65			AK_GPIO_GROUP2_NO(33)
#define AK_GPIO_66			AK_GPIO_GROUP2_NO(34)
#define AK_GPIO_67			AK_GPIO_GROUP2_NO(35)
#define AK_GPIO_68			AK_GPIO_GROUP2_NO(36)
#define AK_GPIO_69			AK_GPIO_GROUP2_NO(37)
#define AK_GPIO_70			AK_GPIO_GROUP2_NO(38)
#define AK_GPIO_71			AK_GPIO_GROUP2_NO(39)
#define AK_GPIO_72			AK_GPIO_GROUP2_NO(40)
#define AK_GPIO_73			AK_GPIO_GROUP2_NO(41)
#define AK_GPIO_74			AK_GPIO_GROUP2_NO(42)
#define AK_GPIO_75			AK_GPIO_GROUP2_NO(43)
#define AK_GPIO_76			AK_GPIO_GROUP2_NO(44)
#define AK_GPIO_77			AK_GPIO_GROUP2_NO(45)
#define AK_GPIO_78			AK_GPIO_GROUP2_NO(46)
#define AK_GPIO_79			AK_GPIO_GROUP2_NO(47)
#define AK_GPIO_80			AK_GPIO_GROUP2_NO(48)
#define AK_GPIO_81			AK_GPIO_GROUP2_NO(49)
#define AK_GPIO_82			AK_GPIO_GROUP2_NO(50)
#define AK_GPIO_83			AK_GPIO_GROUP2_NO(51)
#define AK_GPIO_84			AK_GPIO_GROUP2_NO(52)
#define AK_GPIO_85			AK_GPIO_GROUP2_NO(53)


#define AK_GPIO_MIN				AK_GPIO_0
#define AK_GPIO_MAX				AK_GPIO_85
...
#define AK_GPIO_DIR3			(AK_VA_GPIO + 0x08)//adh:caohao 2018.11.5 
...
#define AK_PERIPLL_CTRL_REG1	(AK_VA_SYSCTRL + 0x14) // cdh:add
#define AK_ALALOG_CTRL_REG3		(AK_VA_SYSCTRL + 0xA4) // cdh:add
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
#define AK_GPIO_UART1_FLOW(x)	REG32(AK_VA_SYSCTRL + 0x78) &= ~(0xa << 8)
...
typedef enum {
	 ...
	 ePIN_AS_PWM1,				 // share pin80 as PWM1
	 ePIN_AS_PWM2,				 // share pin69 as PWM2
	 ePIN_AS_PWM3,				 // share pin5 as PWM3
	 ePIN_AS_PWM4,				 // share pin66 as PWM4
	 ePIN_AS_PWM5,				 // share pin47 as PWM5
	 ...
	 ePIN_AS_MAC,				 // share pin as Ethernet MAC with MII interface
	 ePIN_AS_RMAC,				 // share pin as Ethernet RMAC with RMII interface
	 ePIN_AS_I2C,				 // share pin as I2C
 	 ePIN_AS_IRDA,				 // share png as IrDA
	 ePIN_AS_RAM,				 // share pin as RAM Controller
	 ePIN_AS_MIPI,				 // share pin as MIPI Controller
...
typedef enum  {
	...
	SHARE_CFG14,	  // share cfg1 and share cfg3 as used	
	SHARE_CFG23,	  // share cfg2 and share cfg2 as used
	SHARE_CFG123,	  // share cfg1, share config2 and cfg3 as used
	SHARE_CFG134,	  // share cfg1, share config3 and cfg4 as used	
	EXIT_CFG		  
}T_SHARE_CFG;
...
struct gpio_info {
	...
	char dir;
	char int_pol;
	char pwr_dn; ///< Power Down Level Defination, Default = 0.
};
