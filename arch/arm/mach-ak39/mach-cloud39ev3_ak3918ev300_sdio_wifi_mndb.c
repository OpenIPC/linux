 ...
 */
//static 
struct ak_mac_data ak39_mac_pdata = {
	.gpio_init = ak_gpio_set,
	.pwr_gpio = {
		.pin		= -1,
		.pulldown	= AK_PULLDOWN_DISABLE,
...
static struct ak_led_data leds[] = {
	...
	.def_trigger	= "none",
	.effective_level = AK_GPIO_OUT_HIGH, //LEDµƿٖǓѐ§µ膽
	.gpio		= {
		.pin		= AK_GPIO_80,
		.pulldown	= -1,
		.pullup 	= AK_PULLUP_ENABLE,
		.value		= AK_GPIO_OUT_HIGH,  //ϵͳǴ¶¯LED¹ܽƄ¬ɏµ膽 
		.dir		= AK_GPIO_DIR_OUTPUT,
		.int_pol	= -1,
		}
	},
...
MACHINE_START(AK39XX, "CLOUD39EV3_AK3918EV300_MNBD")
/* Maintainer: */
	.atag_offset = 0x100,
	.fixup = NULL,
	.map_io = ak39_map_io,
