...
struct ak_mci_platform_data mci1_plat_data = {
    ...
    .gpio_cd = {
        .pin = -1, /* GPIO20 are used by MAC_RXD1, must be disable */
        .pulldown = -1, 
        .pullup = -1,
        .value = -1,
        .dir = AK_GPIO_DIR_INPUT,
...
struct ak39_codec_platform_data ak39_codec_pdata =
{
	...
	.spk_down_gpio =
	{
		.pin        = -1, /*GPIO47 are used by MII_50M, must be disable */
		.dir		= AK_GPIO_DIR_OUTPUT,
		.pullup		= -1,
		.pulldown	= -1,
		.value      = AK_GPIO_OUT_LOW,
...
static struct ak_led_data leds[] = {
	...
	.def_trigger	= "none",
	.effective_level = AK_GPIO_OUT_HIGH,
	.gpio		= {
		.pin		= -1, /* GPIO24 are used by MAC_RXDV, must be disable */
		.pulldown	= -1,
		.pullup 	= AK_PULLUP_ENABLE,
		.value		= AK_GPIO_OUT_HIGH,
		.dir		= AK_GPIO_DIR_OUTPUT,
...
MACHINE_START(AK39XX, "CLOUD39EV3_AK3919EV300_MNBD")
/* Maintainer: */
	.atag_offset = 0x100,
	.fixup = NULL,
	.map_io = ak39_map_io,
